                ...
                if(detik.equals("01")){
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                                "SELECT" +
                                "	kode_kelas_aplicare,kamar.kd_bangsal," +
                                "	nm_bangsal," +
                                "	kamar.kelas," +
                                "	count(CASE WHEN kamar.statusdata = '1' then 1 end) AS kapasitas," +
                                "	count(CASE WHEN kamar.`status` IN ('KOSONG') then 1 end) AS tersedia," +
                                "	0 as tersediapria," +
                                "	0 as tersediawanita, " +
                                ...
                                "	INNER JOIN aplicare_ketersediaan_kamar on aplicare_ketersediaan_kamar.kd_bangsal=kamar.kd_bangsal " +
                                "WHERE " +
                                "	statusdata = '1' " +
                                "	AND kamar.kd_bangsal NOT IN ( 'K0000161', 'K0000162' ) " +
                                "GROUP BY " +
                                "	kamar.kd_bangsal ");
                        try {
                            rs=ps.executeQuery();
                            while(rs.next()){
                                ...
                                try {     
                                    ...
                                    requestJson ="{\"kodekelas\":\""+rs.getString("kode_kelas_aplicare")+"\", "+
                                                  ...
                                                  "\"kapasitas\":\""+rs.getString("kapasitas")+"\","+ 
                                                  "\"tersedia\":\""+rs.getString("tersedia")+"\","+
                                                  "\"tersediapria\":\""+rs.getString("tersediapria")+"\","+ 
                                                  "\"tersediawanita\":\""+rs.getString("tersediawanita")+"\","+ 
                                                  "\"tersediapriawanita\":\""+rs.getString("tersediapriawanita")+"\""+
                                                  "}";
