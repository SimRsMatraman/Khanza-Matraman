...
import integration_idrg.DlgPemeriksaanPasien;
import javax.swing.JOptionPane;
...
public final class DlgDetailKlaim extends javax.swing.JDialog {
    ...
    public DlgDetailKlaim(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        internalFrame1.setPreferredSize(new Dimension(1600, 1900));
...
//        });
    ...
    private void initComponents() {
        ...
        btnMultiplicity1 = new javax.swing.JMenuItem();
        ...
        btnMultiplicity1.setBackground(new java.awt.Color(255, 255, 254));
        btnMultiplicity1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        btnMultiplicity1.setForeground(new java.awt.Color(50, 50, 50));
        btnMultiplicity1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        btnMultiplicity1.setText("Multiplicity Procedure");
        btnMultiplicity1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnMultiplicity1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        btnMultiplicity1.setName("btnMultiplicity1"); // NOI18N
        btnMultiplicity1.setPreferredSize(new java.awt.Dimension(250, 25));
        btnMultiplicity1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMultiplicity1ActionPerformed(evt);
            }
        });
        ppDiagnosaIDRG.add(btnMultiplicity1);
        ...
        FormCariDiagnosa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FormCariDiagnosaActionPerformed(evt);
            }
        });
        ...
        tglIntubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-12-2025 10:41:33" }));
        ...
        tglEkstubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-12-2025 10:41:33" }));
        ...
        tfNonBedah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNonBedahActionPerformed(evt);
            }
        });
        ...
        BtnPemeriksaan.setBackground(new java.awt.Color(0, 204, 204));
        BtnPemeriksaan.setForeground(new java.awt.Color(0, 102, 102));
        BtnPemeriksaan.setMnemonic('4');
        BtnPemeriksaan.setText("Pemeriksaan Pasien");
        BtnPemeriksaan.setToolTipText("Alt+4");
        BtnPemeriksaan.setName("BtnPemeriksaan"); // NOI18N
        BtnPemeriksaan.setOpaque(true);
        BtnPemeriksaan.setPreferredSize(new java.awt.Dimension(200, 23));
        BtnPemeriksaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemeriksaanActionPerformed(evt);
            }
        });
        internalFrame8.add(BtnPemeriksaan);
        ...
        if (sourceDiagnosa.equals("Diagnosa ICDX")) {
            ...
            if (tabModeDiagnosa.getRowCount() != 0) {
                if (tbDiagnosa.getValueAt(tbDiagnosa.getSelectedRow(), 3).toString().equals("0")) {
                    ...
                    if (tbDiagnosa.getValueAt(tbDiagnosa.getSelectedRow(), 4).toString().equals("N")) {
                        if (Sequel.cariInteger("select count(diagnosa_pasien.kd_penyakit) from diagnosa_pasien WHERE no_rawat='"+txtNoRawat.getText()+"' and  `status`='"+status+"' ")>0){
                            if (Sequel.cariInteger(
    ...
    private void CmbSpecialProcedureItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbSpecialProcedureItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            ...
            try {
                ...
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=getCmg&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"speciapCmg\": \"" + allCmg + "\""
...
//                            }
 ...
 Sequel.queryu("delete from tb_inacbg_prosedure where no_rawat='" + norawat + "' and kode='" + tbProsedureINACBG.getValueAt(tbProsedureINACBG.getSelectedRow(), 0).toString() + "'  ");
    ...
    private void tfNonBedahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNonBedahActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNonBedahActionPerformed

    private void btnMultiplicity1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMultiplicity1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        txtProcedureIDRGCode.setText(tbDiagnosaIDRG.getValueAt(tbDiagnosaIDRG.getSelectedRow(), 0).toString());
        txtProcedureIDRGName.setText(tbDiagnosaIDRG.getValueAt(tbDiagnosaIDRG.getSelectedRow(), 1).toString());
        txtPriority.setText(tbDiagnosaIDRG.getValueAt(tbDiagnosaIDRG.getSelectedRow(), 2).toString());
        txtPriority.setVisible(false);
        WindowMultiplicityProcedure.setSize(800, 150);
        WindowMultiplicityProcedure.setLocationRelativeTo(internalFrame1);
        WindowMultiplicityProcedure.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_btnMultiplicity1ActionPerformed

    private void FormCariDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FormCariDiagnosaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_FormCariDiagnosaActionPerformed
...
if (noRawat == null || noRawat.trim().isEmpty()) {
    ...
    DlgPemeriksaanPasien dlg =
        new DlgPemeriksaanPasien(null, true);
    ...
    private javax.swing.JMenuItem btnMultiplicity1;
...
//            this.tglAkhir = Sequel.cariIsi("select ADDTIME(concat(tgl_registrasi, ' ',jam_reg),'03:00:00') as tglpulang from reg_periksa  where no_rawat='" + noRawat + "'");
            this.tglAkhir = Sequel.cariIsi("select LEAST(\n" +
                                           "        ADDTIME(CONCAT(tgl_registrasi, ' ', jam_reg), '06:00:00'),\n" +
                                           "        CONCAT(tgl_registrasi, ' 23:59:59')\n" +
                                           "    ) AS tglpulang\n" +
                                           "FROM reg_periksa\n" +
            ...
            this.tglAwal = Sequel.cariIsi("select concat(tgl_registrasi, ' ',jam_reg) as tglawal from reg_periksa  where no_rawat='" + noRawat + "'");
            this.tglAkhir = Sequel.cariIsi("select concat(tgl_keluar,' ',jam_keluar) as tglPulang FROM kamar_inap  where no_rawat='" + noRawat + "' and (stts_pulang!='-' or stts_pulang!='Pindah Kamar' ) ORDER BY tgl_keluar DESC limit 1 ");
    ...
    private void kirimKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=createClaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_jkn\": \"" + noKartu + "\","
    ...
    private void updateDataClaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=updateClaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_jkn\": \"" + noKartu + "\","
    ...
    private void validasiPasienTB(String idTB) {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=validateSITB&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_reg_sitb\": \"" + idTB + "\""
...
//            CatatanVerifikasi.dispose();
    ...
    private void tampilDiagnosa() {
        ...
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=searchDiagnosa&kodeDiagnosa=" + FormCariDiagnosa.getText();
            requestEntity = new HttpEntity(headers);
...
//                System.out.println("JSON : " + root);
    ...
    private void tampilDiagnosaInaGrouper() {
        ...
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=searchDiagnosisInagrouper&kodeDiagnosa=" + FormCariDiagnosa.getText();
            requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.GET, requestEntity, String.class).getBody());
//                System.out.println("JSON : " + root);
            response = root.path("response");
    ...
    private void tampilProsedur() {
        ...
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=searchProcedure&kodeProcedure=" + TCariProsedur.getText();
            requestEntity = new HttpEntity(headers);
...
//                System.out.println("JSON : " + root);
    ...
    private void tampilProsedurInaGrouper() {
        ...
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=searchProcedureInagrouper&kodeProcedure=" + TCariProsedur.getText();
            requestEntity = new HttpEntity(headers);
            root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.GET, requestEntity, String.class).getBody());
            response = root.path("response");
            if (response.path("data").isArray()) {
    ...
    private void setDRG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=setDiagnosaIDRG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"diagnosa\": \"" + diagPasien + "\","
    ...
    private void finalDRG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=finalIDRG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void editDRG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=editIDRG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void importCoding() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=importCoding&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
...
//                    }
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=setDiagnosaINACBG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"diagnosa\": \"" + diagPasien + "\","
...
//            CatatanVerifikasi.dispose();
    ...
    private void getDataKlaim() {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=getKlaim&nikCoder=" + nik;
            requestEntity = new HttpEntity(headers);
            requestJson = "{"
                    + "\"no_sep\": \"" + noSep + "\""
                    + "}";
    ...
    private void finalINACBG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=finalINACBG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void editINACBG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=editINACBG&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void finalKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=finalKlaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
                ...
                if (root.path("metadata").path("code").asText().equals("200")) {
                    ...
                    Sequel.menyimpantf2("tt_berkasdigital", "?,?,?,?,?,?", "No.Rawat", 6,
                        new String[]{
                            txtNoRawat.getText(),
                            "data_individual",
                            "data_individual/individual_" + noSep + ".pdf",
                            akses.getkode(),
                            tglNow,
                            jamNow
                        }
    ...
    private void editKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=editKlaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
...
//                            }
    ...
    private void cetakKlaim() {
            ...
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=cetakKlaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
     ...
     private void KirimOnlineKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg/index.php?act=kirimOnlineKlaim&nikCoder=" + nik;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
...
//                            }
    ...
    public void openpdf( String file) {
        try {
            URL url = new URL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/webapps/inacbg_idrg/"  + file);
