...
public class frmUtama extends javax.swing.JFrame {
    ...
    private String requestJson, URL = "", utc = "", link = "", datajam = "",
            ...
            kodepoli = "", kodedokter = "", kodebpjs = "BPJ";
    ...
    private JsonNode rootx;
    private JsonNode nameNodex;
    ...
    private void initComponents() {
        ...
        setTitle("Service Update Antrean mJKN");
...
//                                "SELECT * FROM referensi_mobilejkn_bpjs_batal where referensi_mobilejkn_bpjs_batal.statuskirim='Belum' "
//                                + "and referensi_mobilejkn_bpjs_batal.tanggalbatal between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "'");
//                        try {
//                            rs = ps.executeQuery();
//                            while (rs.next()) {
//                                try {
...
//                                                } catch (Exception ex) {
//                                                    System.out.println("Notifikasi Bridging Batal1 : " + ex);
//                                                }
//                                            }
//                                        }
//                                    }
//                                    TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                } catch (Exception ex) {
//                                    System.out.println("Notifikasi Bridging Batal2 : " + ex);
//                                }
//                            }
//                        } catch (Exception ex) {
//                            System.out.println("Notif Batal : " + ex);
//                        } finally {
//                            if (rs != null) {
//                                rs.close();
//                            }
...
//                        }
                        ...
                        ps = koneksi.prepareStatement(
                                "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.kd_poli,poliklinik.nm_poli,reg_periksa.stts_daftar,reg_periksa.no_rkm_medis,reg_periksa.kd_pj,concat(replace(reg_periksa.tgl_registrasi,'-',''),reg_periksa.no_rkm_medis) as nobooking,pasien.no_peserta,pasien.no_ktp,pasien.no_tlp,IF(tujuankunjungan='2',noskdp,no_rujukan) as referensi,IF(tujuankunjungan='2','3','1') as jeniskunj "
                                + "from reg_periksa inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli left join bridging_sep ON bridging_sep.no_rawat=reg_periksa.no_rawat where reg_periksa.tgl_registrasi between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "' "
                                + "and reg_periksa.kd_poli!='IGDK' and reg_periksa.no_rawat not in (select referensi_mobilejkn_bpjs.no_rawat from referensi_mobilejkn_bpjs) "
                            ...
                            while (rs.next()) {
                                ...
                                try {
                                    ...
                                    if (rs2.next()) {
                                        ...
                                        kodepoli = Sequel.cariIsi("select maping_poli_bpjs_real.kd_poli_bpjs from maping_poli_bpjs_real where maping_poli_bpjs_real.kd_poli_rs=?", rs.getString("kd_poli"));
                                        if ((!kodedokter.equals("")) && (!kodepoli.equals(""))) {
                                            ...
                                            if (task3.equals("") && task99.equals("")) {
                                                try {
                                                    datajam = Sequel.cariIsi("select DATE_ADD(concat('" + rs.getString("tgl_registrasi") + "',' ','" + rs2.getString("jam_mulai") + "'),INTERVAL " + (Integer.parseInt(rs.getString("no_reg")) * 2) + " MINUTE) ");
                                                    parsedDate = dateFormat.parse(datajam);
...
//                                                                + "\"namadokter\": \"" + rs.getString("nm_dokter") + "\","
//                                                                + "\"jampraktek\": \"" + rs2.getString("jam_mulai").substring(0, 5) + "-" + rs2.getString("jam_selesai").substring(0, 5) + "\","
//                                                                + "\"jeniskunjungan\": \"" + rs.getString("jeniskunj") + "\","
//                                                                + "\"nomorreferensi\": \"" + rs.getString("referensi") + "\","
//                                                                + "\"nomorantrean\": \"" + rs.getString("no_reg") + "\","
//                                                                + "\"angkaantrean\": " + Integer.parseInt(rs.getString("no_reg")) + ","
//                                                                + "\"estimasidilayani\": " + parsedDate.getTime() + ","
//                                                                + "\"sisakuotajkn\": " + (rs2.getInt("kuota") - Integer.parseInt(rs.getString("no_reg"))) + ","
...
//                                                    }
                                                    ...
                                                    System.out.println("Notifikasi Add Antrian dan Task 3 : " + ex);
                                                }
                                            }
//
                                            if (task4.equals("") && task99.equals("")) {
                                                datajam = Sequel.cariIsi("select concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.jam_rawat desc limit 1", rs.getString("no_rawat"));
                                                if (datajam.equals("")) {
                                            ...
                                            if (task5.equals("") && task99.equals("")) {
                                                ...
                                                if (datajam.equals("")) {
                                                    datajam = Sequel.cariIsi("select now() from reg_periksa where reg_periksa.stts in ('Sudah','Dirujuk') and reg_periksa.no_rawat=?", rs.getString("no_rawat"));
                                                }
                                                if (!datajam.equals("")) {
                                            ...
                                            if (task6.equals("") && task99.equals("")) {
                                                ...
                                                if (!noresep.equals("")) {
                                                    try {
                                                        ...
                                                        System.out.println("Notifikasi Bridging Task 6 : " + ex);
                                                    }
                                                }
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "6", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            System.out.println("Notifikasi Bridging Task 6-1 : " + ex);
                                                        }
                                                    }
                                                }
                                            }
//
                                            if (task7.equals("") && task99.equals("")) {
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "7", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            System.out.println("Notifikasi Bridging Task 7 : " + ex);
                                                        }
                                                    }
                                                }
                                            }
//
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "99", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            System.out.println("Notifikasi Bridging Task 99 : " + ex);
                                                        }
                                                    }
                                                }
                                            }
                            ...
                            System.out.println("Notif Onsite : " + ex);
                        } finally {
                            if (rs != null) {
                                rs.close();
                            }
...
//                                + "referensi_mobilejkn_bpjs.kodepoli,referensi_mobilejkn_bpjs.pasienbaru,referensi_mobilejkn_bpjs.kodedokter,"
...
//                                + "WHERE referensi_mobilejkn_bpjs.statuskirim='Belum' and referensi_mobilejkn_bpjs.no_rawat not in (SELECT bridging_sep.no_rawat from bridging_sep) and referensi_mobilejkn_bpjs.tanggalperiksa between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "' "
...
//                                    TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                } catch (Exception ex) {
//                                    System.out.println("Notifikasi Bridging Tambah Antrean JKN : " + ex);
//                                }
//                            }
//                        } catch (Exception ex) {
...
//                        }
//
//                        TeksArea.append("Menjalankan WS update antrean Mobile JKN Pasien BPJS\n");
//                        ps = koneksi.prepareStatement(
//                                "SELECT referensi_mobilejkn_bpjs.nobooking,referensi_mobilejkn_bpjs.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,referensi_mobilejkn_bpjs.nohp,referensi_mobilejkn_bpjs.nomorkartu,"
//                                + "referensi_mobilejkn_bpjs.nik,referensi_mobilejkn_bpjs.tanggalperiksa,poliklinik.nm_poli,dokter.nm_dokter,referensi_mobilejkn_bpjs.jampraktek,"
//                                + "referensi_mobilejkn_bpjs.jeniskunjungan,referensi_mobilejkn_bpjs.nomorreferensi,referensi_mobilejkn_bpjs.status,referensi_mobilejkn_bpjs.validasi,"
...
//                                + "referensi_mobilejkn_bpjs.nomorantrean,referensi_mobilejkn_bpjs.angkaantrean,referensi_mobilejkn_bpjs.estimasidilayani,referensi_mobilejkn_bpjs.sisakuotajkn,"
//                                + "referensi_mobilejkn_bpjs.kuotajkn,referensi_mobilejkn_bpjs.sisakuotanonjkn,referensi_mobilejkn_bpjs.kuotanonjkn,"
//                                + "(kuotajkn-sisakuotajkn)*5 as estimasi,concat(tanggalperiksa,' ',LEFT(jampraktek,5),':00') as mulai,LEFT (DATE_ADD((SELECT mulai), INTERVAL (SELECT estimasi) MINUTE),19) as waktutunggu "
//                                + "FROM referensi_mobilejkn_bpjs INNER JOIN reg_periksa ON referensi_mobilejkn_bpjs.no_rawat=reg_periksa.no_rawat "
//                                + "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
//                                + "INNER JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli "
//                                + "INNER JOIN dokter ON reg_periksa.kd_dokter=dokter.kd_dokter "
...
//
//                                if (task4.equals("") && task99.equals("")) {
//                                    if (!rs.getString("waktutunggu").equals("")) {
//                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "4", rs.getString("waktutunggu")}) == true) {
//                                            parsedDate = dateFormat.parse(rs.getString("waktutunggu"));
//                                            try {
...
//                                                    URL = link + "/antrean/updatewaktu";
//                                                    System.out.println("URL : " + URL);
//                                                    rootx = mapper.readTree(api.getRest().exchange(URL, HttpMethod.POST, requestEntity, String.class).getBody());
//                                                    nameNodex = rootx.path("metadata");
//                                                    TeksArea.append("respon coba update lagi task 4 : " + nameNodex.path("code").asText() + " " + nameNodex.path("message").asText() + "\n");
//                                                    Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"4",rs.getString("waktutunggu")});
//                                                    if (!nameNodex.path("code").asText().equals("200")) {
//                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='4' and no_rawat='" + rs.getString("no_rawat") + "'");
//                                                    }
//                                                }
//                                                TeksArea.append("respon update task 4 : "+ parsedDate.getTime() + " " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                            } catch (Exception ex) {
//                                                System.out.println("Notifikasi Bridging Update JKN Task 4 : " + rs.getString("waktutunggu") );
//                                            }
//                                        }
//                                    }
//                                }
...
//                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                            } catch (Exception ex) {
//                                                System.out.println("Notifikasi Bridging Update JKN Task 5 : " + ex);
//                                            }
//                                        }
//                                    }
//                                }
...
//                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                        } catch (Exception ex) {
//                                            System.out.println("Notifikasi Bridging Update JKN Task 6 : " + ex);
//                                        }
//                                    }
//
//                                    datajam = Sequel.cariIsi("select concat(resep_obat.tgl_perawatan,' ',resep_obat.jam) from resep_obat where resep_obat.tgl_perawatan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.no_rawat=?", rs.getString("no_rawat"));
...
//                                                    root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.POST, requestEntity, String.class).getBody());
//                                                    nameNode = root.path("metadata");
////                                                Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"6",datajam});
//                                                    if (!nameNode.path("code").asText().equals("200")) {
//                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='6' and no_rawat='" + rs.getString("no_rawat") + "'");
//                                                    }
//                                                }
//                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                            } catch (Exception ex) {
//                                                System.out.println("Notifikasi Bridging Update JKN Task 6-1 : " + ex);
//                                            }
//                                        }
//                                    }
//                                }
...
//                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                            } catch (Exception ex) {
//                                                System.out.println("Notifikasi Bridging Update JKN Task 7 : " + ex);
//                                            }
//                                        }
//                                    }
//                                }
...
//                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
//                                            } catch (Exception ex) {
//                                                System.out.println("Notifikasi Bridging Update JKN Task 99 : " + ex);
//                                            }
//                                        }
//                                    }
//                                }
