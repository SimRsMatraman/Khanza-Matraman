    ...
    private void encounter() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where CHAR_LENGTH(pasien.no_ktp)='16' and nota_jalan.tanggal between ? and ?");
            try {
                ps.setString(1,Tanggal1.getText());
                ps.setString(2,Tanggal2.getText());
                rs=ps.executeQuery();
                while(rs.next()){
//                    and CHAR_LENGTH(pasien.no_ktp)='16'
                    if((!rs.getString("no_ktp").equals(""))&&(!rs.getString("no_ktp").endsWith("0000000"))&&(!rs.getString("ktpdokter").equals(""))&&rs.getString("id_encounter").equals("")){
                        try {
                            ...
                            try{
                                ...
                                Sequel.menyimpan2("satu_sehat_encounter_gagal","?,?","No.Rawat",2,new String[]{
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "where CHAR_LENGTH(pasien.no_ktp)='16' and nota_inap.tanggal between ? and ?");
            try {
                ps.setString(1,Tanggal1.getText());
                ps.setString(2,Tanggal2.getText());
                rs=ps.executeQuery();
    ...
    private void observationTTV(){
        ...
        try{
            ps=koneksi.prepareStatement(
                   "select reg_periksa.no_rawat,pasien.nm_pasien,pasien.no_ktp,satu_sehat_encounter.id_encounter,pegawai.no_ktp as ktppraktisi,pemeriksaan_ralan.tgl_perawatan,"+
                   "pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.spo,ifnull(satu_sehat_observationttvspo2.id_observation,'') as satu_sehat_observationttvspo2 "+
                   "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat "+
                   "inner join satu_sehat_encounter on satu_sehat_encounter.no_rawat=reg_periksa.no_rawat inner join pemeriksaan_ralan on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "+
            ...
            ps=koneksi.prepareStatement(
                   "select reg_periksa.no_rawat,pasien.nm_pasien,pasien.no_ktp,satu_sehat_encounter.id_encounter,pegawai.no_ktp as ktppraktisi,pemeriksaan_ranap.tgl_perawatan,"+
                   "pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.spo,ifnull(satu_sehat_observationttvspo2.id_observation,'') as satu_sehat_observationttvspo2 "+
                   "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat "+
                   "inner join satu_sehat_encounter on satu_sehat_encounter.no_rawat=reg_periksa.no_rawat inner join pemeriksaan_ranap on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat "+
                    ...
                    if((!rs.getString("no_ktp").equals(""))&&rs.getString("id_condition").equals("")){
                        try {
                            ...
                            try{
                                ...
                                System.out.println("Notifikasi Bridging : "+e);
                                Sequel.menyimpan2("satu_sehat_condition_gagal","?,?,?","Diagnosa",3,new String[]{
                                        rs.getString("no_rawat"),rs.getString("kd_penyakit"),rs.getString("status_lanjut")
                                    });
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
    ...
    private void dietgizi(){
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where asuhan_gizi.instruksi<>'' and nota_jalan.tanggal between ? and ? ");
            try {
                ps.setString(1,Tanggal1.getText()+" ");
                ps.setString(2,Tanggal2.getText()+" ");
                rs=ps.executeQuery();
                                ...
                                json = "{" +
                                            ...
                                            "\"section\" : [" +
                                                "{" +
                                                    ...
                                                    "\"text\" : {" +
                                                        "\"status\" : \"additional\"," +
                                                        "\"div\" : \""+rs.getString("intervensi_gizi").replaceAll("(\r\n|\r|\n|\n\r)","<br>").replaceAll("\t", " ")+"\"" +
                                                    "}" +
                                                "}" +
                                            "]" +
                                        "}";
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "left join satu_sehat_diet on satu_sehat_diet.no_rawat=asuhan_gizi.no_rawat "+
                   "and satu_sehat_diet.tanggal=asuhan_gizi.tanggal "+
                   "where asuhan_gizi.intervensi_gizi<>'' and nota_inap.tanggal between ? and ? ");
            try {
                ps.setString(1,Tanggal1.getText()+" ");
                ps.setString(2,Tanggal2.getText()+" ");
                rs=ps.executeQuery();
