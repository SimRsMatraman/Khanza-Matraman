...
//    }
    ...
    public static String USERLOINC(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("USERLOINC"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PASSWORDLOINC(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("PASSWORDLOINC"));
        }catch(Exception e){
            var=""; 
        }
        return var;
