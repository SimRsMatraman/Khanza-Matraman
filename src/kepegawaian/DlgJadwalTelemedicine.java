 ...
 * @author dosen
 */
public class DlgJadwalTelemedicine extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJadwalTelemedicine(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Jadwal Telemedicine ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(nmdokter.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("jadwal_telemedicine","'"+kddokter.getText()+"','"+cmbHari.getSelectedItem()+"','"+
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(int i=0;i<tbJadwal.getRowCount();i++){ 
            if(tbJadwal.getValueAt(i,0).toString().equals("true")){
                Sequel.queryu("delete from jadwal_telemedicine where kd_dokter='"+tbJadwal.getValueAt(i,1).toString()+"' and hari_kerja='"+tbJadwal.getValueAt(i,3).toString()+"' "+
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(nmdokter.getText().trim().equals("")){
            ...
            if(tbJadwal.getSelectedRow()!= -1){
                Sequel.queryu("update jadwal_telemedicine set jam_mulai='"+cmbJam1.getSelectedItem()+":"+cmbMnt1.getSelectedItem()+":"+cmbDtk1.getSelectedItem()+"',"+
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>();   
                ...
                Valid.MyReportqry("rptJadwal.jasper","report","::[ Jadwal Praktek Dokter ]::",
                        "select jadwal_telemedicine.kd_dokter,dokter.nm_dokter,jadwal_telemedicine.hari_kerja, "+
                        "jadwal_telemedicine.jam_mulai,jadwal_telemedicine.jam_selesai,poliklinik.nm_poli,jadwal_telemedicine.kuota "+
                        "from jadwal_telemedicine inner join poliklinik inner join dokter "+
                        "on jadwal_telemedicine.kd_dokter=dokter.kd_dokter "+
                        "and jadwal_telemedicine.kd_poli=poliklinik.kd_poli "+
                        "where jadwal_telemedicine.kd_dokter like '%"+TCari.getText()+"%' or "+
                        "dokter.nm_dokter like '%"+TCari.getText()+"%' or "+
                        "jadwal_telemedicine.hari_kerja like '%"+TCari.getText()+"%' or "+
                        "poliklinik.nm_poli like '%"+TCari.getText()+"%' "+
                        "order by jadwal_telemedicine.kd_dokter",param);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJadwalTelemedicine dialog = new DlgJadwalTelemedicine(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{           
            ps=koneksi.prepareStatement(
                ...
                "on jadwal_telemedicine.kd_dokter=dokter.kd_dokter "+
                "and jadwal_telemedicine.kd_poli=poliklinik.kd_poli "+
                "where jadwal_telemedicine.kd_dokter like ? or dokter.nm_dokter like ? or "+
                "jadwal_telemedicine.hari_kerja like ? or poliklinik.nm_poli like ? "+
                "order by jadwal_telemedicine.kd_dokter");
            try {
