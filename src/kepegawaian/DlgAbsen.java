 ...
 * @author dosen
 */
public class DlgAbsen extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAbsen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"P","Kode Dokter","Nama Dokter","Tanggal","Status"};
    ...
    private void initComponents() {
        ...
        CmbAbsen = new widget.ComboBox();
        jLabel16 = new widget.Label();
        TanggalAbsen = new widget.Tanggal();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Absensi Dokter ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelBiasa1.setPreferredSize(new java.awt.Dimension(1023, 90));
        ...
        CmbAbsen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cuti", "Sakit", "Izin" }));
        CmbAbsen.setName("CmbAbsen"); // NOI18N
        panelBiasa1.add(CmbAbsen);
        CmbAbsen.setBounds(250, 50, 75, 23);

        jLabel16.setText("Status :");
        jLabel16.setName("jLabel16"); // NOI18N
        panelBiasa1.add(jLabel16);
        jLabel16.setBounds(180, 50, 60, 23);

        TanggalAbsen.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAbsen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-03-2025" }));
        TanggalAbsen.setDisplayFormat("dd-MM-yyyy");
        TanggalAbsen.setName("TanggalAbsen"); // NOI18N
        TanggalAbsen.setOpaque(false);
        TanggalAbsen.setPreferredSize(new java.awt.Dimension(141, 18));
        panelBiasa1.add(TanggalAbsen);
        TanggalAbsen.setBounds(80, 50, 90, 23);

        jLabel18.setText("Tanggal :");
        jLabel18.setName("jLabel18"); // NOI18N
        panelBiasa1.add(jLabel18);
        jLabel18.setBounds(10, 50, 60, 23);
...
//            if(Sequel.menyimpantf("jadwal","'"+kddokter.getText()+"','"Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"','"+
...
//            }
                if(Sequel.menyimpantf("absensi_dokter","?,?,?","Tanggal",3,new String[]{
                    Valid.SetTgl(TanggalAbsen.getSelectedItem()+""),kddokter.getText(),CmbAbsen.getSelectedItem()+""
                })==true){
                tabMode.addRow(new Object[]{
                    false,kddokter.getText(),nmdokter.getText(),Valid.SetTgl(TanggalAbsen.getSelectedItem()+""),CmbAbsen.getSelectedItem().toString()
                });
                LCount.setText(""+tabMode.getRowCount());
                emptTeks();
                }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,TanggalAbsen,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(int i=0;i<tbJadwal.getRowCount();i++){ 
            if(tbJadwal.getValueAt(i,0).toString().equals("true")){
                if(Sequel.queryutf("delete from absensi_dokter where kd_dokter='"+tbJadwal.getValueAt(i,1).toString()+"' and tanggal='"+tbJadwal.getValueAt(i,3).toString()+"'")==true){
                    tabMode.removeRow(i);
                    i--;
                }
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(nmdokter.getText().trim().equals("")){
            ...
            if(tbJadwal.getSelectedRow()!= -1){
                if(Sequel.queryutf("update absensi_dokter set tanggal='"+Valid.SetTgl(TanggalAbsen.getSelectedItem()+"")+"',kd_dokter='"+kddokter.getText()+"',status='"+CmbAbsen.getSelectedItem()+"' where "+
                        "kd_dokter='"+tbJadwal.getValueAt(tbJadwal.getSelectedRow(),1).toString()+"' "+
                        "and tanggal='"+tbJadwal.getValueAt(tbJadwal.getSelectedRow(),3).toString()+"'")==true){
                    ...
                    tbJadwal.setValueAt(Valid.SetTgl(TanggalAbsen.getSelectedItem()+""),tbJadwal.getSelectedRow(),3);
                    tbJadwal.setValueAt(CmbAbsen.getSelectedItem().toString(),tbJadwal.getSelectedRow(),4);
                    emptTeks();
                }
            }  
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAbsen dialog = new DlgAbsen(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox CmbAbsen;
    private widget.Label LCount;
    private widget.ScrollPane Scroll;
    private widget.TextBox TCari;
    private widget.Tanggal TanggalAbsen;
    ...
    private void tampil() {
        ...
        try{           
            ps=koneksi.prepareStatement(
                "select absensi_dokter.kd_dokter,dokter.nm_dokter,absensi_dokter.tanggal, "+
                "absensi_dokter.status "+
                "from absensi_dokter inner join dokter "+
                "on absensi_dokter.kd_dokter=dokter.kd_dokter "+
                "where absensi_dokter.kd_dokter like ? or dokter.nm_dokter like ? "+
                "order by absensi_dokter.tanggal desc");
            try {
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            Valid.SetTgl(TanggalAbsen,tabMode.getValueAt(row,3).toString());
            CmbAbsen.setSelectedItem(tabMode.getValueAt(row,4).toString());
        }
    }
