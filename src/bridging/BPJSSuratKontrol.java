...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026" }));
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2026 08:56:37" }));
    ...
    */
    ...
    private boolean isBooking(){
        ...
        if(status==true){
            ...
            status=Sequel.menyimpantf2("booking_registrasi","?,?,?,?,?,?,?,?,?,?,?,?,?","Pasien dan Tanggal",13,new String[]{
                ...
                Valid.SetTgl(TanggalKontrol.getSelectedItem()+"")+" "+TanggalKontrol.getSelectedItem().toString().substring(11,19),"belum","0"
            });
        }
