...
public final class SatuSehatMapingRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(1140, 40, 90, 23);
        ...
        btnBarang.setBounds(460, 10, 28, 23);
        ...
        FormInput.add(Code);
        Code.setBounds(650, 40, 110, 23);

        jLabel9.setText("Periksa Code :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(570, 40, 80, 23);

        jLabel10.setText("Periksa Display :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(760, 40, 90, 23);
        ...
        Display.setBounds(850, 40, 290, 23);
        ...
        RadiologiSystem.setBounds(1230, 40, 240, 23);
        ...
        jLabel12.setBounds(760, 70, 90, 23);
        ...
        SampelCode.setBounds(650, 70, 110, 23);
        ...
        SampelDisplay.setBounds(850, 70, 290, 23);

        jLabel5.setText("Sampel System :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(1140, 70, 90, 23);

        SampelRadiologiSystem.setHighlighter(null);
        SampelRadiologiSystem.setName("SampelRadiologiSystem"); // NOI18N
        SampelRadiologiSystem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SampelRadiologiSystemActionPerformed(evt);
            }
        });
        ...
        SampelRadiologiSystem.setBounds(1230, 70, 240, 23);
        ...
        NamaPemeriksaan.setBounds(230, 10, 230, 24);

        jLabel13.setText("Nama Pemeriksaan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 10, 120, 23);
            ...
            aplikasi.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if (aplikasi.getTable().getSelectedRow() != -1) {
                        ...
                        RadiologiSystem.setText("http://snomed.info/sct");
                    }
                }
            ...
            aplikasi.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if (aplikasi.getTable().getSelectedRow() != -1) {
                        ...
                        SampelRadiologiSystem.setText("http://loinc.org");
                    }
                }
    ...
    private void SampelRadiologiSystemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SampelRadiologiSystemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SampelRadiologiSystemActionPerformed
