...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnRiwayatRadLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnRiwayatRadLab.setText("Riwayat Rad & Lab");
        BtnRiwayatRadLab.setFocusPainted(false);
        BtnRiwayatRadLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatRadLab.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRiwayatRadLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatRadLab.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatRadLab.setName("BtnRiwayatRadLab"); // NOI18N
        BtnRiwayatRadLab.setPreferredSize(new java.awt.Dimension(135, 23));
            ...
            if(TabRawatJalan.getSelectedIndex()==0){
                if(akses.getberi_obat()==true){
                    if(tabMode.getRowCount()==0){
                        ...
                        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                        RMRiwayatRadLab resumeradlab=new RMRiwayatRadLab(null,true);
                        resumeradlab.setNoRm(NoRM,Pasien);
                        resumeradlab.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                        resumeradlab.setLocationRelativeTo(internalFrame1);
                        resumeradlab.setVisible(true);
                        this.setCursor(Cursor.getDefaultCursor());
                    }
                }else{
                    JOptionPane.showMessageDialog(null,"Maaf, Anda tidak punya hak akses untuk melihat data yang sudah divalidasi...!!!!");
    ...
    */
    ...
    public void tampil() {
        ...
        try{  
            ...
            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan, telaah_resep_obat.nip,"+
