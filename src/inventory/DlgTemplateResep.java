...
public class DlgTemplateResep extends javax.swing.JDialog {
    ...
    public DlgTemplateResep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Resep","Tgl.Resep","Jam Resep","No.Rawat","No.RM","Pasien","Dokter Peresep","Kode Dokter","Judul Resep","Jenis Resep"};
...
//            if(ChkTanggal.isSelected()==true){
            if(NamaDokter.getText().equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " if(resep_obat.jam_peresepan=resep_obat.jam,'Belum Terlayani','Sudah Terlayani') as status,resep_obat.status as status_asal,resep_obat.judul,resep_obat.jenis "+
                    ...
                    " dokter.nm_dokter like ? and resep_obat.jenis like ? order by resep_obat.tgl_perawatan,resep_obat.jam desc");
            }else if(Jenis.getSelectedItem().equals("Semua")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter, "+
                    " if(resep_obat.jam_peresepan=resep_obat.jam,'Belum Terlayani','Sudah Terlayani') as status,resep_obat.status as status_asal,resep_obat.judul,resep_obat.jenis "+
                    " from resep_obat inner join reg_periksa inner join pasien inner join dokter on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    " and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and resep_obat.kd_dokter=dokter.kd_dokter where "+
                    " dokter.nm_dokter like ? and (resep_obat.jenis like '%Umum%' or resep_obat.jenis like '%Racikan%')  order by resep_obat.tgl_perawatan,resep_obat.jam desc");
            }
            else{
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter, "+
                    ...
                    " from resep_obat inner join reg_periksa inner join pasien inner join dokter on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    " and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and resep_obat.kd_dokter=dokter.kd_dokter where "+
                    " dokter.nm_dokter like ? and resep_obat.jenis like ? and resep_obat.judul like ? or "+
                    " dokter.nm_dokter like ? and resep_obat.jenis like ? and pasien.nm_pasien like ? "+
...
//                    ps.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                    ps.setString(1,"%"+NamaDokter.getText()+"%");
                    ps.setString(2,"%"+Jenis.getSelectedItem()+"%");
...
//                    ps.setString(4,kddokter);
                 ...
                 ps.setString(1,"%"+NamaDokter.getText()+"%");
                    ...
                    ps.setString(4,"%"+NamaDokter.getText()+"%");
                    ps.setString(5,"%"+Jenis.getSelectedItem()+"%");
...
//                    ps.setString(2,kddokter);
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("judul"),rs.getString("jenis")
                    });  
