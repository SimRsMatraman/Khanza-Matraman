...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppTelaah = new javax.swing.JMenuItem();
        ...
        cmbTipeResep = new widget.ComboBox();
        ...
        ppTelaah.setBackground(new java.awt.Color(255, 255, 254));
        ppTelaah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppTelaah.setForeground(new java.awt.Color(50, 50, 50));
        ppTelaah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppTelaah.setText("Telaah Resep & Obat");
        ppTelaah.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppTelaah.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppTelaah.setName("ppTelaah"); // NOI18N
        ppTelaah.setPreferredSize(new java.awt.Dimension(225, 25));
        ppTelaah.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ppTelaahMouseClicked(evt);
            }
        });
        ppTelaah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppTelaahActionPerformed(evt);
            }
        });
        Popup2.add(ppTelaah);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-04-2025 09:19:02" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-04-2025 09:19:02" }));
        ...
        cmbTipeResep.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Non Racik", "Racik" }));
        cmbTipeResep.setLightWeightPopupEnabled(false);
        cmbTipeResep.setName("cmbTipeResep"); // NOI18N
        cmbTipeResep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbTipeResepKeyPressed(evt);
            }
        });
        panelGlass9.add(cmbTipeResep);
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-04-2025" }));
        ...
        TabData.addTab("TTD Penyerahan Resep", null, FormPhoto, "");
  ...
  isForm();                
    ...
    private void ppLembarObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("jam",cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            param.put("lahir",Sequel.cariIsi("select DATE_FORMAT(tgl_lahir,'%d-%m-%Y') from pasien where no_rkm_medis=? ",Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=?",TNoRw.getText())));
            param.put("bb",Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TNoRw.getText()));
            param.put("sip",Sequel.cariIsi("select dokter.no_ijn_praktek from dokter INNER JOIN reg_periksa ON reg_periksa.kd_dokter=dokter.kd_dokter where no_rawat=?",TNoRw.getText()));
            param.put("alergi",Sequel.cariIsi("select alergi from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TNoRw.getText()));
            param.put("nm_poli",Sequel.cariIsi("select poliklinik.nm_poli, reg_periksa.kd_poli from reg_periksa INNER JOIN poliklinik ON reg_periksa.kd_poli = poliklinik.kd_poli where no_rawat=?",TNoRw.getText()));
            param.put("resep",Sequel.cariIsi("select resep from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("identitas",Sequel.cariIsi("select identitas from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("obat",Sequel.cariIsi("select obat from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("campuran",Sequel.cariIsi("select campuran from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("jumlah",Sequel.cariIsi("select jumlah from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("dosis",Sequel.cariIsi("select dosis from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("rute",Sequel.cariIsi("select rute from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("tidak1",Sequel.cariIsi("select tidak1 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("tidak2",Sequel.cariIsi("select tidak2 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("tidak3",Sequel.cariIsi("select tidak3 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("benar1",Sequel.cariIsi("select benar1 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("benar2",Sequel.cariIsi("select benar2 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("benar3",Sequel.cariIsi("select benar3 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("benar4",Sequel.cariIsi("select benar4 from telaah_resep_obat where no_resep=?",NoResep.getText()));
            param.put("benar5",Sequel.cariIsi("select benar5 from telaah_resep_obat where no_resep=?",NoResep.getText()));
    ...
    private void ppLabelDataObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLabelDataObatActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("kd_kamar",Sequel.cariIsi("select kamar_inap.kd_kamar from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText()));
    ...
    private void BtnTelaahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTelaahActionPerformed
        if(tbResep.getSelectedRow()!= -1){
            if(NoResep.getText().equals("")){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgTelaahObat aplikasi=new DlgTelaahObat(null,false);
                aplikasi.emptTeks();
                aplikasi.isCek();
...
//                aplikasi.setSize(750,750);
    ...
    private void ppTelaahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTelaahActionPerformed
        if(tabMode.getRowCount()==0){
             JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
             TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
             JOptionPane.showMessageDialog(null,"Maaf, Klik No Resep untuk telaah resep & obat...!!!!");
        }else if(!(TPasien.getText().trim().equals(""))){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgTelaahObat aplikasi=new DlgTelaahObat(null,false);
                aplikasi.emptTeks();
...
//                aplikasi.setSize(750,750);
    ...
    }//GEN-LAST:event_ppTelaahActionPerformed

    private void ppTelaahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ppTelaahMouseClicked
        if(tabMode.getRowCount()!=0){
            if(evt.getClickCount()==2){
                if(akses.getregistrasi()==true){
                    ppTelaahActionPerformed(null);
                }
            }
        }
    }//GEN-LAST:event_ppTelaahMouseClicked

    private void cmbTipeResepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbTipeResepKeyPressed
        Valid.pindah(evt,TCari,BtnCari);
    }//GEN-LAST:event_cmbTipeResepKeyPressed
    ...
    */
    ...
    private widget.ComboBox cmbTipeResep;
    ...
    private javax.swing.JMenuItem ppTelaah;
    ...
    public void tampil() {
        ...
        // Ambil pilihan combo box tipe resep
        String tipeResep = cmbTipeResep.getSelectedItem().toString();

        // Buat kondisi filter racikan
        String filterRacikan = "";
        if (tipeResep.equalsIgnoreCase("Racik")) {
            filterRacikan = " and EXISTS (select 1 from obat_racikan where " +
                            "obat_racikan.tgl_perawatan=resep_obat.tgl_perawatan " +
                            "and obat_racikan.jam=resep_obat.jam " +
                            "and obat_racikan.no_rawat=resep_obat.no_rawat) ";
        } else if (tipeResep.equalsIgnoreCase("Non Racik")) {
            filterRacikan = " and NOT EXISTS (select 1 from obat_racikan where " +
                            "obat_racikan.tgl_perawatan=resep_obat.tgl_perawatan " +
                            "and obat_racikan.jam=resep_obat.jam " +
                            "and obat_racikan.no_rawat=resep_obat.no_rawat) ";
        }
        // Jika "Semua", filterRacikan tetap string kosong (no filter)
        ...
        try {
            ps = koneksi.prepareStatement(
                ...
                " from resep_obat inner join reg_periksa inner join pasien inner join dokter" +
                ...
                filterRacikan +  // <-- FILTER RACIKAN MASUK SINI
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                ...
                                Sequel.cariIsi(
                                    "select aturan from aturan_pakai where tgl_perawatan='" + rs.getString("tgl_perawatan") + "' and " +
                ...
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("tte").equals("")||rs.getString("tte").equals("-")){
                            ...
                            LoadHTML.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+rs.getString("tte")+"' alt='photo' width='750' height='750'/></center></body></html>");
                        }  
...
//                        "from telaah_farmasi inner join petugas on telaah_farmasi.nip=petugas.nip where telaah_farmasi.no_resep=?");
                        ...
                        "telaah_resep_obat.no_resep,telaah_resep_obat.tanggal,telaah_resep_obat.jam,telaah_resep_obat.no_rawat, telaah_resep_obat.TLP,"+
                        ...
                        LoadHTML2.setText(
                            "<html>"+
                                "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    ...
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center' colspan='3'><br>ASPEK ADMINISTRATIF</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                    ...
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' align='left'>Resep Lengkap</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("resep")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>2</td>"+        
                                        "<td valign='middle' align='left'>Identitas Pasien Sesuai</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("identitas")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center' colspan='3'><br>ASPEK FARMASETIK</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No</td>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='75%'>Penilaian</td>"+
                                    ...
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>1</td>"+        
                                        "<td valign='middle' align='left'>Obat Tepat</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("obat")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>2</td>"+        
                                        "<td valign='middle' align='left'>Campuran Obat Stabil</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("campuran")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                       "<td valign='middle' align='center'>3</td>"+         
                                       "<td valign='middle' align='left'>Jumlah Tepat</td>"+
                                       "<td valign='middle' align='center'>"+rs.getString("jumlah")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center' colspan='3'><br>ASPEK KLINIS</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No</td>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='75%'>Penilaian</td>"+
                                    ...
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>1</td>"+        
                                        "<td valign='middle' align='left'>Dosis/Kekuatan/Frekuensi</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("dosis")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>2</td>"+        
                                        "<td valign='middle' align='left'>Rute Pemberian Tepat</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("rute")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>3</td>"+
                                        "<td valign='middle' align='left'>Tidak Ada Interaksi Obat</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("tidak1")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>4</td>"+
                                        "<td valign='middle' align='left'>Tidak Ada Duplikasi</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("tidak2")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>5</td>"+
                                        "<td valign='middle' align='left'>Tidak Ada Alergi/Kontradikasi</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("tidak3")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center' colspan='3'><br>TELAAH OBAT</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No</td>"+
                                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='75%'>Penilaian</td>"+
                                    ...
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>1</td>"+
                                        "<td valign='middle' align='left'>Benar Pasien</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("benar1")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>2</td>"+
                                        "<td valign='middle' align='left'>Benar Obat</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("benar2")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>3</td>"+
                                        "<td valign='middle' align='left'>Benar Dosis Pemberian</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("benar3")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>4</td>"+
                                        "<td valign='middle' align='left'>Benar Rute Pemberian</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("benar4")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                        "<td valign='middle' align='center'>5</td>"+
                                        "<td valign='middle' align='left'>Benar Waktu Pemberian</td>"+
                                        "<td valign='middle' align='center'>"+rs.getString("benar5")+"</td>"+
                                    "</tr>"+
                                    "<tr class='isi'>"+
