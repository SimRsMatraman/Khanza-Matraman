                    ...
                    try {
                        if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                            if(Sequel.menyimpantf2("mutasibarang","'"+tbDokter.getValueAt(i,4).toString()+"','"+Valid.SetAngka(tbDokter.getValueAt(i,0).toString())+"',"+
                                "'"+Valid.SetAngka(tbDokter.getValueAt(i,2).toString())+"','"+kdgudangTujuan.getText()+"','"+kdgudangasal.getText()+"',"+
                                ...
                                if(aktifkanbatch.equals("yes")){
                                    Trackobat.catatRiwayat(tbDokter.getValueAt(i,4).toString(),0,Valid.SetAngka(tbDokter.getValueAt(i,0).toString()),"Mutasi",akses.getkode(),kdgudangTujuan.getText(),"Simpan",tbDokter.getValueAt(i,9).toString(),tbDokter.getValueAt(i,10).toString(),Keterangan.getText()+", dari "+kdgudangTujuan.getText()+" ke "+kdgudangasal.getText());
                                    ...
                                    Trackobat.catatRiwayat(tbDokter.getValueAt(i,4).toString(),Valid.SetAngka(tbDokter.getValueAt(i,0).toString()),0,"Mutasi",akses.getkode(),kdgudangasal.getText(),"Simpan",tbDokter.getValueAt(i,9).toString(),tbDokter.getValueAt(i,10).toString(),Keterangan.getText()+", dari "+kdgudangTujuan.getText()+" ke "+kdgudangasal.getText());
