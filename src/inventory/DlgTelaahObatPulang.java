 ...
 * @author perpustakaan
 */
public final class DlgTelaahObatPulang extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public DlgTelaahObatPulang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        TNoResep.setDocument(new batasInput((byte)17).getKata(TNoResep));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Telaah Resep Obat Pulang]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("telaah_resep_pulang","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Resep",24,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from telaah_resep_pulang where no_resep=? and tanggal=?",2,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Benar5Ya.isSelected()==true){
                ...
                if(Sequel.mengedittf("telaah_resep_pulang","no_resep=? and tanggal=?","no_resep=?,tanggal=?,jam=?,no_rawat=?,kd_dokter=?,nip=?,status=?,resep=?,identitas=?,obat=?,campuran=?,jumlah=?,dosis=?,rute=?,tidak1=?,tidak2=?,tidak3=?,benar1=?,benar2=?,benar3=?,benar4=?,benar5=?,tgl=?,jam_telaah=?",26,new String[]{
                TNoResep.getText(),TglRw.getText(),JamRw.getText(),
                TNoRw.getText(),KodeDokter.getText(),KdPetugas.getText(),Status.getText(),resep,identitas,obat,campuran,jumlah,dosis,
                rute,tidak1,tidak2,tidak3,benar1,benar2,benar3,benar4,benar5,tanggalNow.format(new Date()),jamNow.format(new Date()),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTelaahObatPulang dialog = new DlgTelaahObatPulang(new javax.swing.JFrame(), true);
...
//                        "telaah_resep_pulang.no_resep,telaah_resep_pulang.tanggal,telaah_resep_pulang.jam,telaah_resep_pulang.no_rawat,"+
//                        "telaah_resep_pulang.kd_dokter,telaah_resep_pulang.nip,telaah_resep_pulang.status,telaah_resep_pulang.resep,"+
//                        "telaah_resep_pulang.identitas,telaah_resep_pulang.obat,telaah_resep_pulang.campuran,telaah_resep_pulang.jumlah,"+
//                        "telaah_resep_pulang.dosis,telaah_resep_pulang.rute,telaah_resep_pulang.tidak1,telaah_resep_pulang.tidak2,telaah_resep_pulang.tidak3,"+
//                        "telaah_resep_pulang.benar1,telaah_resep_pulang.benar2,telaah_resep_pulang.benar3,telaah_resep_pulang.benar4,telaah_resep_pulang.benar5,"+
//                        "telaah_resep_pulang.tgl,telaah_resep_pulang.jam_telaah,dokter.nm_dokter,petugas.nama "+
//                        "from resep_obat inner join telaah_resep_pulang on resep_obat.no_resep=telaah_resep_pulang.no_resep "+
//                        "inner join dokter on telaah_resep_pulang.kd_dokter=dokter.kd_dokter "+
//                        "inner join petugas on telaah_resep_pulang.nip=petugas.nip where "+
//                        "telaah_resep_pulang.tanggal between ? and ? order by telaah_resep_pulang.tanggal");
...
//                        "from resep_obat inner join telaah_resep_pulang on resep_obat.no_resep=telaah_resep_pulang.no_resep "+
//                        "inner join dokter on telaah_resep_pulang.kd_dokter=dokter.kd_dokter "+
//                        "inner join petugas on telaah_resep_pulang.nip=petugas.nip "+
...
//                        "telaah_resep_pulang.tanggal between ? and ? order by telaah_resep_pulang.tanggal");
                        "select telaah_resep_pulang.no_resep,telaah_resep_pulang.tanggal,telaah_resep_pulang.jam,telaah_resep_pulang.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                        "telaah_resep_pulang.kd_dokter,dokter.nm_dokter,telaah_resep_pulang.nip,petugas.nama,telaah_resep_pulang.status,telaah_resep_pulang.resep,telaah_resep_pulang.identitas,"+
                        "telaah_resep_pulang.obat,telaah_resep_pulang.campuran,telaah_resep_pulang.jumlah,telaah_resep_pulang.dosis,telaah_resep_pulang.rute,telaah_resep_pulang.tidak1,"+
                        "telaah_resep_pulang.tidak2,telaah_resep_pulang.tidak3,telaah_resep_pulang.benar1,telaah_resep_pulang.benar2,telaah_resep_pulang.benar3,telaah_resep_pulang.benar4,"+
                        "telaah_resep_pulang.benar5,telaah_resep_pulang.tgl,telaah_resep_pulang.jam_telaah "+
                        "from telaah_resep_pulang INNER JOIN reg_periksa ON telaah_resep_pulang.no_rawat = reg_periksa.no_rawat "+
                        "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "+
                        "INNER JOIN dokter ON telaah_resep_pulang.kd_dokter = dokter.kd_dokter "+
                        "INNER JOIN petugas ON telaah_resep_pulang.nip = petugas.nip where "+
                        "telaah_resep_pulang.tanggal between ? and telaah_resep_pulang.no_resep like ? and ? order by telaah_resep_pulang.tanggal");
            }else{
                ps=koneksi.prepareStatement(
//                        "select resep_obat.no_resep,resep_obat.no_rawat,resep_obat.kd_dokter,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,resep_obat.status,"+
//                        "telaah_resep_pulang.no_resep,telaah_resep_pulang.tanggal,telaah_resep_pulang.jam,telaah_resep_pulang.no_rawat,"+
...
//                        "inner join dokter on telaah_resep_pulang.kd_dokter=dokter.kd_dokter "+
//                        "inner join petugas on telaah_resep_pulang.nip=petugas.nip where "+
//                        "telaah_resep_pulang.tanggal between ? and ? and resep_obat.no_resep like ? or "+
//                        "telaah_resep_pulang.tanggal between ? and ? and resep_obat.no_rawat like ? or "+
//                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.jam like ? or "+
//                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.nip like ? or "+
//                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.kd_dokter like ? or "+
//                        "telaah_resep_pulang.tanggal between ? and ? and petugas.nama like ? order by telaah_resep_pulang.tanggal");
                        "select telaah_resep_pulang.no_resep,telaah_resep_pulang.tanggal,telaah_resep_pulang.jam,telaah_resep_pulang.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                        "telaah_resep_pulang.kd_dokter,dokter.nm_dokter,telaah_resep_pulang.nip,petugas.nama,telaah_resep_pulang.status,telaah_resep_pulang.resep,telaah_resep_pulang.identitas,"+
                        "telaah_resep_pulang.obat,telaah_resep_pulang.campuran,telaah_resep_pulang.jumlah,telaah_resep_pulang.dosis,telaah_resep_pulang.rute,telaah_resep_pulang.tidak1,"+
                        "telaah_resep_pulang.tidak2,telaah_resep_pulang.tidak3,telaah_resep_pulang.benar1,telaah_resep_pulang.benar2,telaah_resep_pulang.benar3,telaah_resep_pulang.benar4,"+
                        ...
                        "INNER JOIN dokter ON telaah_resep_pulang.kd_dokter = dokter.kd_dokter "+
                        "INNER JOIN petugas ON telaah_resep_pulang.nip = petugas.nip where "+
                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.no_resep like ? or "+
                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.no_rawat like ? or "+
                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.jam like ? or "+
                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.nip like ? or "+
                        "telaah_resep_pulang.tanggal between ? and ? and telaah_resep_pulang.kd_dokter like ? or "+
                        "telaah_resep_pulang.tanggal between ? and ? and petugas.nama like ? order by telaah_resep_pulang.tanggal");
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("benar5"),rs.getString("tgl"),rs.getString("jam_telaah")
                    });
                }
            } catch (Exception e) {
...
//         Sequel.cariIsi("select kd_dokter from dpjp_ranap where no_rawat=? ",KodeDokter,TNoRw.getText());
//         Sequel.cariIsi("select no_rawat from resep_pulang where no_rawat=? ",TNoRw,TNoRw.getText());
...
//        Sequel.cariIsi("select tanggal from resep_obat where no_resep='"+norwt+"'", DTPCari1);
//        Sequel.cariIsi("select no_rawat from resep_obat where no_resep=? ",TNoRw,TNoResep.getText());
