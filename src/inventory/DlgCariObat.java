...
import rekammedis.DlgInputTemplateRacikan;
...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private PreparedStatement psobat,pscarikapasitas,psstok,ps2,psbatch,psrekening,ps;
    private ResultSet rsobat,carikapasitas,rsstok,rs2,rsbatch,rsrekening,rs;
    ...
    private double[] jumlah,harga,stok,beli,kapasitas,kandungan;
    private String[] kodebarang,namabarang,kodesatuan,letakbarang,namajenis,aturan,industri,kategori,golongan,no,nobatch,nofaktur,kadaluarsa,ulangi,ejum,eb,ts;
    private boolean[] editIterasi;
    private boolean memuatKatalogRacikan=false;
    ...
    private String nipOtorisasiPPRA = "";
    private boolean otorisasiPPRAValid = false;
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
        ...
        tabModeobat=new DefaultTableModel(null,new Object[]{
                ...
                "Harga(Rp)","Jenis Obat","Sebelumnya","Sisa","Stok","Aturan Pakai","I.F.",
                "H.Beli","Kategori","Golongan","No.Batch","No.Faktur","Kadaluarsa","Edit Iterasi","Iterasi","jml Iter"
            }){
...
//        tbDokter.setDefaultRenderer(Object.class, warna);
        try {
            if(koneksiDB.AKTIFKANWARNARALAN().equals("yes")){
                tbObat.setDefaultRenderer(Object.class, new WarnaTableEtter());
            }else{
        ...
        tbObatRacikan.addMouseListener(new java.awt.event.MouseAdapter(){
            @Override public void mouseClicked(java.awt.event.MouseEvent evt){
                if(evt.getClickCount()==2&&tbObatRacikan.getSelectedRow()>=0){
        ...
        if(koneksiDB.CARICEPAT().equals("aktif")){
            TCari.getDocument().addDocumentListener(new javax.swing.event.DocumentListener(){
                ...
                public void insertUpdate(DocumentEvent e) {
                    if(!memuatKatalogRacikan&&TCari.getText().length()>2){
    ...
    private void initComponents() {
        ...
        DlgPass.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        DlgPass.setName("DlgPass"); // NOI18N
        DlgPass.setUndecorated(true);
        DlgPass.setResizable(false);

        internalFrame2.setBorder(null);
        internalFrame2.setName("internalFrame2"); // NOI18N
        internalFrame2.setWarnaAtas(new java.awt.Color(70, 130, 180));
        internalFrame2.setWarnaBawah(new java.awt.Color(70, 130, 180));
        internalFrame2.setLayout(null);

        internalFrame3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(100, 125, 90), 1, true), ":: Silahkan Masukkan Passphrase ::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 2, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame3.setName("internalFrame3"); // NOI18N
        internalFrame3.setRequestFocusEnabled(false);
        internalFrame3.setWarnaAtas(new java.awt.Color(40, 178, 170));
        ...
        jLabel9.setText("Passphrase :");
        jLabel9.setName("jLabel9"); // NOI18N
        panelGlass1.add(jLabel9);
        jLabel9.setBounds(10, 30, 75, 23);
        ...
        edPwd.setBounds(90, 30, 193, 23);

        internalFrame3.add(panelGlass1);
        panelGlass1.setBounds(-1, 25, 342, 76);

        BtnLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/login2.png"))); // NOI18N
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/newicon.png"))); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N
        internalFrame3.add(jLabel13);
        jLabel13.setBounds(190, 10, 135, 145);

        internalFrame2.add(internalFrame3);
        internalFrame3.setBounds(10, 10, 295, 155);

        DlgPass.getContentPane().add(internalFrame2, java.awt.BorderLayout.CENTER);
        ...
        BtnSimpan.setText("Simpan Validasi");
        ...
        BtnHapus.setText("Hapus Racik");
        BtnHapus.setToolTipText("Alt+H");
        BtnHapus.setName("BtnHapus"); // NOI18N
        BtnHapus.setPreferredSize(new java.awt.Dimension(178, 23));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 175));
        ...
        Jeniskelas.setBounds(448, 40, 230, 23);
        ...
        ChkNoResep.setBounds(610, 100, 100, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-08-2026" }));
        ...
        jLabel27.setBounds(690, 10, 145, 23);
        ...
        DiagnosaUtama.setBounds(840, 10, 520, 23);
        ...
        KodeDiagnosaUtama.setBounds(1360, 10, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(1360, 40, 75, 23);
        ...
        DiagnosaSekunder1.setBounds(840, 40, 520, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(690, 40, 145, 23);

        jLabel25.setText("Diagnosa Sekunder 2 :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(690, 70, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(840, 70, 520, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(1360, 70, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(1360, 100, 75, 23);
        ...
        DiagnosaSekunder3.setBounds(840, 100, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(690, 100, 145, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(690, 130, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(840, 130, 520, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(1360, 130, 75, 23);
        ...
        NoResep.setBounds(447, 100, 150, 23);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    if (VALIDASIULANGBERIOBAT.equals("yes")) {
        ...
        try {
            otorisasiPPRAValid = false;
            nipOtorisasiPPRA = "";

            if (perluOtorisasiAntibiotik()) {
                edPwd.setText("");
                DlgPass.setModal(true);
                DlgPass.setSize(316, 171);
                DlgPass.setLocationRelativeTo(this);
                DlgPass.setVisible(true);

                if (!otorisasiPPRAValid) {
                    JOptionPane.showMessageDialog(
                        null,
                        "Validasi dibatalkan. Otorisasi PPRA belum dilakukan."
                    );
                    return;
                }
            }
            ...
            for (i = 0; i < tbObat.getRowCount(); i++) {
                Object val1 = tbObat.getValueAt(i, 1);
                String s1 = (val1 == null) ? "" : val1.toString().trim();

                Object val13 = tbObat.getValueAt(i, 13);
                String s13 = (val13 == null) ? "" : val13.toString().trim();

                Object val6 = tbObat.getValueAt(i, 6);
                String s6 = (val6 == null) ? "" : val6.toString().trim();

                Object val8 = tbObat.getValueAt(i, 8);
                String s8 = (val8 == null) ? "" : val8.toString().trim();

                Object val9 = tbObat.getValueAt(i, 9);
                String s9 = (val9 == null) ? "" : val9.toString().trim();

                try {
                    double jml = s1.isEmpty() ? 0.0 : Double.parseDouble(s1);
                    double h_beli = s13.isEmpty() ? 0.0 : Double.parseDouble(s13);
                    double harga = s6.isEmpty() ? 0.0 : Double.parseDouble(s6);
                    double tambahan1 = s8.isEmpty() ? 0.0 : Double.parseDouble(s8);
                    double tambahan2 = s9.isEmpty() ? 0.0 : Double.parseDouble(s9);
                    ...
                    Object objCek = tbObat.getValueAt(i, 0);
                    if (objCek != null) {
                        terpilih = (Boolean) objCek;
                    }

                    PreparedStatement pscarikapasitas = null;
                    ResultSet carikapasitas = null;
                    ...
                    try {
                        if (terpilih) {
                            ...
                            if (carikapasitas.next()) {
                                if (simpanDetailPemberianObat(
                                        i, DTPTgl, cmbJam, cmbMnt, cmbDtk, TNoRw, kdgudang,
                                        jml, harga, h_beli, tambahan1, tambahan2
                                    )) {
                                    updateTtl(
                                        i, DTPTgl, cmbJam, cmbMnt, cmbDtk, TNoRw, kdgudang,
                                        jml, harga, h_beli, tambahan1, tambahan2
                    ...
                    JOptionPane.showMessageDialog(
                        rootPane,
                        "Baris " + (i + 1) + " kolom Jumlah tidak valid.\nGunakan angka positif.",
                        "Kesalahan Input",
                    ...
                    if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 10).toString()) > 0) {
                        if (Sequel.menyimpantf2(
                            ...
                            if (Sequel.menyimpantf2(
                                ...
                                ttlhpp = ttlhpp + Math.round(
                                    Double.parseDouble(tbDetailObatRacikan.getValueAt(i, 5).toString()) *
                                    Double.parseDouble(tbDetailObatRacikan.getValueAt(i, 10).toString())
                                );
                                ...
                                if (aktifkanbatch.equals("yes")) {
                                    ...
                                    Sequel.menyimpan(
                                        ...
                                        tbDetailObatRacikan.getValueAt(i, 16).toString() + "','" +
                                        tbDetailObatRacikan.getValueAt(i, 17).toString() + "'",
                                        "stok=stok-'" + Double.parseDouble(tbDetailObatRacikan.getValueAt(i, 10).toString()) + "'",
                                        "kode_brng='" + tbDetailObatRacikan.getValueAt(i, 1).toString() +
                                        "' and kd_bangsal='" + kdgudang.getText() +
                                        "' and no_batch='" + tbDetailObatRacikan.getValueAt(i, 16).toString() +
                                        "' and no_faktur='" + tbDetailObatRacikan.getValueAt(i, 17).toString() + "'"
                                    );
                                } else {
                                    Trackobat.catatRiwayat(
                                        tbDetailObatRacikan.getValueAt(i, 1).toString(),
                                ...
                                if (aktifpcare.equals("yes")) {
                                    arrSplit = Sequel.cariIsi(
                                        "select aturan_pakai from obat_racikan where tgl_perawatan='" +
                                        Valid.SetTgl(DTPTgl.getSelectedItem() + "") +
                                        "' and jam='" + cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem() +
                                        "' and no_rawat='" + TNoRw.getText() +
                                        "' and no_racik='" + tbDetailObatRacikan.getValueAt(i, 0).toString() + "'"
                                    ).toLowerCase().split("x");
    ...
    private boolean simpanDetailPemberianObat(
        int i, Object DTPTgl, JComboBox cmbJam, JComboBox cmbMnt, JComboBox cmbDtk,
        JTextField TNoRw, JTextField kdgudang,
        double jml, double harga, double h_beli, double tambahan1, double tambahan2) {
    
        // ambil input tanggal dengan aman
        String tglTxt = "";
        if (DTPTgl instanceof JTextField) {
            tglTxt = ((JTextField) DTPTgl).getText().trim();
        } else if (DTPTgl instanceof String) {
            tglTxt = DTPTgl.toString().trim();
        }

        String tanggal = "";

        if (!tglTxt.isEmpty() && tglTxt.matches("\\d{4}-\\d{2}-\\d{2}")) {
            tanggal = tglTxt;
        } else {
            try {
                if (!tglTxt.isEmpty()) {
                    tanggal = Valid.SetTgl(tglTxt); // ddmmyyyy → YYYY-MM-DD
                } else {
                    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd/MM/yyyy");
                    tanggal = Valid.SetTgl(sdf.format(new Date()));
                ...
                JOptionPane.showMessageDialog(rootPane,
                    "Format tanggal tidak valid.\nData akan disimpan dengan tanggal default.",
                    "Peringatan", JOptionPane.WARNING_MESSAGE);
            }
        }

        if (tanggal.equals("1900-01-01")) {
            try {
                    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd/MM/yyyy");
                    tanggal = Valid.SetTgl(sdf.format(new Date()));
            } catch (Exception e) {
        ...
        String kodeBrng = tbObat.getValueAt(i, 2).toString();
        String noBatch = tbObat.getValueAt(i, 16).toString();
        String noFaktur = tbObat.getValueAt(i, 17).toString();

        double totalBiaya = Math.round((harga * jml));

        return Sequel.menyimpantf2("detail_pemberian_obat",
        "?,?,?,?,?,?,?,?,?,?,?,?,?,?",
        "data", 14, new String[]{
            tanggal,     // tgl_perawatan
            jam,         // jam
            TNoRw.getText(), kodeBrng,
            Double.toString(harga),
            Double.toString(harga),
            Double.toString(jml),
            "0", "0",
            Double.toString(totalBiaya),
            "Ralan", kdgudang.getText(), noBatch, noFaktur
        });
    }
    ...
    private void updateTtl(
        ...
        double biaya = Math.round((harga * jml));
        double hpp = Math.round(h_beli * jml);

        ttljual += biaya;
        ttlhpp += hpp;

        // Aturan pakai
        if (i < tbObat.getRowCount() &&
            tbObat.getValueAt(i, 11) != null &&
            !tbObat.getValueAt(i, 11).toString().trim().isEmpty()) {
            ...
            String jam = cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem();
            String kodeBrng = tbObat.getValueAt(i, 2).toString();
            String aturan = tbObat.getValueAt(i, 11).toString();

            Sequel.menyimpan("aturan_pakai", "?,?,?,?,?", 5,
                new String[]{tanggal, jam, TNoRw.getText(), kodeBrng, aturan});
        }

        // Batch & stok
        if (aktifkanbatch.equals("yes")) {
            String jmlStr = Double.toString(jml);

            Sequel.mengedit("data_batch",
                "no_batch=? and kode_brng=? and no_faktur=?", "sisa=sisa-?",
                4, new String[]{jmlStr, tbObat.getValueAt(i, 16).toString(),
                                tbObat.getValueAt(i, 2).toString(),
                                tbObat.getValueAt(i, 17).toString()});

            Trackobat.catatRiwayat(
                tbObat.getValueAt(i, 2).toString(), 0, jml,
                "Pemberian Obat", akses.getkode(), kdgudang.getText(),
                "Simpan", tbObat.getValueAt(i, 16).toString(),
                tbObat.getValueAt(i, 17).toString(),
                TNoRw.getText() + " " + TNoRM.getText() + " " + TPasien.getText());

            Sequel.menyimpan(
                "gudangbarang",
                "'" + tbObat.getValueAt(i, 2).toString() + "','" + kdgudang.getText() + "','-" + jmlStr + "','" + tbObat.getValueAt(i, 16).toString() + "','" + tbObat.getValueAt(i, 17).toString() + "'",
                "stok=stok-'"+ jmlStr +"'",
                "kode_brng='" + tbObat.getValueAt(i, 2).toString() + "' and kd_bangsal='" + kdgudang.getText() + "' and no_batch='" + tbObat.getValueAt(i, 16).toString() + "' and no_faktur='" + tbObat.getValueAt(i, 17).toString() + "'"
            );
            ...
            Trackobat.catatRiwayat(
                tbObat.getValueAt(i, 2).toString(), 0, jml,
                "Pemberian Obat", akses.getkode(), kdgudang.getText(),
                "Simpan", "", "", TNoRw.getText() + " " + TNoRM.getText() + " " + TPasien.getText());

            Sequel.menyimpan(
                "gudangbarang",
                "'" + tbObat.getValueAt(i, 2).toString() + "','" + kdgudang.getText() + "','-" + jmlStr + "','',''",
                "stok=stok-'"+ jmlStr +"'",
                "kode_brng='" + tbObat.getValueAt(i, 2).toString() + "' and kd_bangsal='" + kdgudang.getText() + "' and no_batch='' and no_faktur=''"
            );
        }

        // PCare
        if (aktifpcare.equals("yes")) {
            String aturan = (tbObat.getValueAt(i, 11) != null) ? tbObat.getValueAt(i, 11).toString().toLowerCase() : "1x1";
            String[] arrSplit = aturan.split("x");
            ...
            try {
                if (arrSplit.length > 1 && !arrSplit[1].replaceAll("[^0-9.]+", "").equals("")) {
                    signa2 = arrSplit[1].replaceAll("[^0-9.]+", "");
                }
            } catch (Exception e) {
                signa2 = "1";
            ...
            simpanObatPCare(
                nokunjungan, "false",
                Sequel.cariIsi("select kode_brng_pcare from maping_obat_pcare where kode_brng=?", tbObat.getValueAt(i, 2).toString()),
                signa1, signa2, Double.toString(jml), "0", "",
                TNoRw.getText(),
                tanggal,
                cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                tbObat.getValueAt(i, 2).toString(),
        ...
        // Update: etter - 1 di resep_dokter
        if (!NoResep.getText().trim().isEmpty()) {
            Sequel.mengedit("resep_dokter",
                "no_resep=? and kode_brng=? and aturan_pakai=?", "etter = etter - 1",
                3, new String[]{
                    NoResep.getText(),
                    tbObat.getValueAt(i, 2).toString(),
        ...
        // Update: kolom ulang (boolean → String "true"/"false")
        if (!NoResep.getText().trim().isEmpty()) {
            Boolean ulangBool = (Boolean) tbObat.getValueAt(i, 19);
            String ulangStr = (ulangBool != null && ulangBool) ? "true" : "false";

            Sequel.mengedit("resep_dokter",
                "no_resep=? and kode_brng=? and aturan_pakai=?", "ulang=?",
                4, new String[]{
                    ulangStr,
                    NoResep.getText(),
                    tbObat.getValueAt(i, 2).toString(),
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void tbObatRacikanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbObatRacikanKeyPressed
        if((evt.getKeyCode()==KeyEvent.VK_ENTER||evt.getKeyCode()==KeyEvent.VK_SPACE)&&
                tbObatRacikan.getSelectedRow()>=0){
            bukaDialogRacikan(true);
        }
    ...
    private void DiagnosaUtamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaUtamaKeyPressed
        Valid.pindah(evt,DiagnosaUtama,KodeDiagnosaUtama);
    ...
    private void KodeDiagnosaSekunder4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder4KeyPressed
        Valid.pindah(evt,DiagnosaSekunder4,KodeDiagnosaSekunder4);
                                    ...
                                    if(carikapasitas.next()){ 
                                        if (Valid.SetAngka(tbObat.getValueAt(i, 1).toString()) > 0) {
                                            ...
                                            Sequel.mengedit("resep_dokter", "no_resep=? and kode_brng=? and aturan_pakai=?", "ulang=?", 4, new String[]{
                                                ulangStr,NoResep.getText(),tbObat.getValueAt(i, 2).toString(),tbObat.getValueAt(i, 11).toString()
                                            });
                                        }      
                                    }else{ 
                                        if (Valid.SetAngka(tbObat.getValueAt(i, 1).toString()) > 0) {
    ...
    private boolean perluOtorisasiAntibiotik() {
        for (int row = 0; row < tbObat.getRowCount(); row++) {
            Object objJenis = tbObat.getValueAt(row, 7); // sesuaikan index kolom Jenis Obat
            if (objJenis != null) {
                String jenis = objJenis.toString().toLowerCase();
                if (jenis.contains("watch") || jenis.contains("reserve")) {
                    return true;
                }
            }
        }

        for (int row = 0; row < tbDetailObatRacikan.getRowCount(); row++) {
            Object objJenis = tbDetailObatRacikan.getValueAt(row, 7);
            if (objJenis != null) {
                String jenis = objJenis.toString().toLowerCase();
                if (jenis.contains("watch") || jenis.contains("reserve")) {
                    return true;
    ...
    private boolean validasiPassphrasePPRA(String passphrase) {
        otorisasiPPRAValid = false;
        nipOtorisasiPPRA = "";

        try {
            String nip = Sequel.cariIsi(
                "select nip from ppra_user where passphrase=? and status='AKTIF'",
                passphrase
            );

            if (nip != null && !nip.trim().equals("")) {
                nipOtorisasiPPRA = nip;
                otorisasiPPRAValid = true;
                return true;
            }
        } catch (Exception e) {
            System.out.println("Notifikasi validasi PPRA : " + e);
        }
    ...
    private void BtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLoginActionPerformed
        if (edPwd.getText().trim().equals("")) {
            Valid.textKosong(edPwd, "Passphrase");
            return;
        }

        if (validasiPassphrasePPRA(edPwd.getText().trim())) {
            JOptionPane.showMessageDialog(null, "Otorisasi berhasil.");
            DlgPass.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Passphrase tidak valid.");
            edPwd.setText("");
            edPwd.requestFocus();
        }
    ...
    */
    ...
    private double angkaRacikan(Object nilai){
        try{
            return Double.parseDouble(nilai==null?"0":nilai.toString().replace(",","."));
        }catch(Exception e){
            return 0;
        }
    }

    private String nilaiRacikan(DefaultTableModel model,int baris,int kolom){
        Object nilai=model.getValueAt(baris,kolom);
        return nilai==null?"":nilai.toString();
    }

    private int nomorRacikanBerikut(){
        for(int nomor=1;nomor<=98;nomor++){
            boolean digunakan=false;
            for(int baris=0;baris<tabModeObatRacikan.getRowCount();baris++){
                if(nomor==(int)angkaRacikan(tabModeObatRacikan.getValueAt(baris,0))){
                    digunakan=true;
                    break;
                }
            }
    ...
    private void bukaDialogRacikan(boolean edit){
        ...
        if(edit&&barisEdit<0){
            JOptionPane.showMessageDialog(null,"Pilih racikan yang akan diedit.");
            return;
        }

        java.util.List<DlgInputTemplateRacikan.Detail> katalog=buatKatalogRacikan();
        if(katalog.isEmpty()){
            JOptionPane.showMessageDialog(null,"Daftar obat pada depo aktif masih kosong.");
            return;
        }

        boolean tambahLagi;
        do{
            int nomor=barisEdit>=0?(int)angkaRacikan(tabModeObatRacikan.getValueAt(barisEdit,0)):
                    nomorRacikanBerikut();
            if(nomor<1){
            ...
            dialog.setJudulDialog(barisEdit>=0?"Edit Racikan Obat":"Tambah Racikan Obat");
            dialog.setKatalogObat(katalog);
            if(barisEdit>=0){
                dialog.setData(noRacik,nilaiRacikan(tabModeObatRacikan,barisEdit,1),
                        nilaiRacikan(tabModeObatRacikan,barisEdit,2),
                        angkaRacikan(tabModeObatRacikan.getValueAt(barisEdit,4)),
                        nilaiRacikan(tabModeObatRacikan,barisEdit,5),
                        nilaiRacikan(tabModeObatRacikan,barisEdit,6),ambilDetailRacikan(noRacik));
            }else{
                dialog.setData(noRacik,"","",0,"","",new java.util.ArrayList<>());
            }
    ...
    private java.util.List<DlgInputTemplateRacikan.Detail> buatKatalogRacikan(){
        String pencarian=TCari.getText();
        memuatKatalogRacikan=true;
        try{
            TCari.setText("");
            tampilobat();
            TCari.setText(pencarian);
        }finally{
            memuatKatalogRacikan=false;
        }

        java.util.Map<String,Double> kapasitasBarang=new java.util.HashMap<>();
        try(PreparedStatement pst=koneksi.prepareStatement(
                "select kode_brng,kapasitas from databarang where status='1'");
            ResultSet rst=pst.executeQuery()){
            while(rst.next()){
                kapasitasBarang.put(rst.getString(1),rst.getDouble(2));
            }
        }catch(Exception e){
            System.out.println("Notif Kapasitas Katalog Racikan : "+e);
        }

        java.util.Map<String,DlgInputTemplateRacikan.Detail> katalog=new java.util.LinkedHashMap<>();
        for(int baris=0;baris<tabModeobat.getRowCount();baris++){
            String kode=nilaiRacikan(tabModeobat,baris,2);
            if(kode.isEmpty()||katalog.containsKey(kode)){
                continue;
            }
            DlgInputTemplateRacikan.Detail detail=new DlgInputTemplateRacikan.Detail();
            detail.kodeBarang=kode;
            detail.namaBarang=nilaiRacikan(tabModeobat,baris,3);
            detail.satuan=nilaiRacikan(tabModeobat,baris,4);
            detail.komposisi=nilaiRacikan(tabModeobat,baris,5);
            detail.harga=angkaRacikan(tabModeobat.getValueAt(baris,6));
            detail.jenis=nilaiRacikan(tabModeobat,baris,7);
            detail.stok=angkaRacikan(tabModeobat.getValueAt(baris,10));
            detail.industri=nilaiRacikan(tabModeobat,baris,12);
            detail.hargaBeli=angkaRacikan(tabModeobat.getValueAt(baris,13));
            detail.kategori=nilaiRacikan(tabModeobat,baris,14);
            detail.golongan=nilaiRacikan(tabModeobat,baris,15);
            detail.noBatch=nilaiRacikan(tabModeobat,baris,16);
            detail.noFaktur=nilaiRacikan(tabModeobat,baris,17);
            detail.kadaluarsa=nilaiRacikan(tabModeobat,baris,18);
            detail.kapasitas=kapasitasBarang.containsKey(kode)?kapasitasBarang.get(kode):0;
            katalog.put(kode,detail);
        }
        return new java.util.ArrayList<>(katalog.values());
    }

    private java.util.List<DlgInputTemplateRacikan.Detail> ambilDetailRacikan(String noRacik){
        java.util.List<DlgInputTemplateRacikan.Detail> detail=new java.util.ArrayList<>();
        for(int baris=0;baris<tabModeDetailObatRacikan.getRowCount();baris++){
            if(noRacik.equals(nilaiRacikan(tabModeDetailObatRacikan,baris,0))){
                DlgInputTemplateRacikan.Detail obat=new DlgInputTemplateRacikan.Detail();
                obat.kodeBarang=nilaiRacikan(tabModeDetailObatRacikan,baris,1);
                obat.namaBarang=nilaiRacikan(tabModeDetailObatRacikan,baris,2);
                obat.satuan=nilaiRacikan(tabModeDetailObatRacikan,baris,3);
                obat.harga=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,4));
                obat.hargaBeli=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,5));
                obat.jenis=nilaiRacikan(tabModeDetailObatRacikan,baris,6);
                obat.stok=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,7));
                obat.kapasitas=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,8));
                obat.kandungan=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,9));
                obat.jumlah=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,10));
                obat.embalase=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,11));
                obat.tuslah=angkaRacikan(tabModeDetailObatRacikan.getValueAt(baris,12));
                obat.industri=nilaiRacikan(tabModeDetailObatRacikan,baris,13);
                obat.kategori=nilaiRacikan(tabModeDetailObatRacikan,baris,14);
                obat.golongan=nilaiRacikan(tabModeDetailObatRacikan,baris,15);
                obat.noBatch=nilaiRacikan(tabModeDetailObatRacikan,baris,16);
                obat.noFaktur=nilaiRacikan(tabModeDetailObatRacikan,baris,17);
                obat.kadaluarsa=nilaiRacikan(tabModeDetailObatRacikan,baris,18);
                detail.add(obat);
            }
        }
        return detail;
    ...
    private void simpanCacheRacikan(DlgInputTemplateRacikan dialog,int barisEdit){
        ...
        Object[] header={noRacik,dialog.getNamaRacik(),dialog.getKodeMetode(),dialog.getNamaMetode(),
            dialog.getJumlahRacik(),dialog.getAturanPakai(),dialog.getKeterangan()};
        if(barisEdit>=0){
        ...
        for(DlgInputTemplateRacikan.Detail obat:dialog.getDetail()){
            tabModeDetailObatRacikan.addRow(new Object[]{noRacik,obat.kodeBarang,obat.namaBarang,
                obat.satuan,obat.harga,obat.hargaBeli,obat.jenis,obat.stok,obat.kapasitas,
                obat.kandungan,obat.jumlah,obat.embalase,obat.tuslah,obat.industri,obat.kategori,
                obat.golongan,obat.noBatch,obat.noFaktur,obat.kadaluarsa});
        }
    ...
    private void hapusRacikanTerpilih(){
        ...
        String noRacik=nilaiRacikan(tabModeObatRacikan,baris,0);
        if(JOptionPane.showConfirmDialog(null,"Hapus racikan "+nilaiRacikan(tabModeObatRacikan,baris,1)+"?",
                "Konfirmasi",JOptionPane.YES_NO_OPTION)!=JOptionPane.YES_OPTION){
            return;
        }
        tabModeObatRacikan.removeRow(baris);
        for(int i=tabModeDetailObatRacikan.getRowCount()-1;i>=0;i--){
            if(noRacik.equals(nilaiRacikan(tabModeDetailObatRacikan,i,0))){
    ...
    private String hitungSisaObat(ResultSet hasil) throws SQLException {
        String jumlahMaksimal=hasil.getString("jml_max");
        String jumlahTerakhir=hasil.getString("jml_terakhir");
        if(jumlahMaksimal==null||jumlahMaksimal.trim().isEmpty()||
                jumlahTerakhir==null||jumlahTerakhir.trim().isEmpty()){
            return "";
        }
        try{
            double terakhir=Double.parseDouble(jumlahTerakhir);
            if(terakhir<=0){
                return "";
            }
            double sisa=Double.parseDouble(jumlahMaksimal)-terakhir;
            return sisa==(long)sisa?String.valueOf((long)sisa):String.valueOf(sisa);
        }catch(NumberFormatException e){
            return "";
        }
    }
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<tbObat.getRowCount();i++){
            if(!tbObat.getValueAt(i,1).toString().equals("")){
                ...
                eb[z]=tbObat.getValueAt(i,8).toString();
                ts[z]=tbObat.getValueAt(i,9).toString();
                ...
                editIterasi[z]=Boolean.parseBoolean(tbObat.getValueAt(i,19).toString());
                ulangi[z]=tbObat.getValueAt(i,20).toString();
                ejum[z]=tbObat.getValueAt(i,21).toString();
        ...
        for(i=0;i<z;i++){
            tabModeobat.addRow(new Object[] {
                ...
                eb[i],ts[i],stok[i],aturan[i],industri[i],beli[i],kategori[i],golongan[i],nobatch[i],nofaktur[i],kadaluarsa[i],editIterasi[i],ulangi[i],ejum[i]
            });
        }
        ...
        try {
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    if(aktifpcare.equals("yes")){
                        sql="select data_batch.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(data_batch.h_beli+(data_batch.h_beli*?)) as harga,"+
                            ...
                            " data_batch.no_batch,data_batch.no_faktur,data_batch.tgl_kadaluarsa,gudangbarang.stok,data_batch."+hppfarmasi+" as dasar, COALESCE(pernah_diberikan.jml_terakhir, '') as jml_terakhir, COALESCE(pernah_diberikan.vvip, '') as jml_max  "+
                            ...
                            " WHERE e.no_rkm_medis =? " +
                            " AND b.kd_pj = 'BPJ' " +
                            " AND b.tgl_registrasi >= DATE_SUB(NOW(), INTERVAL 30 DAY) " +
                            " AND c.kode_brng IN (SELECT db.kode_brng FROM databarang db WHERE db.kode_golongan IN ('G04','G05')) " +
                            " GROUP BY c.kode_brng " +
                            " )pernah_diberikan ON pernah_diberikan.kode_brng = databarang.kode_brng ";
                    }else{
                        sql="select data_batch.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(data_batch.h_beli+(data_batch.h_beli*?)) as harga,"+
                            " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,golongan_barang.nama as golongan,"+
                            " data_batch.no_batch,data_batch.no_faktur,data_batch.tgl_kadaluarsa,gudangbarang.stok,data_batch."+hppfarmasi+" as dasar, COALESCE(pernah_diberikan.jml_terakhir, '') as jml_terakhir, COALESCE(pernah_diberikan.vvip, '') as jml_max  "+
                    ...
                    try{
                        ...
                        psobat.setString(2, TNoRM.getText().trim());
                        ...
                        while(rsobat.next()){
                            ...
                            tabModeobat.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                               ...
                               rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hasilKurangText,rsobat.getDouble("stok"),"",rsobat.getString("nama_industri"),
                               rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),
                               rsobat.getString("no_batch"),rsobat.getString("no_faktur"),rsobat.getString("tgl_kadaluarsa"),false,"","3"
                            });          
                        }
                    }catch(Exception e){
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                            " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,gudangbarang.stok,golongan_barang.nama as golongan,databarang."+hppfarmasi+" as dasar, COALESCE(pernah_diberikan.jml_terakhir, '') as jml_terakhir, COALESCE(pernah_diberikan.vvip, '') as jml_max  "+
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            tabModeobat.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                               rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                               rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hasilKurangText,rsobat.getDouble("stok"),"",rsobat.getString("nama_industri"),
                               rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","","",false,"","3"
                            });          
                        }
                    }catch(Exception e){
                        System.out.println("Notifikasi : "+e);
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    try{
                        psobat.setString(1, TNoRM.getText().trim());
                        ...
                        if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                            while(rsobat.next()){
                                tabModeobat.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   ...
                                   rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hitungSisaObat(rsobat),rsobat.getDouble("stok"),"",rsobat.getString("nama_industri"),
                                   rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),
                                   rsobat.getString("no_batch"),rsobat.getString("no_faktur"),rsobat.getString("tgl_kadaluarsa"),false,"","3"
                                });           
                            }
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.karyawan,databarang.ralan,databarang.beliluar,gudangbarang.stok,"+
                            " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,golongan_barang.nama as golongan,databarang."+hppfarmasi+" as dasar, COALESCE(pernah_diberikan.jml_terakhir, '') as jml_terakhir, COALESCE(pernah_diberikan.vvip, '') as jml_max  "+
                            " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                            " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                            " inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode "+
                            " inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode "+
                        ...
                        if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                            while(rsobat.next()){
                                tabModeobat.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("karyawan"),100),
                                   rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hitungSisaObat(rsobat),rsobat.getDouble("stok"),"",rsobat.getString("nama_industri"),
                                   rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","","",false,"",""
                                });     
                            }
                        }else if(Jeniskelas.getSelectedItem().equals("Rawat Jalan")){
                            while(rsobat.next()){
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getString("ulang").equals("true")){
                                ulang="Ulangi";
                            }else if(rsobat.getString("ulang").equals("false")){
                                ulang="-";
                            }
                            String jmlMax         = rsobat.getString("jml_max");
                            String jmlTerakhir    = rsobat.getString("jml_terakhir");
                            ...
                            // konversi rsobat.getString("ulang") ke boolean
                            String ulangStr = rsobat.getString("ulang");
                            boolean ulangBool = Boolean.parseBoolean(ulangStr); 
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                tabModeobat.addRow(new Object[] {
                                   ...
                                   rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hasilKurangText,sisacari,rsobat.getString("aturan_pakai"),rsobat.getString("nama_industri"),
                                   h_belicari,rsobat.getString("kategori"),rsobat.getString("golongan"),no_batchcari,no_fakturcari,tgl_kadaluarsacari,ulangBool,rsobat.getString("stts"),rsobat.getString("etter")
                                });   
                            }else{
                                tabModeobat.addRow(new Object[] {
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                tabModeobat.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                                   rsobat.getString("nama"),rsobat.getString("jml_terakhir"),hasilKurangText,sisacari,rsobat.getString("aturan_pakai"),rsobat.getString("nama_industri"),
                                   rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","","",ulangBool,rsobat.getString("stts"),rsobat.getString("etter")
                                });   
                            }else{
    ...
    public void tampildetailracikanobat() {        
        ...
        for(i=0;i<tbDetailObatRacikan.getRowCount();i++){
            if(Valid.SetAngka(tbDetailObatRacikan.getValueAt(i,10).toString())>0){
                ...
                eb[z]=tbObat.getValueAt(i,11).toString();
                ts[z]=tbObat.getValueAt(i,12).toString();
