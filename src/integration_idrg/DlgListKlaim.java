...
public final class DlgListKlaim extends javax.swing.JDialog {
    ...
    public DlgListKlaim(java.awt.Frame parent, boolean modal) {
        ...
        Object[] columns = new String[]{
            ...
            "Tgl SEP[7]", "Tgl. Regis[8]", "Tgl Pulang[9]", "Set Data Klaim[10]", "Final iDrg[11]", "Final iNaCbg[12]",
            "Final Klaim[13]", "Berkas Individual Klaim[14]", "Kirim Online[15]"};
        ...
        Object[] columnsRanap = new String[]{"P", "No Rawat[1]", "No RM[2]", "Nama Pasien[3]", "Unit[4]", "Nama Dokter[5]", "No SEP[6]",
            "Tgl SEP[7]", "Tgl. Regis[8]", "Tgl Pulang[9]", "Set Data Klaim[10]", "Final iDrg[11]", "Final iNaCbg[12]",
            "Final Klaim[13]", "Berkas Individual Klaim[14]", "Kirim Online[15]"};
    ...
    private void initComponents() {
        ...
        jTextField7.setBackground(new java.awt.Color(178, 223, 219));
        ...
        jLabel44.setText("Sudah Kirim Data Klaim");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput1.add(jLabel44);
        jLabel44.setBounds(100, 50, 290, 23);

        jTextField4.setEditable(false);
        jTextField4.setBackground(new java.awt.Color(144, 202, 249));
        ...
        jLabel46.setText("Sudah Final Idrg");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput1.add(jLabel46);
        jLabel46.setBounds(100, 80, 320, 23);

        jTextField8.setEditable(false);
        jTextField8.setBackground(new java.awt.Color(179, 157, 219));
        ...
        jLabel49.setText("Sudah Final InaCbg");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput1.add(jLabel49);
        jLabel49.setBounds(100, 110, 320, 23);

        jTextField9.setEditable(false);
        jTextField9.setBackground(new java.awt.Color(165, 214, 167));
        ...
        jLabel50.setText("Sudah Kirim Online");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput1.add(jLabel50);
        jLabel50.setBounds(100, 200, 320, 23);

        jTextField10.setEditable(false);
        jTextField10.setBackground(new java.awt.Color(206, 147, 216));
        ...
        jLabel51.setText("Sudah Final Klaim");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput1.add(jLabel51);
        jLabel51.setBounds(100, 140, 320, 23);

        jTextField11.setEditable(false);
        jTextField11.setBackground(new java.awt.Color(255, 204, 128));
        ...
        jLabel52.setText("Bekas Individual Ada");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Pasien JKN ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPTglAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2025" }));
        ...
        DTPTglAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2025" }));
    ...
    private void tampilRalan() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    String SetDataKlaim = "-", FinalIdrg = "-", FinalInaCbg = "-", FinalKlaim = "-", BekasIndividualKlaim = "-", KirimOnline = "-";
...
// Cek berkas individual dari tb_eklaim_grouping_result
int jmlFileIndividual = Sequel.cariInteger(
    "select count(file_individual) from tb_eklaim_grouping_result " +
    "where no_rawat='" + rs.getString("no_rawat") + "' " +
    "and file_individual is not null and file_individual<>''"
);
BekasIndividualKlaim = (jmlFileIndividual > 0) ? "Sudah Ada" : "Belum";
                    int statusBerkas = Sequel.cariInteger("select count(no_rawat) as total from tt_status_eklaim where   no_rawat='" + rs.getString("no_rawat") + "'");
                    if (statusBerkas > 0) {
    SetDataKlaim = tampilStatusBoolean(
        Sequel.cariIsi("select set_data_klaim from tt_status_eklaim where no_rawat='" + rs.getString("no_rawat") + "'")
    );
    FinalIdrg = tampilStatusBoolean(
        Sequel.cariIsi("select final_idrg from tt_status_eklaim where no_rawat='" + rs.getString("no_rawat") + "'")
    );
    FinalInaCbg = tampilStatusBoolean(
        Sequel.cariIsi("select final_inacbg from tt_status_eklaim where no_rawat='" + rs.getString("no_rawat") + "'")
    );
    FinalKlaim = tampilStatusBoolean(
        Sequel.cariIsi("select final_klaim from tt_status_eklaim where no_rawat='" + rs.getString("no_rawat") + "'")
    );
//    BekasIndividualKlaim = tampilStatusBoolean(
//        Sequel.cariIsi("select file_individual from tb_eklaim_grouping_result where no_rawat='" + rs.getString("no_rawat") + "'")
//    );
    KirimOnline = tampilStatusBoolean(
        Sequel.cariIsi("select Kirim_Online from tt_status_eklaim where no_rawat='" + rs.getString("no_rawat") + "'")
    );
} else {
    SetDataKlaim = "Belum";
    FinalIdrg = "Belum";
    ...
    KirimOnline = "Belum";
                    ...
                    TabModePasienRalan.addRow(new Object[]{
                        ...
                        SetDataKlaim, FinalIdrg, FinalInaCbg, FinalKlaim, BekasIndividualKlaim, KirimOnline
                    });
                }
            } catch (Exception e) {
...
//                        false, rs.getString("no_rawat"), rs.getString("no_rkm_medis"), rs.getString("nm_pasien"), kamar, noSep, tglSep, StatusKoding, StatusKirim, fileSep, fileResume, fileLaboratorium, fileRadiologi, fileusg, fileBilling, fileindividual
    ...
    // === Helper konversi DB -> "Sudah"/"Belum" ===
private String tampilStatusBoolean(String value) {
    if (value == null) {
        // kalau null anggap saja Belum
        return "Belum";
    }

    String v = value.trim();

    // Semua kemungkinan TRUE
