...
public class DlgFrekuensiPenyakitRalan2 extends javax.swing.JDialog {
    ...
    private DlgCariPoli poli2=new DlgCariPoli(null,false);
    ...
    public DlgFrekuensiPenyakitRalan2(java.awt.Frame parent, boolean modal) {
        ...
        poli2.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(poli.getTable().getSelectedRow()!= -1){
                    kdpoli1.setText(poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(),0).toString());
                    nmpoli1.setText(poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(),1).toString());
                }      
            ...
            public void windowDeiconified(WindowEvent e) {}
            @Override
            public void windowActivated(WindowEvent e) {poli2.emptTeks();}
            @Override
            public void windowDeactivated(WindowEvent e) {}
        });
    ...
    private void initComponents() {
        ...
        BtnSeek3.setBounds(400, 100, 28, 23);
        ...
        BtnSeek4.setBounds(400, 70, 28, 23);
        ...
        kdpoli1.setBounds(80, 40, 85, 23);

        nmpoli1.setEditable(false);
        nmpoli1.setName("nmpoli1"); // NOI18N
        nmpoli1.setPreferredSize(new java.awt.Dimension(215, 23));
        FormInput.add(nmpoli1);
        nmpoli1.setBounds(167, 40, 228, 23);
        ...
        BtnSeek8.setBounds(400, 40, 28, 23);
    ...
    private void tampil() {
        ...
        try{ 
            ps=koneksi.prepareStatement(
                ...
                "where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and ( poliklinik.nm_poli LIKE ? or  poliklinik.nm_poli LIKE ? ) and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and penyakit.kd_penyakit like ? or "+
                "diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and ( poliklinik.nm_poli LIKE ? or  poliklinik.nm_poli LIKE ? ) and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and penyakit.nm_penyakit like ? "+
                "group by penyakit.kd_penyakit order by penyakit.kd_penyakit");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,"%"+nmpoli.getText().trim()+"%");
                ps.setString(4,"%"+nmpoli1.getText().trim()+"%");
                ...
                ps.setString(13,"%"+nmpoli.getText().trim()+"%");
                ps.setString(14,"%"+nmpoli1.getText().trim()+"%");
                ps.setString(15,"%"+nmdokter.getText().trim()+"%");
                ps.setString(16,"%"+nmpenjab.getText().trim()+"%");
                ps.setString(17,"%"+nmkabupaten.getText().trim()+"%");
                ps.setString(18,"%"+nmkecamatan.getText().trim()+"%");
                ps.setString(19,"%"+nmkelurahan.getText().trim()+"%");
