...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    public DlgSensusHarianRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabmode=new DefaultTableModel(null,new String[]{
                "No.","Nomor RM","Nama Pasien","NIK","Tgl.Lahir","Tgl.Daftar","Poliklinik","Dokter",
    ...
    public void tampil(){        
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                       ...
                       "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,pasien.tgl_lahir,"+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabmode.addRow(new String[]{
                        i+"",rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("no_ktp"),rs.getString("tgl_lahir"),
