...
public final class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","No.Telfon","NIK","Kode","Diagnosa","Dokter Jaga"}){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","No.Telfon","NIK","Kode","Diagnosa","Dokter Jaga"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,pasien.no_tlp,pasien.no_ktp,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar " +
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),rs.getString("no_tlp"),rs.getString("no_ktp"),kddiangnosa,diagnosa,rs.getString("nm_dokter")
                    });                
                    i++;
                }
                if(i>=2){
