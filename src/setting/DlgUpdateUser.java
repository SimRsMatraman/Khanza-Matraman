...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            pemeriksaan_fisik_ralan_per_penyakit=false,satu_sehat_kirim_diet=false,satu_sehat_mapping_obat=false,satu_sehat_kirim_medication=false,satu_sehat_kirim_medicationrequest=false,satu_sehat_kirim_medicationdispense=false,
            satu_sehat_mapping_radiologi=false,satu_sehat_kirim_servicerequest_radiologi=false,satu_sehat_kirim_specimen_radiologi=false,satu_sehat_mapping_lab=false,satu_sehat_kirim_servicerequest_lab=false,
            satu_sehat_kirim_servicerequest_labmb=false,satu_sehat_kirim_specimen_lab=false,satu_sehat_kirim_specimen_labmb=false,satu_sehat_kirim_observation_radiologi=false,satu_sehat_kirim_diagnosticreport_radiologi=false,
    ...
    */
    ...
    private void tampil(String user) {  
        ...
        checklist_kriteria_masuk_icu=false;checklist_kriteria_keluar_icu=false;akses_dokter_lain_rawat_jalan=false;follow_up_dbd=false;penilaian_risiko_jatuh_neonatus=false;validasi_pengajuan_biaya=false;
        pemeriksaan_fisik_ralan_per_penyakit=false;satu_sehat_kirim_diet=false;satu_sehat_mapping_obat=false;satu_sehat_kirim_medication=false;satu_sehat_kirim_medicationrequest=false;satu_sehat_kirim_medicationdispense=false;
        satu_sehat_mapping_radiologi=false;satu_sehat_kirim_servicerequest_radiologi=false;satu_sehat_kirim_specimen_radiologi=false;satu_sehat_kirim_observation_radiologi=false;satu_sehat_kirim_diagnosticreport_radiologi=false;
        ...
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.satu_sehat_mapping_lab,user.surat_persetujuan_rawat_inap,user.monitoring_reaksi_tranfusi,user.penilaian_korban_kekerasan,user.penilaian_lanjutan_resiko_jatuh_lansia,"+
                "user.satu_sehat_kirim_observation_radiologi,user.satu_sehat_kirim_diagnosticreport_radiologi,user.penilaian_pasien_penyakit_menular,user.mpp_skrining,user.edukasi_pasien_keluarga_rj,user.pemantauan_pews_dewasa,user.penilaian_tambahan_bunuh_diri,"+
                "user.satu_sehat_kirim_specimen_radiologi,user.bpjs_antrean_pertanggal,user.penilaian_tambahan_perilaku_kekerasan,user.penilaian_tambahan_beresiko_melarikan_diri,user.persetujuan_penundaan_pelayanan,"+
                "user.satu_sehat_mapping_radiologi,user.satu_sehat_kirim_servicerequest_radiologi,user.sisa_diet_pasien,user.penilaian_awal_medis_ralan_bedah_mulut,user.penilaian_pasien_keracunan,user.pemantauan_meows_obstetri,user.catatan_adime_gizi,"+
                "user.satu_sehat_kirim_medicationrequest,user.satu_sehat_kirim_medicationdispense,user.pengajuan_biaya,user.penilaian_awal_keperawatan_ralan_geriatri,user.master_masalah_keperawatan_geriatri,user.master_rencana_keperawatan_geriatri,"+
                "user.checklist_kriteria_masuk_hcu,user.checklist_kriteria_keluar_hcu,user.penilaian_risiko_dekubitus,user.master_menolak_anjuran_medis,user.satu_sehat_kirim_medication,user.penolakan_anjuran_medis,"+
                "user.laporan_tahunan_penolakan_anjuran_medis,user.template_laporan_operasi,user.satu_sehat_kirim_diet,user.satu_sehat_mapping_obat,user.hasil_tindakan_eswl,user.checklist_kriteria_masuk_icu,"+
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    satu_sehat_kirim_diet=rs.getBoolean("satu_sehat_kirim_diet");satu_sehat_mapping_obat=rs.getBoolean("satu_sehat_mapping_obat");satu_sehat_kirim_medication=rs.getBoolean("satu_sehat_kirim_medication");satu_sehat_kirim_medicationrequest=rs.getBoolean("satu_sehat_kirim_medicationrequest");
                    satu_sehat_kirim_medicationdispense=rs.getBoolean("satu_sehat_kirim_medicationdispense");satu_sehat_mapping_radiologi=rs.getBoolean("satu_sehat_mapping_radiologi");satu_sehat_kirim_servicerequest_radiologi=rs.getBoolean("satu_sehat_kirim_servicerequest_radiologi");satu_sehat_kirim_specimen_radiologi=rs.getBoolean("satu_sehat_kirim_specimen_radiologi");
                    satu_sehat_kirim_observation_radiologi=rs.getBoolean("satu_sehat_kirim_observation_radiologi");satu_sehat_kirim_diagnosticreport_radiologi=rs.getBoolean("satu_sehat_kirim_diagnosticreport_radiologi");satu_sehat_mapping_lab=rs.getBoolean("satu_sehat_mapping_lab");satu_sehat_kirim_servicerequest_lab=rs.getBoolean("satu_sehat_kirim_servicerequest_lab");
