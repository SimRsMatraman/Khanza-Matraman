 ...
 * @author dosen
 */
public class InventarisKondisi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisKondisi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"ID Kondisi","Nama Kondisi Inventaris"};
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID Kondisi :");
        jLabel3.setName("jLabel3"); // NOI18N
        panelGlass7.add(jLabel3);
        jLabel3.setBounds(2, 12, 72, 23);

        jLabel4.setText("Nama Kondisi :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"ID kondisi");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama kondisi");
        }else{
            Sequel.menyimpan("inventaris_kondisi","'"+TKd.getText()+"','"+TNm.getText()+"'","ID kondisi");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"inventaris_kondisi","id_kondisi");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("inventaris_kondisi","id_kondisi=?","id_kondisi=?,nama_kondisi=?",3,new String[]{
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from inventaris_kondisi where id_kondisi like '%"+TCari.getText().trim()+"%' "+
                "or nama_kondisi like '%"+TCari.getText().trim()+"%' ");
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        TCari.setText("");
        prosesCari("select * from inventaris_kondisi order by id_kondisi");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisKondisi dialog = new InventarisKondisi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        String sql="select * from inventaris_kondisi order by id_kondisi";
        prosesCari(sql);
    }
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"KND",3,TKd);
        TKd.requestFocus();
    }
