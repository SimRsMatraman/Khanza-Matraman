...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    public SuratKeteranganSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tensi","Suhu","Buta Warna","Kesehatan Mata","Keperluan","Kesimpulan","Catatan"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratSehatENG = new javax.swing.JMenuItem();
        MnCetakSuratSehatSign = new javax.swing.JMenuItem();
        MnCetakSuratKhusus = new javax.swing.JMenuItem();
        MnCetakSuratKhususSign = new javax.swing.JMenuItem();
        ...
        MnCetakSuratSehatENG.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratSehatENG.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratSehatENG.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratSehatENG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratSehatENG.setText("Cetak Surat Sehat (Inggris)");
        MnCetakSuratSehatENG.setName("MnCetakSuratSehatENG"); // NOI18N
        MnCetakSuratSehatENG.setPreferredSize(new java.awt.Dimension(200, 26));
        MnCetakSuratSehatENG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratSehatENGActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratSehatENG);

        MnCetakSuratSehatSign.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratSehatSign.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratSehatSign.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratSehatSign.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratSehatSign.setText("Cetak Surat Sehat (e-sign)");
        MnCetakSuratSehatSign.setName("MnCetakSuratSehatSign"); // NOI18N
        MnCetakSuratSehatSign.setPreferredSize(new java.awt.Dimension(200, 26));
        MnCetakSuratSehatSign.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratSehatSignActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratSehatSign);

        MnCetakSuratKhusus.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratKhusus.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratKhusus.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratKhusus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKhusus.setText("Cetak Surat Khusus");
        MnCetakSuratKhusus.setToolTipText("");
        MnCetakSuratKhusus.setName("MnCetakSuratKhusus"); // NOI18N
        MnCetakSuratKhusus.setPreferredSize(new java.awt.Dimension(200, 26));
        MnCetakSuratKhusus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratKhususActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratKhusus);

        MnCetakSuratKhususSign.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratKhususSign.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratKhususSign.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratKhususSign.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKhususSign.setText("Cetak Surat Khusus - Esign");
        MnCetakSuratKhususSign.setToolTipText("");
        MnCetakSuratKhususSign.setName("MnCetakSuratKhususSign"); // NOI18N
        MnCetakSuratKhususSign.setPreferredSize(new java.awt.Dimension(200, 26));
        MnCetakSuratKhususSign.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratKhususSignActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratKhususSign);
        ...
        MnCetakSuratSKBN.setText("Surat SKBN");
        MnCetakSuratSKBN.setToolTipText("");
        MnCetakSuratSKBN.setName("MnCetakSuratSKBN"); // NOI18N
        MnCetakSuratSKBN.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        MnCetakSuratSehat1.setText("Cetak Surat Sehat (sesuai alamat)");
        MnCetakSuratSehat1.setToolTipText("");
        ...
        jLabel3.setBounds(920, 40, 60, 23);
        ...
        jLabel20.setBounds(260, 70, 30, 23);
        ...
        jLabel28.setBounds(740, 40, 60, 23);
        ...
        CmbButaWarna.setBounds(810, 70, 100, 23);

        CmbKesimpulan.setEditable(true);
        CmbKesimpulan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sehat", "Tidak Sehat", "Sehat Dengan Catatan" }));
        ...
        CmbKesimpulan.setBounds(810, 40, 100, 23);
        ...
        jLabel30.setBounds(730, 70, 70, 23);

        jLabel31.setText("Catatan :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(740, 10, 60, 23);
        ...
        Catatan.setBounds(810, 10, 400, 23);
        ...
        scrollPane5.setBounds(990, 40, 220, 50);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_sehat","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,berat=?,tinggi=?,BMI=?,tensi=?,suhu=?,butawarna=?,tesmata=?,keperluan=?,kesimpulan=?,catatan=?",14,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKeteranganSehat.jasper","report","::[ Data Surat Keterangan Sehat ]::",
                     ...
                     "surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.BMI,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu,surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata, "+                  
                     "surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan from surat_keterangan_sehat inner join reg_periksa on surat_keterangan_sehat.no_rawat=reg_periksa.no_rawat "+
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehat.jasper","report","::[ Surat Keterangan Sehat ]::",
                              ...
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan,dokter.nm_dokter,dokter.no_ijn_praktek,dokter.nip1,pasien.jk,reg_periksa.kd_dokter," +
    ...
    private void MnCetakSuratSehatSignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatSignActionPerformed
    if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    //
    }//GEN-LAST:event_MnCetakSuratSehatSignActionPerformed
           ...
           if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehat3.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.BMI,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan,dokter.nm_dokter,dokter.no_ijn_praktek,dokter.nip1,pasien.jk,reg_periksa.kd_dokter," +
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.alamat,concat(kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as nm_alamat" +
                              " from surat_keterangan_sehat inner join reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten" +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and "+
                              " pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.no_rawat=surat_keterangan_sehat.no_rawat "+
                              " where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
    ...
    if (TPasien.getText().trim().equals("")) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                ...
                resume.setNoRm(TNoRw.getText(), TNoRM.getText(), TPasien.getText(), kodedokter, namadokter, DTPCari1.getDate(), DTPCari2.getDate());
                resume.tampil();
    ...
    private void CatatanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CatatanKeyPressed
        Valid.pindah(evt,CmbKesimpulan,Keperluan);
    ...
    private void MnCetakSuratKhususActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKhususActionPerformed
       if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    }//GEN-LAST:event_MnCetakSuratKhususActionPerformed

    private void MnCetakSuratKhususSignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKhususSignActionPerformed
       if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("rad", rad);
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                Valid.MyReportqry("rptSuratKeteranganSehatKhususSign.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.BMI,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan,dokter.nm_dokter,dokter.no_ijn_praktek,dokter.nip1,pasien.jk,reg_periksa.kd_dokter," +
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from surat_keterangan_sehat inner join reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten" +
    ...
    }//GEN-LAST:event_MnCetakSuratKhususSignActionPerformed

    private void MnCetakSuratSehatENGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatENGActionPerformed
       if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kodedokter);
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                Valid.MyReportqry("rptSuratKeteranganSehatENG.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.BMI,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan,dokter.nm_dokter,dokter.no_ijn_praktek,dokter.nip1,pasien.jk,reg_periksa.kd_dokter," +
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from surat_keterangan_sehat inner join reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten" +
    ...
    }//GEN-LAST:event_MnCetakSuratSehatENGActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakSuratKhusus;
    private javax.swing.JMenuItem MnCetakSuratKhususSign;
    ...
    private javax.swing.JMenuItem MnCetakSuratSehatENG;
    private javax.swing.JMenuItem MnCetakSuratSehatSign;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_sehat.no_surat,surat_keterangan_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.BMI,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+                  
                     "surat_keterangan_sehat.butawarna,surat_keterangan_sehat.tesmata,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.catatan from surat_keterangan_sehat inner join reg_periksa on surat_keterangan_sehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
...
//        NoSurat.setText("");
    ...
    public void isCek(){
        ...
        if (akses.getkode().equals("D0000030") || akses.getkode().equals("D0000010") || akses.getkode().equals("Admin Utama") ) {
            ...
            MnCetakSuratSehatSign.setEnabled(false);
        }
    }
