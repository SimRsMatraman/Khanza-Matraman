...
public final class SuratSehat extends javax.swing.JDialog {
    ...
    public SuratSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sakit","No.Rawat","No.R.M.","Nama Pasien","Tanggal Surat","Kode Dokter","Dokter","Keperluan",
            "TB(cm)","BB(Kg)","Kesadaran","TD","Suhu(c)","Respirasi(/menit)","Catatan"
        ...
        Kesadaran.setDocument(new batasInput((byte)50).getKata(Kesadaran));  
        TTensi.setDocument(new batasInput((byte)10).getKata(TTensi));
        TSuhu.setDocument(new batasInput((byte)5).getKata(TSuhu));
        TRespirasi.setDocument(new batasInput((byte)5).getKata(TRespirasi));
    ...
    private void initComponents() {
        ...
        MnCetakSuratSehat.setPreferredSize(new java.awt.Dimension(140, 26));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-02-2023" }));
        ...
        TanggalSurat.setBounds(340, 40, 90, 23);

        jLabel13.setText("Tanggal Surat :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(250, 40, 90, 23);
        ...
        Keperluan.setBounds(500, 40, 225, 23);
        ...
        jLabel22.setBounds(430, 40, 63, 23);

        jLabel16.setText("Tinggi Badan(Cm) :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(10, 100, 100, 23);
        ...
        TTinggi.setBounds(110, 100, 55, 23);

        jLabel25.setText("Berat(Kg) :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(180, 100, 60, 23);
        ...
        TBerat.setBounds(240, 100, 55, 23);

        jLabel8.setText("Tensi :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(300, 100, 50, 23);
        ...
        TTensi.setBounds(350, 100, 70, 23);

        jLabel9.setText("Kesadaran :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(420, 70, 70, 23);
        ...
        Kesadaran.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                KesadaranKeyTyped(evt);
            }
        });
        FormInput.add(Kesadaran);
        Kesadaran.setBounds(490, 70, 170, 23);

        jLabel10.setText("Suhu (C) :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(410, 100, 70, 23);
        ...
        FormInput.add(TSuhu);
        TSuhu.setBounds(480, 100, 55, 23);

        jLabel23.setText("Respirasi(/menit) :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(540, 100, 100, 23);
        ...
        TRespirasi.setBounds(640, 100, 55, 23);

        jLabel24.setText("Catatan :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(46, 130, 63, 23);
        ...
        Catatan.setBounds(110, 130, 590, 23);
    ...
    private void NoSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoSuratKeyPressed
       Valid.pindah(evt,TCari,Kesadaran);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_sehat","?,?,?,?,?,?,?,?,?,?,?,?","No.Surat Sehat",12,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),KdDok.getText(),
                    Keperluan.getText(),TTinggi.getText(),TBerat.getText(),Kesadaran.getText(),TTensi.getText(),
                    TSuhu.getText(),TRespirasi.getText(),Catatan.getText()
                })==true){
                tampil();
                emptTeks();
            }else{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_sehat","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_sehat","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,kd_dokter=?,keperluan=?,tb=?,bb=?,kesadaran=?,td=?,suhu=?,respirasi=?,catatan=?",13,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),KdDok.getText(),
                    Keperluan.getText(),TTinggi.getText(),TBerat.getText(),Kesadaran.getText(),TTensi.getText(),
                    TSuhu.getText(),TRespirasi.getText(),Catatan.getText(),
    ...
    private void TanggalSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalSuratKeyPressed
        Valid.pindah(evt,NoSurat,Kesadaran);
    ...
    private void MnCetakSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("tb",TTinggi.getText());
                param.put("bb",TBerat.getText());
                param.put("kesadaran",Kesadaran.getText());
                param.put("td",TTensi.getText());
                param.put("suhu",TSuhu.getText());
                param.put("respirasi",TRespirasi.getText());
...
//                param.put("cocain",hasil6.getSelectedItem().toString());
                ...
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSuratSehat3.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select reg_periksa.no_rawat,dokter.nm_dokter,pasien.tgl_lahir,pasien.nm_pasien,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,pasien.jk " +
                              " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten " +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
//                Valid.MyReportqry("rptSuratSehat3.jasper","report","::[ Surat Keterangan Sehat ]::",
...
//                              " where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
    ...
    private void KeperluanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeperluanKeyPressed
         Valid.pindah(evt,btnDokter,Keperluan);
    ...
    private void btnDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnDokterKeyPressed
        Valid.pindah(evt,TSuhu,Keperluan);
    ...
    private void KesadaranKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KesadaranKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_KesadaranKeyTyped
    ...
    */
    ...
    public void tampil() {
        ...
        try{
            tgl=" surat_sehat.tanggalsurat between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_sehat.no_surat,surat_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_sehat.tanggalsurat,surat_sehat.kd_dokter,dokter.nm_dokter,surat_sehat.keperluan, "+
                     "surat_sehat.tb,surat_sehat.bb,surat_sehat.kesadaran,surat_sehat.td,surat_sehat.suhu,surat_sehat.respirasi,surat_sehat.catatan "+                   
                     "from surat_sehat inner join reg_periksa on surat_sehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_sehat.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_sehat.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_sehat.no_surat,surat_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_sehat.tanggalsurat,surat_sehat.kd_dokter,dokter.nm_dokter,surat_sehat.keperluan, "+
                     ...
                     "inner join dokter on surat_sehat.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_sehat.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_sehat.tanggalsurat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_sehat.keperluan like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_sehat.no_surat");
            }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TTinggi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            TBerat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Kesadaran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            TTensi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            TSuhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            TRespirasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
    ...
    private void isRawat() {
        ...
        Sequel.cariIsi("select pemeriksaan_ralan.tinggi from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TTinggi,TNoRw.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.berat from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TBerat,TNoRw.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.tensi from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TTensi,TNoRw.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.kesadaran from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",Kesadaran,TNoRw.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.suhu_tubuh from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TSuhu,TNoRw.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.respirasi from pemeriksaan_ralan where no_rawat=? ORDER BY pemeriksaan_ralan.tgl_perawatan desc",TRespirasi,TNoRw.getText());
    }
    ...
    private void autoSKBN() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_sehat where tanggalsurat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ",
                "SKS"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    }
