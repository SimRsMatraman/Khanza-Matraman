 ...
 * @author salimmulyana
 */
public final class SuratIsoman extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratIsoman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sakit","No.Rawat","No.R.M.","Nama Pasien","Dari Tanggal","Sampai Tanggal","Lama Isoman","Isoman Di","NIP","Dokter DPJP"
        }){
        ...
        Di.setDocument(new batasInput((byte)100).getKata(Di));
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit.setText("Cetak Surat Keterangan Isoman");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Isolasi Mandiri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2021" }));
        ...
        jLabel3.setText("No. Surat Keterangan Isoman :");
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(0, 40, 160, 23);
        ...
        NoSurat.setBounds(170, 40, 141, 23);
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2021" }));
        ...
        TanggalAkhir.setBounds(220, 70, 90, 23);
        ...
        LamaSakit.setBounds(420, 70, 106, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("s.d.");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(190, 70, 27, 23);

        jLabel18.setText("Hari");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(530, 70, 20, 23);

        TanggalAwal.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2021" }));
        ...
        TanggalAwal.setBounds(100, 70, 90, 23);

        jLabel13.setText("Dari Tanggal :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(20, 70, 80, 23);

        jLabel20.setText("Lama Isoman :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(320, 70, 90, 23);

        jLabel5.setText("Melakukan Isoman Di:");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(320, 40, 120, 23);
        ...
        FormInput.add(Di);
        Di.setBounds(440, 40, 280, 23);

        jLabel8.setText("Dokter DPJP :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 100, 100, 23);
        ...
        BtnDokter.setBounds(520, 100, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            Valid.textKosong(NoSurat,"No.Surat Keterangan Isoman");
        }else if(LamaSakit.getText().trim().equals("")){
            Valid.textKosong(LamaSakit,"lama Isoman");
        }else if(Di.getText().trim().equals("")){
            Valid.textKosong(Di,"Isoman Di");
        }else if(KodeDokter.getText().trim().equals("")){
            Valid.textKosong(KodeDokter,"Dokter DPJP");
        }else if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"pasien");
        }else{
            if(Sequel.menyimpantf("surat_isoman","?,?,?,?,?,?,?","No.Surat Keterangan Isoman",7,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),LamaSakit.getText(),Di.getText(),KodeDokter.getText()
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_isoman","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_isoman","no_surat=?","no_surat=?,no_rawat=?,tanggalawal=?,tanggalakhir=?,lamasakit=?,di=?,kd_dokter=?",8,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),LamaSakit.getText(),Di.getText(),KodeDokter.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_isoman.no_surat,surat_isoman.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_isoman.tanggalawal,surat_isoman.tanggalakhir,surat_isoman.lamasakit "+                  
                     "from surat_isoman inner join reg_periksa on surat_isoman.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"order by surat_isoman.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_isoman.no_surat,surat_isoman.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_isoman.tanggalawal,surat_isoman.tanggalakhir,surat_isoman.lamasakit "+                  
                     ...
                     tgl+"and surat_isoman.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_isoman.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_isoman.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_isoman.no_surat",param);
            }
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSuratIsoman.jasper","report","::[ Surat Keterangan Isolasi Mandiri ]::",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratIsoman dialog = new SuratIsoman(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            tgl=" surat_isoman.tanggalawal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_isoman.no_surat,surat_isoman.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_isoman.tanggalawal,surat_isoman.tanggalakhir,surat_isoman.lamasakit,surat_isoman.di,surat_isoman.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_isoman inner join reg_periksa on surat_isoman.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_isoman.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_isoman.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_isoman.no_surat,surat_isoman.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_isoman.tanggalawal,surat_isoman.tanggalakhir,surat_isoman.lamasakit,surat_isoman.di,surat_isoman.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     tgl+"and surat_isoman.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_isoman.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_isoman.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        TPasien.setText("");
        NoSurat.setText("");
        LamaSakit.setText("14 (Hari)");
        Di.setText("");
        KodeDokter.setText("");
        TanggalAwal.setDate(new Date());
        TanggalAkhir.setDate(new Date());
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_isoman where tanggalawal='"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"")+"' ",
                "SKI"+TanggalAwal.getSelectedItem().toString().substring(6,10)+TanggalAwal.getSelectedItem().toString().substring(3,5)+TanggalAwal.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Di.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
