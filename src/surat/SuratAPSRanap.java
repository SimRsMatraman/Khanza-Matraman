 ...
 * @author salimmulyana
 */
public final class SuratAPSRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratAPSRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                        KdPeg.requestFocus();  
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Atas Permintaan Sendiri Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2024" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_aps_ranap","?,?,?,?,?,?,?,?,?","No.Surat",9,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_aps_ranap","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_aps_ranap","no_surat=?","no_surat=?,no_rawat=?,nik=?,kd_dokter=?,tanggal_surat=?,jam=?,hubungan=?,acc_aps=?,tte=?",10,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_aps_ranap.no_surat,surat_aps_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_aps_ranap.tanggalawal,surat_aps_ranap.tanggalakhir,surat_aps_ranap.lamasakit "+                  
                     "from surat_aps_ranap inner join reg_periksa on surat_aps_ranap.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"order by surat_aps_ranap.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_aps_ranap.no_surat,surat_aps_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_aps_ranap.tanggalawal,surat_aps_ranap.tanggalakhir,surat_aps_ranap.lamasakit "+                  
                     ...
                     tgl+"and surat_aps_ranap.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_aps_ranap.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_aps_ranap.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_aps_ranap.no_surat",param);
            }
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("hubungan",Sequel.cariIsi("select hubungan from surat_aps_ranap where no_rawat=?",TNoRw.getText()));
                param.put("obat",Sequel.cariIsi("select obat from surat_aps_ranap where no_rawat=?",TNoRw.getText()));
                param.put("kepada",Sequel.cariIsi("select kepada from surat_aps_ranap where no_rawat=?",TNoRw.getText()));
                param.put("izin1",Sequel.cariIsi("select izin1 from surat_aps_ranap where no_rawat=?",TNoRw.getText()));
                param.put("izin",Sequel.cariIsi("select izin from surat_aps_ranap where no_rawat=?",TNoRw.getText()));
                param.put("nik",Sequel.cariIsi("select pegawai.nama from surat_aps_ranap inner join pegawai on pegawai.nik=surat_aps_ranap.nik where no_rawat=?",TNoRw.getText()));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratAPSRanap dialog = new SuratAPSRanap(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            tgl=" surat_aps_ranap.tanggal_surat between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "SELECT surat_aps_ranap.no_surat,surat_aps_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,surat_aps_ranap.nik,pegawai.nama,surat_aps_ranap.kd_dokter,dokter.nm_dokter,surat_aps_ranap.tanggal_surat,"+
                     "surat_aps_ranap.jam,surat_aps_ranap.hubungan,surat_aps_ranap.acc_aps,surat_aps_ranap.tte FROM surat_aps_ranap "+
                     "inner join reg_periksa on surat_aps_ranap.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join pegawai on surat_aps_ranap.nik=pegawai.nik "+
                     "inner join dokter on surat_aps_ranap.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_aps_ranap.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "SELECT surat_aps_ranap.no_surat,surat_aps_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,surat_aps_ranap.nik,pegawai.nama,surat_aps_ranap.kd_dokter,dokter.nm_dokter,surat_aps_ranap.tanggal_surat,"+
                     "surat_aps_ranap.jam,surat_aps_ranap.hubungan,surat_aps_ranap.acc_aps,surat_aps_ranap.tte FROM surat_aps_ranap "+
                     ...
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_aps_ranap.hubungan like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_aps_ranap.acc_aps like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_aps_ranap.no_surat");
            }
...
//        KodeDokter.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_aps_ranap where tanggal_surat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ",
        "APRI"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),4,NoSurat);
...
//        if(FormPhotoPass.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select surat_aps_ranap.tte from surat_aps_ranap where surat_aps_ranap.no_surat=?");
                try {
