...
//                param.put("hubungan",Sequel.cariIsi("select hubungan from surat_hk where no_rawat=?",TNoRw.getText()));
//                param.put("obat",Sequel.cariIsi("select obat from surat_hk where no_rawat=?",TNoRw.getText()));
//                param.put("kepada",Sequel.cariIsi("select kepada from surat_hk where no_rawat=?",TNoRw.getText()));
//                param.put("izin1",Sequel.cariIsi("select izin1 from surat_hk where no_rawat=?",TNoRw.getText()));
//                param.put("izin",Sequel.cariIsi("select izin from surat_hk where no_rawat=?",TNoRw.getText()));
