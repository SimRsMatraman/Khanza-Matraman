 ...
 * @author salimmulyana
 */
public final class SuratMCU extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratMCU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","NIP","Dokter PJ","Tanggal Surat","Daya Pendengaran","Daya Pandang","Visus Kanan","Visus Kiri","Rekomendasi"
        }){
        ...
        Pendengaran.setDocument(new batasInput((byte)100).getKata(Pendengaran));
        Pandang.setDocument(new batasInput((byte)100).getKata(Pandang));
        Kanan.setDocument(new batasInput((byte)20).getKata(Kanan));
        Kiri.setDocument(new batasInput((byte)20).getKata(Kiri));
        Rekomendasi.setDocument(new batasInput((int)1000).getKata(Rekomendasi));
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit.setText("Cetak Surat MCU");
        ...
        jLabel3.setText("Daya Pendengaran :");
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(0, 70, 160, 23);

        Pendengaran.setHighlighter(null);
        ...
        Pendengaran.setBounds(170, 70, 340, 23);
        ...
        jLabel5.setText("Visus Kanan:");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(70, 130, 90, 23);

        Kanan.setHighlighter(null);
        Kanan.setName("Kanan"); // NOI18N
        Kanan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KananKeyPressed(evt);
            }
        });
        FormInput.add(Kanan);
        Kanan.setBounds(170, 130, 150, 23);

        jLabel8.setText("Dokter PJ :");
        ...
        jLabel9.setText("Daya Pandang:");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(40, 100, 120, 23);

        Rekomendasi.setHighlighter(null);
        ...
        Rekomendasi.setBounds(410, 130, 330, 23);

        jLabel10.setText("Visus Kiri:");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(70, 160, 90, 23);

        Kiri.setHighlighter(null);
        Kiri.setName("Kiri"); // NOI18N
        Kiri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KiriActionPerformed(evt);
            }
        });
        Kiri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KiriKeyPressed(evt);
            }
        });
        FormInput.add(Kiri);
        Kiri.setBounds(170, 160, 150, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-12-2021" }));
        ...
        jLabel11.setBounds(500, 70, 70, 23);
        ...
        NoSurat.setBounds(570, 70, 170, 23);

        jLabel12.setText("Rekomendasi:");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(320, 130, 80, 23);

        Pandang.setHighlighter(null);
        Pandang.setName("Pandang"); // NOI18N
        Pandang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PandangKeyPressed(evt);
            }
        });
        FormInput.add(Pandang);
        Pandang.setBounds(170, 100, 340, 23);
    ...
    private void PendengaranKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PendengaranKeyPressed
       Valid.pindah(evt,TCari,Pendengaran);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(Pendengaran,"Daya Pendengaran");
        }else if(Pandang.getText().trim().equals("")){
            Valid.textKosong(Pandang,"Daya Pandang");    
        }else if(Kanan.getText().trim().equals("")){
            Valid.textKosong(Kanan,"Visus Kanan");
        }else if(Kiri.getText().trim().equals("")){
            Valid.textKosong(Kiri,"Visus Kiri");
        }else if(KodeDokter.getText().trim().equals("")){
            Valid.textKosong(KodeDokter,"Dokter PJ");
        }else if(Rekomendasi.getText().trim().equals("")){
            Valid.textKosong(Rekomendasi,"Rekomendasi");
        }else if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"pasien");
        }else{
            if(Sequel.menyimpantf("surat_mcu","?,?,?,?,?,?,?,?,?","No.Surat",9,new String[]{
                    NoSurat.getText(),TNoRw.getText(),KodeDokter.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Pendengaran.getText(),Pandang.getText(),Kanan.getText(),Kiri.getText(),Rekomendasi.getText()
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Pendengaran,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_mcu","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_mcu","no_surat=?","no_surat=?,no_rawat=?,kd_dokter=?,tanggal_surat=?,pendengaran=?,pandang=?,kanan=?,kiri=?,rekomendasi=?",10,new String[]{
                    NoSurat.getText(),TNoRw.getText(),KodeDokter.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Pendengaran.getText(),Pandang.getText(),Kanan.getText(),Kiri.getText(),Rekomendasi.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_mcu.no_surat,surat_mcu.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_mcu.tanggalawal,surat_mcu.tanggalakhir,surat_mcu.lamasakit "+                  
                     "from surat_mcu inner join reg_periksa on surat_mcu.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"order by surat_mcu.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     "select surat_mcu.no_surat,surat_mcu.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_mcu.tanggalawal,surat_mcu.tanggalakhir,surat_mcu.lamasakit "+                  
                     ...
                     tgl+"and surat_mcu.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_mcu.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_mcu.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_mcu.no_surat",param);
            }
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("pendengaran",Pendengaran.getText());
                ...
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSuratMCU.jasper","report","::[ Surat Keterangan MCU ]::",
    ...
    private void KananKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KananKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KananKeyPressed

    private void KodeDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDokterKeyPressed
        Valid.pindah(evt,TCari,Kanan);
    ...
    private void KiriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KiriKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KiriKeyPressed
    ...
    private void TanggalSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalSuratKeyPressed
        Valid.pindah(evt,NoSurat,Pendengaran);
    ...
    private void PandangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PandangKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PandangKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratMCU dialog = new SuratMCU(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox Kanan;
    private widget.TextBox Kiri;
    private widget.TextBox KodeDokter;
    private widget.Label LCount;
    private javax.swing.JMenuItem MnCetakSuratSakit;
    private widget.TextBox NamaDokter;
    private widget.TextBox NoSurat;
    private widget.TextBox Pandang;
    ...
    public void tampil() {
        ...
        try{
            tgl=" surat_mcu.tanggal_surat between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_mcu.no_surat,surat_mcu.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_mcu.kd_dokter,dokter.nm_dokter,surat_mcu.tanggal_surat,surat_mcu.pendengaran,surat_mcu.pandang,surat_mcu.kanan, "+                  
                     "surat_mcu.kiri,surat_mcu.rekomendasi from surat_mcu inner join reg_periksa on surat_mcu.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_mcu.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_mcu.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_mcu.no_surat,surat_mcu.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_mcu.kd_dokter,dokter.nm_dokter,surat_mcu.tanggal_surat,surat_mcu.pendengaran,surat_mcu.pandang,surat_mcu.kanan, "+                  
                     ...
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_mcu.pendengaran like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_mcu.pandang like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_mcu.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Rekomendasi.setText("");
        KodeDokter.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_mcu where tanggal_surat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ",
                "MCU001"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Pendengaran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
            Pandang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Kanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Kiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
