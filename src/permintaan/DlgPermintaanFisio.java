 ...
 * @author dosen
 */
public final class DlgPermintaanFisio extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanFisio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Input Data Permintaan Fisioterapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Cmbstatus.setBounds(780, 10, 100, 23);

        jLabel25.setText("Alarm :");
        jLabel25.setName("jLabel25"); // NOI18N
        PanelInput.add(jLabel25);
        jLabel25.setBounds(660, 10, 110, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanFisio dialog = new DlgPermintaanFisio(new javax.swing.JFrame(), true);
    ...
    private void tampil() {         
        try{
            file=new File("./cache/permintaanfisio.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem=""; 
        
            pspemeriksaan=koneksi.prepareStatement(
                    "select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,jns_perawatan.kd_pj from jns_perawatan where jns_perawatan.status='1' and jns_perawatan.kd_jenis_prw LIKE 'FT%' order by jns_perawatan.kd_jenis_prw");
            try {
                rs=pspemeriksaan.executeQuery();
                while(rs.next()){
                    iyem=iyem+"{\"KodePeriksa\":\""+rs.getString(1)+"\",\"NamaPemeriksaan\":\""+rs.getString(2).replaceAll("\"","")+"\",\"KodePJ\":\""+rs.getString(3)+"\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"permintaanfisio\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampil2() {         
        try{
            ...
            myObj = new FileReader("./cache/permintaanfisio.iyem");
            root = mapper.readTree(myObj);
            response = root.path("permintaanfisio");
    ...
    public void setNoRm(String norwt,String posisi){
        ...
        isPsien();
        try {
            if(Valid.daysOld("./cache/permintaanfisio.iyem")<3){
                tampil2();
            }
        } catch (Exception e) {
        }
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(permintaan_fisio.noorder,4),signed)),0) from permintaan_fisio where permintaan_fisio.tgl_permintaan='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ","PF"+Valid.SetTgl(Tanggal.getSelectedItem()+"").replaceAll("-",""),4,TNoPermintaan);           
    }
