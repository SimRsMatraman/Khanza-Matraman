 ...
 * @author dosen
 */
public class DlgBookingTelemedicine extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBookingTelemedicine(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Tahun","Bulan","Hari","Asal Booking","Status","Kd PJ","Cara Bayar","No.Telp/HP","No.Booking","Link","eMail",
                "Jam Mulai","Jam Selesai","Bukti Bayar","Tanggal & Jam Bayar"
            }){
    ...
    private void initComponents() {
        ...
        ppUpload = new javax.swing.JMenuItem();
        ...
        ppTelemedicine.setText("Open Video Call");
        ...
        ppTelemedicine.setPreferredSize(new java.awt.Dimension(170, 25));
        ppTelemedicine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppTelemedicineActionPerformed(evt);
            }
        });
        Popup.add(ppTelemedicine);

        ppUpload.setBackground(new java.awt.Color(255, 255, 254));
        ppUpload.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppUpload.setForeground(new java.awt.Color(50, 50, 50));
        ppUpload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppUpload.setText("Bukti Bayar");
        ppUpload.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppUpload.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppUpload.setName("ppUpload"); // NOI18N
        ppUpload.setPreferredSize(new java.awt.Dimension(170, 25));
        ppUpload.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppUploadActionPerformed(evt);
            }
        });
        Popup.add(ppUpload);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Booking Telemedicine ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-08-2021 11:58:14" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-08-2021 11:58:14" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(R2.isSelected()==true){
                status=" booking_telemedicine.tanggal_booking between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            }else if(R3.isSelected()==true){
                status=" booking_telemedicine.tanggal_periksa between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari4.getSelectedItem()+"")+"' ";           
            }
            Valid.MyReportqry("rptBookingRegistrasi.jasper","report","::[ Laporan Daftar Booking Registrasi ]::",
                "select booking_telemedicine.tanggal_booking,booking_telemedicine.jam_booking,booking_telemedicine.no_rkm_medis, "+
                    "pasien.nm_pasien,booking_telemedicine.tanggal_periksa,booking_telemedicine.kd_dokter,"+
                    "dokter.nm_dokter,booking_telemedicine.kd_poli,poliklinik.nm_poli,booking_telemedicine.no_reg, "+
                    ...
                    "booking_telemedicine.limit_reg,booking_telemedicine.status,booking_telemedicine.kd_pj,penjab.png_jawab "+
                    "from booking_telemedicine inner join pasien on booking_telemedicine.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on booking_telemedicine.kd_dokter=dokter.kd_dokter "+
                    "inner join poliklinik on booking_telemedicine.kd_poli=poliklinik.kd_poli "+
                    "inner join penjab on booking_telemedicine.kd_pj=penjab.kd_pj "+
                    "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel "+
                    "inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                    "inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab "+
                    "where "+status+" and booking_telemedicine.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    status+" and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                    status+" and poliklinik.nm_poli like '%"+TCari.getText().trim()+"%' or "+
                    status+" and dokter.nm_dokter like '%"+TCari.getText().trim()+"%' order by booking_telemedicine.tanggal_booking,dokter.nm_dokter",param);
        }
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
        ...
        for(i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                ...
                if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",19,new String[]{
                    tbObat.getValueAt(i,10).toString(),no_rawat,tbObat.getValueAt(i,5).toString(),tbObat.getValueAt(i,30).toString(),
                    ...
                    Sequel.queryu2("update booking_telemedicine set status='Terdaftar' where no_rkm_medis=? and tanggal_periksa=?",2,new String[]{
                        tbObat.getValueAt(i,3).toString(),tbObat.getValueAt(i,5).toString()
                    });
                }
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbObat.getRowCount();i++){
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                Sequel.queryu2("delete from booking_telemedicine where no_rkm_medis=? and tanggal_periksa=?",2,new String[]{
                    tbObat.getValueAt(i,3).toString(),tbObat.getValueAt(i,5).toString()
                });
            }
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(aktifjadwal.equals("aktif")){
                    if(Sequel.cariInteger("select count(no_rkm_medis) from booking_telemedicine where kd_dokter='"+KdDokter.getText()+"' and tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ")>=kuota){
    ...
    private void ppTelemedicineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTelemedicineActionPerformed
         this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Valid.panggilUrl2(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_ppTelemedicineActionPerformed

    private void ppUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppUploadActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Valid.panggilUrl2("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/telemedicine/upload/"+tbObat.getValueAt(tbObat.getSelectedRow(),32).toString()+"");
            this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_ppUploadActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBookingTelemedicine dialog = new DlgBookingTelemedicine(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem ppUpload;
    ...
    private void tampil() {     
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select booking_telemedicine.no_booking,booking_telemedicine.tanggal_booking,booking_telemedicine.jam_booking,booking_telemedicine.no_rkm_medis, "+
                    "pasien.nm_pasien,booking_telemedicine.tanggal_periksa,booking_telemedicine.kd_dokter,"+
                    "dokter.nm_dokter,booking_telemedicine.kd_poli,poliklinik.nm_poli,booking_telemedicine.no_reg,booking_telemedicine.link,booking_telemedicine.email,booking_telemedicine.jam_mulai,booking_telemedicine.jam_selesai,booking_telemedicine.foto,booking_telemedicine.upload, "+
                    "pasien.namakeluarga,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamatpj,pasien.kelurahanpj,pasien.kecamatanpj,pasien.no_tlp,"+
                    "pasien.kabupatenpj,pasien.propinsipj,pasien.keluarga,TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) as tahun, "+
                    "(TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) div 12) * 12)) as bulan, "+
                    "TIMESTAMPDIFF(DAY, DATE_ADD(DATE_ADD(pasien.tgl_lahir,INTERVAL TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) YEAR), INTERVAL TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, pasien.tgl_lahir, CURDATE()) div 12) * 12) MONTH), CURDATE()) as hari, "+
                    ...
                    "inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                    "inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab "+
                    "where "+status+" and booking_telemedicine.no_rkm_medis like ? or "+
                    status+" and pasien.nm_pasien like ? or "+
                    status+" and poliklinik.nm_poli like ? or "+
                    status+" and dokter.nm_dokter like ? order by booking_telemedicine.tanggal_booking,dokter.nm_dokter");
            try {
                ...
                while(rs.next()){                    
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("status"),rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("no_tlp"),rs.getString("no_booking"),rs.getString("link"),
                        rs.getString("email"),rs.getString("jam_mulai"),rs.getString("jam_selesai"),rs.getString("foto"),rs.getString("upload")
                    });                    
                }
            } catch (Exception e) {
    ...
    private void isNomer(){
        switch (URUTNOREG) {
            case "poli":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from booking_telemedicine where kd_poli='"+KdPoli.getText()+"' and tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg);
                break;
            case "dokter":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from booking_telemedicine where kd_dokter='"+KdDokter.getText()+"' and tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg);
                break;
            case "dokter + poli":             
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from booking_telemedicine where kd_dokter='"+KdDokter.getText()+"' and kd_poli='"+KdPoli.getText()+"' and tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg);
                break;
            default:
                Valid.autoNomer3("select ifnull(MAX(CONVERT(no_reg,signed)),0) from booking_telemedicine where kd_dokter='"+KdDokter.getText()+"' and tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,NoReg);
                break;
    ...
    private void isBooking() {
        if(Sequel.menyimpantf("booking_telemedicine","?,?,?,?,?,?,?,?,?,?,?","Pasien dan Tanggal",11,new String[]{
