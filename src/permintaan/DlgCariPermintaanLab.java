...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tbLabRalan2.setDefaultRenderer(Object.class, new WarnaTableLAB());
        ...
        tbLabRanap2.setDefaultRenderer(Object.class, new WarnaTableLAB());
        ...
        tbLabIGD.setDefaultRenderer(Object.class, new WarnaTableLAB());
        ...
        tbLabIGD1.setModel(tabMode6);

        tbLabIGD1.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbLabIGD1.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 20; i++) {
            TableColumn column = tbLabIGD1.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(90);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbLabIGD1.setDefaultRenderer(Object.class, new WarnaTableLAB());
    ...
    private void initComponents() {
        ...
        listPJ = new javax.swing.JComboBox<>();
        ...
        listStatus1 = new javax.swing.JComboBox<>();
        ...
        listPJ1 = new javax.swing.JComboBox<>();
        jLabel24 = new widget.Label();
        listStatus2 = new javax.swing.JComboBox<>();
        TabIGD = new javax.swing.JTabbedPane();
        scrollPane5 = new widget.ScrollPane();
        tbLabIGD = new widget.Table();
        scrollPane6 = new widget.ScrollPane();
        tbLabIGD1 = new widget.Table();
        ...
        BtnCloseIn4.setBounds(490, 30, 100, 30);
        ...
        BtnCloseIn5.setBounds(450, 30, 30, 30);
        ...
        BtnSimpan5.setBounds(400, 30, 30, 30);
        ...
        internalFrame6.add(TNoPermintaanPK);
        ...
        BtnEditTgl.setText("Ganti Tanggal");
        BtnEditTgl.setToolTipText("Alt+G");
        BtnEditTgl.setName("BtnEditTgl"); // NOI18N
        BtnEditTgl.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnEditTgl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnEditTglActionPerformed(evt);
            }
        });
        BtnEditTgl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnEditTglKeyPressed(evt);
            }
        });
        panelisi1.add(BtnEditTgl);
        ...
        jLabel20.setText("Cara Bayar :");
        jLabel20.setName("jLabel20"); // NOI18N
        jLabel20.setPreferredSize(new java.awt.Dimension(80, 23));
        panelGlass9.add(jLabel20);

        listPJ.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua" }));
        listPJ.setName("listPJ"); // NOI18N
        panelGlass9.add(listPJ);
        ...
        listStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Belum Sampel", "Belum Hasil", "Selesai" }));
        listStatus.setName("listStatus"); // NOI18N
        panelGlass9.add(listStatus);
        ...
        listStatus1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Belum Sampel", "Belum Hasil", "Selesai" }));
        listStatus1.setName("listStatus1"); // NOI18N
        panelGlass10.add(listStatus1);
        ...
        listPJ1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua" }));
        listPJ1.setName("listPJ1"); // NOI18N
        panelGlass11.add(listPJ1);
        ...
        listStatus2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Belum Sampel", "Belum Hasil", "Selesai" }));
        listStatus2.setName("listStatus2"); // NOI18N
        panelGlass11.add(listStatus2);

        internalFrame4.add(panelGlass11, java.awt.BorderLayout.PAGE_END);

        TabIGD.setBackground(new java.awt.Color(255, 255, 254));
        TabIGD.setForeground(new java.awt.Color(50, 50, 50));
        ...
        tbLabIGD.setAutoCreateRowSorter(true);
        ...
        tbLabIGD.getTableHeader().setReorderingAllowed(false);
        ...
        tbLabIGD1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbLabIGD1.setName("tbLabIGD1"); // NOI18N
        tbLabIGD1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLabIGD1MouseClicked(evt);
            }
        });
        tbLabIGD1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbLabIGD1KeyPressed(evt);
            }
        });
        scrollPane6.setViewportView(tbLabIGD1);
...
*/
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        switch (TabPilihRawat.getSelectedIndex()) {
            case 0:
                CrDokter.setText("");
                CrPoli.setText("");
                TCari.setText("");
                ...
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                        ...
                        if(Sampel.equals("")){
                            ...
                            dlgro.emptTeks();
                            dlgro.isCek(); 
                            if (Sequel.cariIntegerSysmex("select count(ONO) from resdt where resdt.ONO=?", NoPermintaan.trim()) > 0) {
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    if(Sequel.mengedittf("permintaan_lab","noorder=?","tgl_sampel=?,jam_sampel=?,tambahan=?",4,new String[]{
                        Valid.SetTgl(TanggalPulang.getSelectedItem()+""),TanggalPulang.getSelectedItem().toString().substring(11,19),Cmbstatus.getSelectedItem()+"",NoPermintaan
                        })==true){
                            WindowAmbilSampel.dispose();
                            try {
...
//                                }
                            ...
                            tbLabRalan.setValueAt(Cmbstatus.getSelectedItem()+"",tbLabRalan.getSelectedRow(),13);
                    }
                }
            }else{            
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data permintaan...!!!!");
...
//                                }  
                            ...
                            tbLabRanap.setValueAt(Cmbstatus.getSelectedItem()+"",tbLabRanap.getSelectedRow(),13);
                    }
                }
            }
                    ...
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                        ...
                        if(Sequel.mengedittf("permintaan_lab","noorder=?","tgl_sampel=?,jam_sampel=?,tambahan=?",4,new String[]{
                            Valid.SetTgl(TanggalPulang.getSelectedItem()+""),TanggalPulang.getSelectedItem().toString().substring(11,19),Cmbstatus.getSelectedItem()+"",NoPermintaan
                                ...
                                Sequel.queryu("insert into antrilabpk values('1')");
                                TeksKosong();
                                tbLabIGD.setValueAt(Valid.SetTgl(TanggalPulang.getSelectedItem()+""),tbLabIGD.getSelectedRow(),5);
                                tbLabIGD.setValueAt(TanggalPulang.getSelectedItem().toString().substring(11,19),tbLabIGD.getSelectedRow(),6);
                                tbLabIGD.setValueAt(Cmbstatus.getSelectedItem()+"",tbLabIGD.getSelectedRow(),13);
                        }
                    }
                }else{            
                    JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data permintaan...!!!!");
...
//                if (tbLabRanap.getValueAt(tbLabRanap.getSelectedRow(), 15).toString().equals("UMUM") && 
//                    tbLabRanap.getValueAt(tbLabRanap.getSelectedRow(), 17).toString().equals("Belum Bayar")
//                            ) {
...
//                        koneksisysmex=koneksiDBSysmex.condb();
                        ps=koneksi.prepareStatement(
                            ...
                            "permintaan_lab.jam_permintaan,LEFT(alamat, 50) as alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,"+
                        ...
                        try {
                            ...
                            if(rs.next()){
                                pilihan="R";
                                if(rs.getString("tambahan").equals("Cito")){
                                    pilihan="U";
                                }
                                Permintaan="";
...
//                        koneksisysmex=koneksiDBSysmex.condb();
                        ps=koneksi.prepareStatement(
                            "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_lab.tgl_permintaan,pasien.tgl_lahir,"+
                            "permintaan_lab.jam_permintaan,LEFT(alamat, 50) as alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,if(pasien.jk='L','1','2') as jk,"+
...
//                Valid.textKosong(NoPermintaan,"No.Rekam Medis");
            if(!NoRawat.equals("")){
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    Valid.textKosong(TCari,"No.Permintaan");
                }else{
                    if(Sequel.mengedittf("permintaan_lab","noorder=?","noorder=?,tgl_permintaan=?",3,new String[]{
                                TNoPermintaanPK.getText(),Valid.SetTgl(TanggalPulang1.getSelectedItem()+"")
...
//                        TanggalPulang1.getSelectedItem().toString().substring(11,19),
                        ,NoPermintaan   
                            ...
                            WindowGanti.dispose();
                            TeksKosong();
                            tbLabRalan.setValueAt(TNoPermintaanPK.getText(),tbLabRalan.getSelectedRow(),0);
                            tbLabRalan.setValueAt(Valid.SetTgl(TanggalPulang1.getSelectedItem()+""),tbLabRalan.getSelectedRow(),3);
                            //Jika Mau merubah jam juga
                            //tbLabRalan.setValueAt(TanggalPulang1.getSelectedItem().toString().substring(11,19),tbLabRalan.getSelectedRow(),6);
                    }
                }
            }else{            
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data permintaan...!!!!");
...
//                        TanggalPulang1.getSelectedItem().toString().substring(11,19),
                        ,NoPermintaan 
                            ...
                            TeksKosong();
                            tbLabRalan.setValueAt(TNoPermintaanPK.getText(),tbLabRalan.getSelectedRow(),0);
                            tbLabRanap.setValueAt(Valid.SetTgl(TanggalPulang1.getSelectedItem()+""),tbLabRanap.getSelectedRow(),3);
//                    Jika Mau merubah jam juga
//                            tbLabRanap.setValueAt(TanggalPulang1.getSelectedItem().toString().substring(11,19),tbLabRanap.getSelectedRow(),6);
                    }
                }
            }else{            
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data permintaan...!!!!");
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    if(Sequel.mengedittf("permintaan_lab","noorder=?","noorder=?,tgl_permintaan=?",3,new String[]{
                        ...
                        ,NoPermintaan   
                            ...
                            WindowGanti.dispose();
                            TeksKosong();
                            tbLabIGD.setValueAt(TNoPermintaanPK.getText(),tbLabIGD.getSelectedRow(),0);
                            tbLabIGD.setValueAt(Valid.SetTgl(TanggalPulang1.getSelectedItem()+""),tbLabIGD.getSelectedRow(),3);
                    }
                }
            }else{            
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data permintaan...!!!!");
    ...
    private void BtnEditTglActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditTglActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
...
//                }
//            }
    }//GEN-LAST:event_BtnEditTglActionPerformed

    private void BtnEditTglKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditTglKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            BtnEditTglActionPerformed(null);
        }
//        else{
//            Valid.pindah(evt, BtnHapus, BtnPrint);
//        }
    }//GEN-LAST:event_BtnEditTglKeyPressed
    ...
    private void BtnBatalSampelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalSampelActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            ...
            if(Hasil.equals("")||!NoRawat.equals("")){
                    if(Sequel.mengedittf("permintaan_lab","noorder=?","tgl_sampel=?,jam_sampel=?",3,new String[]{
                        "0000-00-00", "00:00:00",tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(), 0).toString(),
                    })==true){
                        Sequel.mengeditsysmex("lis_order","ONO=?","ORDER_CONTROL=?",2,new String[]{"CA",tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(), 0).toString()});
                        Sequel.mengeditsysmex("lis_order","ONO=?","FLAG=?",2,new String[]{"0",tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(), 0).toString()});
                        Sequel.mengeditsysmex("lis_order_detail","ONO=?","ORDER_CONTROL=?",2,new String[]{"CA",tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(), 0).toString()});
                        tbLabIGD.setValueAt("",tbLabIGD.getSelectedRow(),5);
                        tbLabIGD.setValueAt("",tbLabIGD.getSelectedRow(),6);
                    }
            }
            else{
                JOptionPane.showMessageDialog(null,"Maaf, Sudah dilakukan pengambilan hasil");
    ...
    private void BtnBatalSampelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnBatalSampelKeyPressed
        // TODO add your handling code here:
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(tabMode5.getRowCount()==0){
                    ...
                    tanggal=(tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),7).toString()+" pukul "+tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),8).toString());
                    nomr=Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat='"+norawat+"'");
                    nama=Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis='"+nomr+"'");
                    telp=Sequel.cariIsi("select no_tlp from pasien where pasien.no_rkm_medis='"+nomr+"'");
                    noorder=Sequel.cariIsi("select a.noorder from permintaan_lab a join periksa_lab b on b.no_rawat=a.no_rawat and a.tgl_hasil=b.tgl_periksa and a.jam_hasil=b.jam where a.no_rawat='"+norawat+"' and a.tgl_hasil='"+tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),7).toString()+"' and a.jam_hasil='"+tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),8).toString()+"' group by a.noorder");
                    if (noorder != null && !noorder.trim().isEmpty()) {
                        link = "https://rsudmatraman.my.id/upload/dokumen/" + noorder + ".pdf";
                    } else {
                        link = null;
    ...
    if (tabMode5.getRowCount() == 0) return;
    if (evt.getClickCount() != 1) return;

    int row = tbLabIGD.rowAtPoint(evt.getPoint());
    if (row < 0) return;

    String jenisPasien = String.valueOf(tbLabIGD.getValueAt(row, 15));
    String statusBayar = String.valueOf(tbLabIGD.getValueAt(row, 17));
    String poliRaw     = String.valueOf(tbLabIGD.getValueAt(row, 11));
    ...
    try { getDataIGD(); } catch (Exception ignored) {}        // TODO add your handling code here:
   ...
   if(tabMode5.getRowCount()!=0){
    ...
    private void tbLabIGD1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLabIGD1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabIGD1MouseClicked

    private void tbLabIGD1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabIGD1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabIGD1KeyPressed
    ...
    */
    ...
    private widget.Button BtnBatalSampel;
    private widget.Button BtnCari;
    private widget.Button BtnCetakHasilLab;
    private widget.Button BtnCloseIn4;
    private widget.Button BtnCloseIn5;
    private widget.Button BtnEditTgl;
    ...
    private javax.swing.JComboBox<String> listPJ;
    private javax.swing.JComboBox<String> listPJ1;
    private javax.swing.JComboBox<String> listStatus;
    private javax.swing.JComboBox<String> listStatus1;
    private javax.swing.JComboBox<String> listStatus2;
    ...
    private widget.Table tbLabIGD1;
    ...
    private void tampil() {
        ...
        try {
            ...
            switch (listStatus.getSelectedItem().toString()) {
                case "Belum Sampel":
                    filterStatus =
                        " and permintaan_lab.tgl_sampel='0000-00-00' " +
                        " and permintaan_lab.jam_sampel='00:00:00' ";
                    break;
                ...
                case "Belum Hasil":
                    filterStatus =
                        ...
                        " and permintaan_lab.jam_hasil='00:00:00' ";
                    break;
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "permintaan_lab.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_lab.informasi_tambahan,permintaan_lab.tambahan,permintaan_lab.diagnosa_klinis,reg_periksa.status_bayar, permintaan_lab_order.jam_permintaan as jam_order "+
                    "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "left join permintaan_lab_order on permintaan_lab_order.noorder=permintaan_lab.noorder "+
                    "where permintaan_lab.status='ralan' and permintaan_lab.tgl_permintaan between ? and ? "+
                    "and penjab.png_jawab like ? and reg_periksa.kd_poli<>'IGDK' "+     
                    filterStatus +        
                    ...
                    "pasien.nm_pasien like ? or permintaan_lab.diagnosa_klinis like ? or dokter.nm_dokter like ?)")+                    
                    "order by permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3, "%" + listPJ.getSelectedItem().toString().replaceAll("Semua", "") + "%"); 
                if(!semua){
                    ps.setString(4,"%"+CrDokter.getText().trim()+"%");
                    ps.setString(5,"%"+CrPoli.getText().trim()+"%");                    
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("tambahan"),rs.getString("status_bayar"),rs.getString("jam_order")
                    });
                    ps2=koneksi.prepareStatement(
                            "select permintaan_pemeriksaan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan "+
                            "from permintaan_pemeriksaan_lab inner join jns_perawatan_lab on "+
    ...
    private void tampil2() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "permintaan_lab.diagnosa_klinis like ? or dokter.nm_dokter like ? )")+                       
                "order by permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    ...
    private void tampiligd1() {
        Valid.tabelKosong(tabMode5);
        try {
            String filterStatus = "";

            switch (listStatus2.getSelectedItem().toString()) {
            ...
            semua=TCari.getText().trim().equals("");
            ps=koneksi.prepareStatement(
                    "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_lab.tgl_permintaan,"+
                    "if(permintaan_lab.jam_permintaan='00:00:00','',permintaan_lab.jam_permintaan) as jam_permintaan,reg_periksa.kd_pj,penjab.png_jawab,"+
                    "if(permintaan_lab.tgl_sampel='0000-00-00','',permintaan_lab.tgl_sampel) as tgl_sampel,if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel,"+
            ...
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3, "%" + listPJ1.getSelectedItem().toString().replaceAll("Semua", "") + "%"); 
                if(!semua){                   
    ...
    private void getDataIGD() {
        if(tbLabIGD.getSelectedRow()!= -1){
            Kd2.setText(tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),1).toString());
            ...
            InformasiTambahan=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),12).toString();
            DiagnosaKlinis=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),13).toString();
    ...
    private void listPJ(){
       try{
            ps=koneksi.prepareStatement("SELECT png_jawab from penjab WHERE penjab.status='1' order by png_jawab desc ");
            ResultSet rs=ps.executeQuery();

            while(rs.next()){
                 listPJ.addItem(rs.getString("png_jawab"));
                 listPJ1.addItem(rs.getString("png_jawab"));
            }               
            rs.close();                
        }
    ...
    private void tampil3() {
        ...
        try {
            ...
            switch (listStatus1.getSelectedItem().toString()) {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                    ...
                    "if(permintaan_lab.tgl_sampel='0000-00-00','',permintaan_lab.tgl_sampel) as tgl_sampel,if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel,"+
                    "if(permintaan_lab.tgl_hasil='0000-00-00','',permintaan_lab.tgl_hasil) as tgl_hasil,if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,"+
                    "permintaan_lab.dokter_perujuk,dokter.nm_dokter,ifnull(bangsal.nm_bangsal,'Ranap Gabung') as nm_bangsal,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,permintaan_lab.tambahan,reg_periksa.status_bayar,permintaan_lab_order.jam_permintaan as jam_order "+
                    "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
                    "left join kamar_inap on reg_periksa.no_rawat=kamar_inap.no_rawat "+
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel, permintaan_lab.tgl_hasil,"+
                        "if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,"+
                        "permintaan_lab.dokter_perujuk,dokter.nm_dokter,ifnull(bangsal.nm_bangsal,'Ranap Gabung') as nm_bangsal,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,permintaan_lab.diagnosa_klinis "+
                        "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join permintaan_pemeriksaan_lab on permintaan_lab.noorder=permintaan_pemeriksaan_lab.noorder "+
                        "left join kamar_inap on reg_periksa.no_rawat=kamar_inap.no_rawat "+
    ...
    private int hitungPermintaan(JTable table, int kolomSample, boolean harusCito) {

            int jumlah = 0;

            for (int i = 0; i < table.getRowCount(); i++) {

                Object noPermintaan = table.getValueAt(i, 0);
                Object sample       = table.getValueAt(i, kolomSample);

                if (noPermintaan == null || noPermintaan.toString().trim().isEmpty()) {
                    continue;
                }

                if (harusCito) {
                    Object statusCito = table.getValueAt(i, 16);

                    if (statusCito == null
                            || !"Cito".equalsIgnoreCase(statusCito.toString().trim())) {
                        continue;
                    }
                }

                if (sample == null || sample.toString().trim().isEmpty()) {
                    jumlah++;
                }
            }
        ...
        ActionListener taskPerformer = (ActionEvent e) -> {
            ...
            detik = String.format("%02d", nilai_detik);
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(permintaan_lab.noorder,4),signed)),0) from permintaan_lab where permintaan_lab.tgl_permintaan='"+Valid.SetTgl(TanggalPulang1.getSelectedItem()+"")+"' ","PK"+Valid.SetTgl(TanggalPulang1.getSelectedItem()+"").replaceAll("-",""),4,TNoPermintaanPK);           
    }
