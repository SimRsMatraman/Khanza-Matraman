...
import rekammedis.RMPenilaianAwalKeperawatanNeonatusRanap;
...
import rekammedis.DlgObservasi;
import rekammedis.EWSRanap;
import rekammedis.PEWSRanap;
import rekammedis.GdsRanap;
import rekammedis.RMDataIC;
import rekammedis.RMDataSkriningGiziAnak;
...
import rekammedis.DlgCatatanPemberianObatRanap;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Respirasi(/menit)","Tinggi(Cm)","Berat(Kg)","GCS(E,V,M)","Kesadaran","S (SUBJECTIVE)","O (OBJECTIVE)","Alergi","A (ASSESSMENT)","P (PLAN)","NIP","Nama Pegawai","SpO2(%)","Instruksi"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
...
//                            KdDok2.requestFocus();
    ...
    private void initComponents() {
        ...
        BtnAwalKeperawatanDewasa = new widget.Button();
        BtnAwalKeperawatanKebidanan = new widget.Button();
        BtnAwalKeperawatanBayiAnak = new widget.Button();
        BtnAwalKeperawatanNeonatus = new widget.Button();
        BtnMedisDewasa = new widget.Button();
        BtnMedisKebidanan = new widget.Button();
        BtnMedisNeonatus = new widget.Button();
        ...
        BtnSkriningGiziAnak = new widget.Button();
        ...
        BtnEPRanap = new widget.Button();
        BtnAPSRanap = new widget.Button();
        ...
        PanelInput1.setPreferredSize(new java.awt.Dimension(192, 400));
        ...
        jLabel7.setBounds(430, 160, 85, 23);
        ...
        TSuhu.setBounds(530, 160, 55, 23);

        jLabel4.setText("Tensi :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(430, 190, 85, 23);
        ...
        TTensi.setBounds(530, 190, 55, 23);

        jLabel25.setText("Berat(Kg) :");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass12.add(jLabel25);
        jLabel25.setBounds(610, 130, 79, 23);
        ...
        TBerat.setBounds(700, 130, 55, 23);
        ...
        TNadi.setBounds(700, 160, 55, 23);

        jLabel24.setText("Nadi(/menit) :");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass12.add(jLabel24);
        jLabel24.setBounds(610, 160, 79, 23);
        ...
        TAlergi.setBounds(610, 90, 245, 23);

        jLabel23.setText("Respirasi(/menit) :");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass12.add(jLabel23);
        jLabel23.setBounds(590, 190, 100, 23);
        ...
        TRespirasi.setBounds(700, 190, 55, 23);

        jLabel22.setText("GCS(E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(400, 90, 90, 23);
        ...
        scrollPane4.setBounds(10, 280, 360, 80);

        jLabel41.setText("Kesadaran :");
        jLabel41.setName("jLabel41"); // NOI18N
        panelGlass12.add(jLabel41);
        jLabel41.setBounds(440, 220, 80, 23);
        ...
        cmbKesadaran.setBounds(530, 220, 196, 23);

        jLabel53.setText("SpO2 (%) :");
        jLabel53.setName("jLabel53"); // NOI18N
        panelGlass12.add(jLabel53);
        jLabel53.setBounds(750, 130, 97, 23);
        ...
        BtnCppt.setBounds(430, 290, 90, 30);
        ...
        BtnEWS.setBounds(520, 290, 90, 30);
        ...
        BtnEWS1.setBounds(610, 290, 100, 30);
        ...
        BtnImplementasiKeperawatanRanap1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnImplementasiKeperawatanRanap1ActionPerformed(evt);
            }
        });
        BtnImplementasiKeperawatanRanap1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnImplementasiKeperawatanRanap1KeyPressed(evt);
            }
        });
        panelGlass12.add(BtnImplementasiKeperawatanRanap1);
        BtnImplementasiKeperawatanRanap1.setBounds(610, 330, 200, 30);
        ...
        BtnRiwayatRadLab.setText("Riwayat Rad & Lab");
        BtnRiwayatRadLab.setToolTipText("");
        BtnRiwayatRadLab.setDisplayedMnemonicIndex(3);
        BtnRiwayatRadLab.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        BtnRiwayatRadLab.setGlassColor(new java.awt.Color(102, 204, 255));
        BtnRiwayatRadLab.setName("BtnRiwayatRadLab"); // NOI18N
        BtnRiwayatRadLab.setPreferredSize(new java.awt.Dimension(160, 30));
        BtnRiwayatRadLab.setRoundRect(false);
        ...
        BtnRiwayatRadLab.setBounds(430, 250, 170, 30);
        ...
        BtnCatatanKeperawatanRanap.setBounds(430, 330, 180, 30);
        ...
        RiwayatResep.setGlassColor(new java.awt.Color(255, 204, 153));
        ...
        RiwayatResep.setBounds(610, 250, 170, 30);
        ...
        PanelInput2.setPreferredSize(new java.awt.Dimension(192, 190));
        ...
        TKualitas_dtk.setBounds(400, 50, 50, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("detik");
        jLabel33.setName("jLabel33"); // NOI18N
        panelGlass14.add(jLabel33);
        jLabel33.setBounds(460, 50, 30, 23);
        ...
        jLabel34.setBounds(350, 50, 55, 23);
        ...
        TKualitas_mnt.setBounds(290, 50, 50, 23);

        jLabel40.setText("Portio Inspekulo :");
        jLabel40.setName("jLabel40"); // NOI18N
        panelGlass14.add(jLabel40);
        jLabel40.setBounds(270, 90, 90, 23);
        ...
        cmbKetuban.setBounds(850, 50, 62, 23);
        ...
        TPortio.setBounds(360, 90, 125, 23);

        jLabel43.setText("Kualitas (x/mnt) : ");
        jLabel43.setName("jLabel43"); // NOI18N
        panelGlass14.add(jLabel43);
        jLabel43.setBounds(190, 50, 100, 23);
        ...
        TVulva.setBounds(140, 90, 125, 23);
        ...
        cmbKontraksi.setBounds(140, 50, 62, 23);
        ...
        cmbFluksus.setBounds(550, 50, 62, 23);

        jLabel48.setText("Dalam :");
        jLabel48.setName("jLabel48"); // NOI18N
        panelGlass14.add(jLabel48);
        jLabel48.setBounds(500, 90, 47, 23);
        ...
        cmbDalam.setBounds(550, 90, 90, 23);

        jLabel49.setText("Pembukaan :");
        jLabel49.setName("jLabel49"); // NOI18N
        panelGlass14.add(jLabel49);
        jLabel49.setBounds(0, 130, 135, 23);
        ...
        TPembukaan.setBounds(140, 130, 125, 23);
        ...
        TPenurunan.setBounds(340, 130, 125, 23);

        jLabel50.setText("Tebal/cm :");
        jLabel50.setName("jLabel50"); // NOI18N
        panelGlass14.add(jLabel50);
        jLabel50.setBounds(640, 90, 60, 23);
        ...
        jLabel51.setBounds(750, 50, 90, 23);
        ...
        cmbArah.setBounds(800, 90, 102, 23);

        jLabel52.setText("Arah :");
        jLabel52.setName("jLabel52"); // NOI18N
        panelGlass14.add(jLabel52);
        jLabel52.setBounds(760, 90, 40, 23);
        ...
        PanelInput3.setPreferredSize(new java.awt.Dimension(192, 260));
        ...
        label14.setBounds(940, 10, 90, 23);
        ...
        KodeDokter.setBounds(1040, 10, 141, 23);
        ...
        NamaDokter.setBounds(1180, 10, 270, 23);
        ...
        BtnDokter.setBounds(1450, 10, 28, 23);
        ...
        BtnRujukKeluar.setText("Rujuk Rawat Inap");
        ...
        BtnAwalKeperawatanDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanDewasa.setText("Awal Keperawatan Dewasa");
        BtnAwalKeperawatanDewasa.setFocusPainted(false);
        BtnAwalKeperawatanDewasa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanDewasa.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanDewasa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanDewasa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanDewasa.setName("BtnAwalKeperawatanDewasa"); // NOI18N
        BtnAwalKeperawatanDewasa.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanDewasa.setRoundRect(false);
        BtnAwalKeperawatanDewasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanDewasaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanDewasa);

        BtnAwalKeperawatanKebidanan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanKebidanan.setText("Awal Keperawatan Kebidanan");
        BtnAwalKeperawatanKebidanan.setFocusPainted(false);
        BtnAwalKeperawatanKebidanan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanKebidanan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanKebidanan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanKebidanan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanKebidanan.setName("BtnAwalKeperawatanKebidanan"); // NOI18N
        BtnAwalKeperawatanKebidanan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanKebidanan.setRoundRect(false);
        BtnAwalKeperawatanKebidanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanKebidananActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanKebidanan);

        BtnAwalKeperawatanBayiAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanBayiAnak.setText("Awal Keperawatan Anak");
        BtnAwalKeperawatanBayiAnak.setFocusPainted(false);
        BtnAwalKeperawatanBayiAnak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnAwalKeperawatanBayiAnak.setName("BtnAwalKeperawatanBayiAnak"); // NOI18N
        ...
        BtnAwalKeperawatanBayiAnak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanBayiAnakActionPerformed(evt);
            }
        });
        ...
        BtnAwalKeperawatanNeonatus.setToolTipText("");
        ...
        BtnMedisDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnMedisDewasa.setText("Medis Dewasa");
        BtnMedisDewasa.setFocusPainted(false);
        BtnMedisDewasa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnMedisDewasa.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnMedisDewasa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnMedisDewasa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnMedisDewasa.setName("BtnMedisDewasa"); // NOI18N
        BtnMedisDewasa.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnMedisDewasa.setRoundRect(false);
        BtnMedisDewasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMedisDewasaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnMedisDewasa);

        BtnMedisKebidanan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnMedisKebidanan.setText("Medis Kebidanan & Kandungan");
        BtnMedisKebidanan.setFocusPainted(false);
        BtnMedisKebidanan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnMedisKebidanan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnMedisKebidanan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnMedisKebidanan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnMedisKebidanan.setName("BtnMedisKebidanan"); // NOI18N
        BtnMedisKebidanan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnMedisKebidanan.setRoundRect(false);
        BtnMedisKebidanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMedisKebidananActionPerformed(evt);
            }
        });
        FormMenu.add(BtnMedisKebidanan);

        BtnMedisNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnMedisNeonatus.setText("Medis Neonatus");
        BtnMedisNeonatus.setFocusPainted(false);
        BtnMedisNeonatus.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnMedisNeonatus.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnMedisNeonatus.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnMedisNeonatus.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnMedisNeonatus.setName("BtnMedisNeonatus"); // NOI18N
        BtnMedisNeonatus.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnMedisNeonatus.setRoundRect(false);
        BtnMedisNeonatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMedisNeonatusActionPerformed(evt);
            }
        });
        FormMenu.add(BtnMedisNeonatus);

        BtnKepAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKepAnak.setText("Medis Anak");
        BtnKepAnak.setFocusPainted(false);
        BtnKepAnak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKepAnak.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKepAnak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKepAnak.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKepAnak.setName("BtnKepAnak"); // NOI18N
        BtnKepAnak.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKepAnak.setRoundRect(false);
        BtnKepAnak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKepAnakActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKepAnak);

        BtnResume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnResume.setText("Resume Pasien Ranap");
        ...
        BtnLepasPerawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLepasPerawatan.setText("Lepas Perawatan Ranap");
        BtnLepasPerawatan.setFocusPainted(false);
        BtnLepasPerawatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLepasPerawatan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLepasPerawatan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLepasPerawatan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLepasPerawatan.setName("BtnLepasPerawatan"); // NOI18N
        BtnLepasPerawatan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnLepasPerawatan.setRoundRect(false);
        BtnLepasPerawatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLepasPerawatanActionPerformed(evt);
            }
        });
        ...
        BtnCatatanCekGDS.setText("GDS Ranap");
        ...
        BtnPemantauanPEWSAnak.setText("PEWS Ranap");
        ...
        BtnPemantauanPEWSDewasa.setText("EWS Ranap");
        ...
        BtnSkriningGiziAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnSkriningGiziAnak.setText("Skrining Gizi Anak");
        BtnSkriningGiziAnak.setFocusPainted(false);
        BtnSkriningGiziAnak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSkriningGiziAnak.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSkriningGiziAnak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSkriningGiziAnak.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSkriningGiziAnak.setName("BtnSkriningGiziAnak"); // NOI18N
        BtnSkriningGiziAnak.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnSkriningGiziAnak.setRoundRect(false);
        BtnSkriningGiziAnak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSkriningGiziAnakActionPerformed(evt);
            }
        });
        FormMenu.add(BtnSkriningGiziAnak);
        ...
        BtnICRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnICRanap.setText("Informed Consent Ranap");
        BtnICRanap.setFocusPainted(false);
        BtnICRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnICRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnICRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnICRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnICRanap.setName("BtnICRanap"); // NOI18N
        BtnICRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnICRanap.setRoundRect(false);
        BtnICRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnICRanapActionPerformed(evt);
            }
        });
        ...
        BtnEPRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnEPRanap.setText("Edukasi Pasien");
        BtnEPRanap.setFocusPainted(false);
        BtnEPRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnEPRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnEPRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnEPRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnEPRanap.setName("BtnEPRanap"); // NOI18N
        BtnEPRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnEPRanap.setRoundRect(false);
        BtnEPRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnEPRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnEPRanap);

        BtnAPSRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAPSRanap.setText("APS Ranap");
        BtnAPSRanap.setFocusPainted(false);
        BtnAPSRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAPSRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAPSRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAPSRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAPSRanap.setName("BtnAPSRanap"); // NOI18N
        BtnAPSRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAPSRanap.setRoundRect(false);
        BtnAPSRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAPSRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAPSRanap);
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 3:
                    if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||
                            ...
                            (!TPenilaian.getText().trim().equals(""))||(!TindakLanjut.getText().trim().equals(""))||(!KodeDokter.getText().trim().equals(""))||(!TSpo2.getText().trim().equals(""))){
                        if(KodeDokter.getText().trim().equals("")||NamaDokter.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.menyimpantf("pemeriksaan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",19,new String[]{
                                        ...
                                        TPenilaian.getText(),TindakLanjut.getText(),KodeDokter.getText(),TSpo2.getText(),Instruksi.getText()
                                    })==true){
                                    tabModePemeriksaan.addRow(new Object[]{
                                        ...
                                        TKeluhan.getText(),TPemeriksaan.getText(),TAlergi.getText(),TPenilaian.getText(),TindakLanjut.getText(),KodeDokter.getText(),NamaDokter.getText(),TSpo2.getText(),Instruksi.getText()
                                    });
                ...
                case 4:
                     if((!TTinggi_uteri.getText().trim().equals(""))||(!TLetak.getText().trim().equals(""))||
                        ...
                        if(Sequel.menyimpantf("pemeriksaan_obstetri_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",24,new String[]{
                            TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                            ...
                            cmbFeto.getSelectedItem().toString(),KodeDokter.getText()
                            })==true){
                ...
                case 5:
                    if ((!TInspeksi.getText().trim().equals(""))||(!TInspeksiVulva.getText().trim().equals(""))||
                        ...
                        if(Sequel.menyimpantf("pemeriksaan_ginekologi_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21, new String[] {
                            TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                            ...
                            TAdnexaKanan.getText(), TAdnexaKiri.getText(), TCavumDouglas.getText(), KodeDokter.getText()
                            })==true){
                        ...
                        if(tbPemeriksaan.getValueAt(i,0).toString().equals("true")){
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaan.getValueAt(i,1).toString()+
                                        ...
                                        "' and nik='"+tbPemeriksaan.getValueAt(i,19).toString()+
                                        "' and jam_rawat='"+tbPemeriksaan.getValueAt(i,5).toString()+"' ");
                                tabModePemeriksaan.removeRow(i);
                                i--;
                            }else{
                                if(akses.getkode().equals(tbPemeriksaan.getValueAt(i,19).toString())){
                                    Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaan.getValueAt(i,1).toString()+
                                            "' and tgl_perawatan='"+tbPemeriksaan.getValueAt(i,4).toString()+
                                            "' and nik='"+tbPemeriksaan.getValueAt(i,19).toString()+
                                            "' and jam_rawat='"+tbPemeriksaan.getValueAt(i,5).toString()+"' ");
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 3:
                    if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||(!TSuhu.getText().trim().equals(""))||
                            ...
                            (!KodeDokter.getText().trim().equals(""))||(!NamaDokter.getText().trim().equals(""))){
                        if(tbPemeriksaan.getSelectedRow()>-1){
                            if(akses.getkode().equals("Admin Utama")){
                                ...
                                "rtl='"+TindakLanjut.getText()+"',penilaian='"+TPenilaian.getText()+"',nik='"+KodeDokter.getText()+"',spo='"+TSpo2.getText()+"',instruksi='"+Instruksi.getText()+"'")==true){
                                    ...
                                    tbPemeriksaan.setValueAt(TPenilaian.getText(),tbPemeriksaan.getSelectedRow(), 17);
                                    tbPemeriksaan.setValueAt(TindakLanjut.getText(),tbPemeriksaan.getSelectedRow(), 18);
                                    tbPemeriksaan.setValueAt(KodeDokter.getText(),tbPemeriksaan.getSelectedRow(), 19);
                                    tbPemeriksaan.setValueAt(NamaDokter.getText(),tbPemeriksaan.getSelectedRow(), 20);
                                    tbPemeriksaan.setValueAt(TSpo2.getText(),tbPemeriksaan.getSelectedRow(), 21);
                                    tbPemeriksaan.setValueAt(Instruksi.getText(),tbPemeriksaan.getSelectedRow(), 22);
                                    BtnBatalActionPerformed(evt);
                                }
                            }else{
                                if(akses.getkode().equals(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),19).toString())){
                                    if(Sequel.mengedittf("pemeriksaan_ranap","no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1)+
                                "' and tgl_perawatan='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),4)+
                                "' and nik='"+KodeDokter.getText()+          
                                "' and jam_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),5)+"'",
                                "no_rawat='"+TNoRw.getText()+"',suhu_tubuh='"+TSuhu.getText()+"',tensi='"+TTensi.getText()+"',"+
                                "keluhan='"+TKeluhan.getText()+"',pemeriksaan='"+TPemeriksaan.getText()+"',"+
                                "nadi='"+TNadi.getText()+"',respirasi='"+TRespirasi.getText()+"',tinggi='"+TTinggi.getText()+"',berat='"+TBerat.getText()+"',"+
                    ...
                    if((!TTinggi_uteri.getText().trim().equals(""))||(!TLetak.getText().trim().equals(""))||
                        ...
                        if(tbPemeriksaanObstetri.getSelectedRow()>-1){
                            if(Sequel.mengedittf("pemeriksaan_obstetri_ranap","no_rawat='"+tbPemeriksaanObstetri.getValueAt(tbPemeriksaanObstetri.getSelectedRow(),1)+
                                    ...
                                    tbPemeriksaanObstetri.setValueAt(NamaDokter.getText(),tbPemeriksaanObstetri.getSelectedRow(), 27);
                                    BtnBatalActionPerformed(evt);
                            }
                        }else{
                            JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data yang mau diganti..!!");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnRujukKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRujukKeluarActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgRujukRanap rujukranap=new DlgRujukRanap(null,false);
                rujukranap.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                rujukranap.setLocationRelativeTo(internalFrame1);
                rujukranap.emptTeks();
                rujukranap.isCek();
                rujukranap.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                rujukranap.tampil();
                rujukranap.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }            
        }
    ...
    private void BtnImplementasiKeperawatanRanap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnImplementasiKeperawatanRanap1ActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgObservasi dlgobservasi=new DlgObservasi(null,false);
            dlgobservasi.setNoRawat(TNoRw.getText(),TNoRw.getText());
            dlgobservasi.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            dlgobservasi.setLocationRelativeTo(internalFrame1);
            dlgobservasi.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnImplementasiKeperawatanRanap1ActionPerformed

    private void BtnImplementasiKeperawatanRanap1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnImplementasiKeperawatanRanap1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnImplementasiKeperawatanRanap1KeyPressed
    ...
    private void BtnImplementasiPerawatRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnImplementasiPerawatRanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnImplementasiPerawatRanapActionPerformed

    private void BtnICRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnICRanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
            ...
            form.setVisible(true);
            form.emptTeks();
            form.setNoRm(TNoRw.getText(),DTPCari2.getDate(),"ranap"); // ⬅️ kirim "ranap"
            form.tampil();
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnICRanapActionPerformed

    private void BtnValidasiCPPTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnValidasiCPPTActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnValidasiCPPTActionPerformed
    ...
    private void BtnSkriningGiziAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSkriningGiziAnakActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnSkriningGiziAnakActionPerformed
    ...
    private void BtnValidasiImpKepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnValidasiImpKepActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnValidasiImpKepActionPerformed

    private void BtnLepasPerawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLepasPerawatanActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
            ...
            lepas.tampil();
            lepas.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnLepasPerawatanActionPerformed

    private void BtnMedisDewasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMedisDewasaActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnMedisDewasaActionPerformed

    private void BtnMedisKebidananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMedisKebidananActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnMedisKebidananActionPerformed
    ...
    private void BtnKepAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKepAnakActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnKepAnakActionPerformed
    ...
    private void BtnAwalKeperawatanDewasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanDewasaActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanDewasaActionPerformed

    private void BtnAwalKeperawatanKebidananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanKebidananActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanKebidananActionPerformed

    private void BtnAwalKeperawatanBayiAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanBayiAnakActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{ 
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanBayiAnakActionPerformed
...
//            resume.setNoRm(TNoRw.getText(),DTPCari2.getDate(),Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()),TNoRM.getText());
    ...
    private void BtnEPRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEPRanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void BtnAPSRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAPSRanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAPSRanapActionPerformed
    ...
    private void BtnPORanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPORanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPemberianObatRanap form=new RMPemberianObatRanap(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    */
    ...
    private widget.Button BtnAPSRanap;
    private widget.Button BtnAll;
    private widget.Button BtnAntarFaskes;
    private widget.Button BtnAwalKeperawatanBayiAnak;
    private widget.Button BtnAwalKeperawatanDewasa;
    private widget.Button BtnAwalKeperawatanKebidanan;
    ...
    private widget.Button BtnMedisKebidanan;
    ...
    private widget.Button BtnSkriningGiziAnak;
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput1.setPreferredSize(new Dimension(WIDTH,400));
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                ...
                "pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.alergi,pemeriksaan_ranap.penilaian,pemeriksaan_ranap.rtl,"+
                "pemeriksaan_ranap.nik,pegawai.nama,pemeriksaan_ranap.spo,pemeriksaan_ranap.instruksi "+
                "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pemeriksaan_ranap on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat "+
                "inner join pegawai on pemeriksaan_ranap.nik=pegawai.nik where "+
...
//            KodeDokter.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),19).toString());
//            NamaDokter.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),20).toString());
            TSpo2.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),21).toString());
            Instruksi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),22).toString());
            ...
            if(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),19).toString().equals(akses.getkode())||akses.getkode().equals("Admin Utama"))
            {
        ...
        try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ps5=koneksi.prepareStatement("select pemeriksaan_obstetri_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "pemeriksaan_obstetri_ranap.kualitas_mnt,pemeriksaan_obstetri_ranap.kualitas_dtk,pemeriksaan_obstetri_ranap.fluksus,pemeriksaan_obstetri_ranap.albus, " +
                    "pemeriksaan_obstetri_ranap.vulva,pemeriksaan_obstetri_ranap.portio,pemeriksaan_obstetri_ranap.dalam, pemeriksaan_obstetri_ranap.tebal, pemeriksaan_obstetri_ranap.arah, pemeriksaan_obstetri_ranap.pembukaan," +
                    "pemeriksaan_obstetri_ranap.penurunan, pemeriksaan_obstetri_ranap.denominator, pemeriksaan_obstetri_ranap.ketuban, pemeriksaan_obstetri_ranap.feto,pemeriksaan_obstetri_ranap.kd_dokter,pegawai.nama " +
                    "from pasien inner join reg_periksa inner join pemeriksaan_obstetri_ranap "+
                    "on pemeriksaan_obstetri_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_obstetri_ranap.kd_dokter=pegawai.nik where  "+
    ...
    private void isForm2(){
        if(ChkInput1.isSelected()==true){
            ...
            PanelInput2.setPreferredSize(new Dimension(WIDTH,190));
    ...
    private void tampilPemeriksaanGinekologi() {
        ...
        try{
            ps6=koneksi.prepareStatement("select pemeriksaan_ginekologi_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "pemeriksaan_ginekologi_ranap.portio_inspekulo,pemeriksaan_ginekologi_ranap.sondage,pemeriksaan_ginekologi_ranap.portio_dalam,pemeriksaan_ginekologi_ranap.bentuk, " +
                    "pemeriksaan_ginekologi_ranap.cavum_uteri,pemeriksaan_ginekologi_ranap.mobilitas,pemeriksaan_ginekologi_ranap.ukuran, pemeriksaan_ginekologi_ranap.nyeri_tekan, pemeriksaan_ginekologi_ranap.adnexa_kanan, pemeriksaan_ginekologi_ranap.adnexa_kiri," +
                    "pemeriksaan_ginekologi_ranap.cavum_douglas,pemeriksaan_ginekologi_ranap.kd_dokter,pegawai.nama " +
                    "from pasien inner join reg_periksa inner join pemeriksaan_ginekologi_ranap "+
                    "on pemeriksaan_ginekologi_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ginekologi_ranap.kd_dokter=pegawai.nik where  "+
    ...
    private void isForm3(){
        if(ChkInput2.isSelected()==true){
            ...
            PanelInput3.setPreferredSize(new Dimension(WIDTH,260));
