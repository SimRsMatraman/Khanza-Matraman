...
import rekammedis.RMCariTindakan;
...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    private rekammedis.RMCariDiagnosa1 rmcaridiagnosa1=new rekammedis.RMCariDiagnosa1(null,false);
    private rekammedis.RMCariDiagnosa2 rmcaridiagnosa2=new rekammedis.RMCariDiagnosa2(null,false);
    private rekammedis.RMCariDiagnosa3 rmcaridiagnosa3=new rekammedis.RMCariDiagnosa3(null,false);
    ...
    public DlgRujuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            ...
            "Diagnosa Utama","Kode Dokter","Dokter Perujuk","Kategori Rujuk","Ambulance","Keterangan",
            "Diagnosa Sekunder 1","Diagnosa Sekunder 2","Tindakan","Terapi"
        };
        ...
        TDiagnosa1.setDocument(new batasInput((int)5000).getKata(TDiagnosa1));
        TDiagnosa2.setDocument(new batasInput((int)5000).getKata(TDiagnosa2));
        ...
        rmcaridiagnosa1.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(rmcaridiagnosa1.getTable().getSelectedRow()!= -1){
                    TDiagnosa.setText(rmcaridiagnosa1.getTable().getValueAt(rmcaridiagnosa1.getTable().getSelectedRow(),0).toString());
                    TDiagnosa.setText(rmcaridiagnosa1.getTable().getValueAt(rmcaridiagnosa1.getTable().getSelectedRow(),1).toString());
        ...
        rmcaridiagnosa2.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(rmcaridiagnosa2.getTable().getSelectedRow()!= -1){
                    TDiagnosa1.setText(rmcaridiagnosa2.getTable().getValueAt(rmcaridiagnosa2.getTable().getSelectedRow(),0).toString());
                    TDiagnosa1.setText(rmcaridiagnosa2.getTable().getValueAt(rmcaridiagnosa2.getTable().getSelectedRow(),1).toString());
        ...
        rmcaridiagnosa3.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(rmcaridiagnosa3.getTable().getSelectedRow()!= -1){
                    TDiagnosa2.setText(rmcaridiagnosa3.getTable().getValueAt(rmcaridiagnosa3.getTable().getSelectedRow(),0).toString());
                    TDiagnosa2.setText(rmcaridiagnosa3.getTable().getValueAt(rmcaridiagnosa3.getTable().getSelectedRow(),1).toString());
                    TDiagnosa2.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Rujukan Keluar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2024" }));
        ...
        jLabel5.setBounds(435, 160, 72, 23);
        ...
        FormInput.add(KdDok);
        KdDok.setBounds(510, 160, 100, 23);
        ...
        btnDokter.setBounds(790, 160, 28, 23);
        ...
        TDokter.setBounds(610, 160, 180, 23);
        ...
        jLabel16.setText("Diagnosa Sekunder 1 :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(10, 130, 120, 23);

        TDiagnosa1.setHighlighter(null);
        ...
        TDiagnosa1.setBounds(150, 130, 260, 20);

        jLabel10.setText("Diagnosa Sekunder 2 :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(10, 160, 120, 23);

        TDiagnosa2.setHighlighter(null);
        ...
        TDiagnosa2.setBounds(150, 160, 260, 23);
        ...
        btnDokter2.setBounds(410, 130, 28, 23);
        ...
        btnDokter3.setBounds(410, 160, 28, 23);

        jLabel17.setText("Tindakan Yang Dilakukan :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(10, 190, 180, 23);
        ...
        BtnDokter15.setBounds(170, 210, 28, 23);
        ...
        scrollPane7.setBounds(200, 190, 541, 50);

        jLabel18.setText("Terapi :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(0, 250, 190, 23);
        ...
        BtnDokter4.setBounds(160, 270, 28, 23);
        ...
        scrollPane6.setBounds(200, 250, 541, 50);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRj.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"rujuk","no_rujuk",TNoRj,"no_rawat='"+TNoRw.getText()+
                    ...
                    "',keterangan_diagnosa1='"+TDiagnosa1.getText()+
                    "',keterangan_diagnosa2='"+TDiagnosa2.getText()+
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptRujuk.jasper","report","::[ Data Rujuk Pasien ]::","select rujuk.no_rujuk,rujuk.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "rujuk.rujuk_ke,rujuk.tgl_rujuk,rujuk.jam,rujuk.keterangan_diagnosa,rujuk.kd_dokter,dokter.nm_dokter,rujuk.kat_rujuk,rujuk.ambulance,rujuk.keterangan,rujuk.keterangan_diagnosa1,rujuk.keterangan_diagnosa2,rujuk.tindakan,rujuk.obat_pulang "+
...
private void TDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokterKeyPressed
    ...
    private void MnSuratRujukanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratRujukanActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("diagnosa1",tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            param.put("diagnosa2",tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
//            param.put("tindakan",diagnosa2);
//            param.put("terpi",diagnosa);
            param.put("tindakan",Sequel.cariIsi("select tindakan from rujuk where no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()));
            param.put("terpi",Sequel.cariIsi("select obat_pulang from rujuk where no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()));
            param.put("kotars",akses.getkabupatenrs());
            param.put("propinsirs",akses.getpropinsirs());
            param.put("kontakrs",akses.getkontakrs());
            param.put("emailrs",akses.getemailrs());
    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TDiagnosa1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            TDiagnosa2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
