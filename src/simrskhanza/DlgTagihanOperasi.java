...
//        jenis.setDocument(new batasInput((byte)8).getKata(jenis));
        ...
        Implan.setDocument(new batasInput((int)100).getKata(Implan));
        NoImplan.setDocument(new batasInput((int)50).getKata(NoImplan));
        Perdarahan.setDocument(new batasInput((byte)5).getKata(Perdarahan));
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(89, 650));
        ...
        label11.setBounds(800, 10, 70, 23);
        ...
        jLabel4.setBounds(420, 40, 90, 23);
        ...
        jLabel9.setBounds(0, 610, 145, 23);
        ...
        DikirimPA.setBounds(150, 610, 130, 23);
        ...
        scrollPane2.setBounds(510, 520, 320, 112);

        jLabel10.setText("Laporan Operasi :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(405, 520, 101, 23);

        Kategori1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Umum", "Spinal", "Lokal" }));
        Kategori1.setName("Kategori1"); // NOI18N
        Kategori1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Kategori1ActionPerformed(evt);
            }
        });
        Kategori1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Kategori1KeyPressed(evt);
            }
        });
        FormInput.add(Kategori1);
        Kategori1.setBounds(520, 40, 122, 23);

        jLabel13.setText("Jenis Pembedahan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(660, 40, 110, 23);
        ...
        JenisPembedahan.setBounds(780, 40, 122, 23);

        jLabel12.setText("Lama Pembedahan :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(660, 400, 110, 23);
        ...
        FormInput.add(Lama);
        Lama.setBounds(770, 400, 60, 23);

        jLabel11.setText("Jam");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(830, 400, 30, 23);

        jLabel14.setText("Komplikasi :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 520, 145, 23);
        ...
        Komplikasi.setBounds(150, 520, 256, 23);

        jLabel15.setText("Implan :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(0, 550, 145, 23);
        ...
        Implan.setBounds(150, 550, 100, 23);

        jLabel18.setText("Perdarahan :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(0, 580, 145, 23);
        ...
        Perdarahan.setBounds(150, 580, 70, 23);

        jLabel17.setText("cc");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(220, 580, 10, 23);

        jLabel20.setText("Transfusi Darah :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(230, 580, 100, 23);

        jLabel16.setText("No. Implan :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(260, 550, 70, 23);
        ...
        NoImplan.setBounds(335, 550, 70, 23);
        ...
        Transfusi.setBounds(335, 580, 70, 23);

        jLabel19.setText("cc");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(405, 580, 10, 23);

        jLabel21.setText("Tindakan Operasi :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(407, 430, 100, 23);

        label13.setText("Tanggal :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label13);
        label13.setBounds(290, 610, 50, 23);
        ...
        FormInput.add(TanggalPA);
        TanggalPA.setBounds(350, 610, 100, 23);
        ...
        scrollPane3.setBounds(511, 430, 320, 80);

        jLabel22.setText("Kategori :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(220, 40, 60, 23);

        Kategori2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Elektive", "Emergency" }));
        Kategori2.setName("Kategori2"); // NOI18N
        Kategori2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Kategori2KeyPressed(evt);
            }
        });
        FormInput.add(Kategori2);
        Kategori2.setBounds(290, 40, 122, 23);
...
private void tglKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglKeyPressed
        Valid.pindah(evt,JenisPembedahan,BtnOperator1);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
   isForm();  
    ...
    private void KategoriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KategoriKeyPressed
        Valid.pindah(evt,TCariPaket,JenisPembedahan);
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                for(i=0;i<tbtindakan.getRowCount();i++){
                    if(tabMode.getValueAt(i,0).toString().equals("true")){
                        if(Sequel.menyimpantf2("operasi","'"+TNoRw.getText()+"','"+Valid.SetTgl(tgl.getSelectedItem()+"")+" "+tgl.getSelectedItem().toString().substring(11,19)
                            +"','"+Kategori1.getSelectedItem()+"','"+Kategori.getSelectedItem()+"','"+Kategori2.getSelectedItem()+"','"+kdoperator1.getText()+"','"+kdoperator2.getText()+"','"+kdoperator3.getText()
                ...
                if(sukses==true){
                    if(!Laporan.getText().equals("")){
                        if(Sequel.menyimpantf2("laporan_operasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","laporan operasi",17,new String[]{
...
//                    jenis.setText("");
    ...
    private void Kategori1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Kategori1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kategori1KeyPressed
    ...
    private void Kategori2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Kategori2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kategori2KeyPressed
    ...
    */
    ...
    private widget.ComboBox Kategori1;
    private widget.ComboBox Kategori2;
