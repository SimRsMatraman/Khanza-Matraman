...
import rekammedis.RMSkriningTB;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private String aktifkanparsial = "no", kamar_inap_kasir_ralan = Sequel.cariIsi("select set_jam_minimal.kamar_inap_kasir_ralan from set_jam_minimal"), caripenjab = "", filter = "no", bangsal = Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"), nonota = "",
            ...
            namadokter = "", namapoli = "", order = "poliklinik.nm_poli,dokter.nm_dokter,reg_periksa.no_reg asc",
    ...
    private void initComponents() {
        ...
        MnPenilaianAwalSkriningTB = new javax.swing.JMenuItem();
        ...
        MnPermintaanFisio = new javax.swing.JMenuItem();
        ...
        MnPeriksaMCU = new javax.swing.JMenuItem();
        MnPeriksaMCUJIWA = new javax.swing.JMenuItem();
        MnPeriksaLab = new javax.swing.JMenuItem();
        MnPeriksaRadiologi = new javax.swing.JMenuItem();
        MnOperasi = new javax.swing.JMenuItem();
        MnPeriksaMCU1 = new javax.swing.JMenuItem();
        ...
        ppADIME = new javax.swing.JMenuItem();
        ppMakanSehat = new javax.swing.JMenuItem();
        ...
        MnDataPemberianObatFDC = new javax.swing.JMenuItem();
        ...
        MnCetakSuratJiwa = new javax.swing.JMenuItem();
        ...
        BtnSuratKontrol = new widget.Button();
        ...
        MnRiwayat.setLabel("e-Medical Record");
        MnRiwayat.setName("MnRiwayat"); // NOI18N
        MnRiwayat.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        ppRiwayat.setText("Riwayat Pasien");
        ...
        MnRMRawatJalan.setText("Keperawatan Rawat Jalan");
        ...
        MnPenilaianAwalSkriningTB.setBackground(new java.awt.Color(255, 255, 254));
        MnPenilaianAwalSkriningTB.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenilaianAwalSkriningTB.setForeground(new java.awt.Color(50, 50, 50));
        MnPenilaianAwalSkriningTB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianAwalSkriningTB.setText("Skrining  TBC");
        MnPenilaianAwalSkriningTB.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPenilaianAwalSkriningTB.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPenilaianAwalSkriningTB.setName("MnPenilaianAwalSkriningTB"); // NOI18N
        MnPenilaianAwalSkriningTB.setPreferredSize(new java.awt.Dimension(250, 26));
        MnPenilaianAwalSkriningTB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenilaianAwalSkriningTBActionPerformed(evt);
            }
        });
        MnRMRawatJalan.add(MnPenilaianAwalSkriningTB);
        ...
        MnRMMedisRawatJalan.setText("Medis Rawat Jalan");
        ...
        MnPermintaanFisio.setBackground(new java.awt.Color(255, 255, 254));
        MnPermintaanFisio.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPermintaanFisio.setForeground(new java.awt.Color(50, 50, 50));
        MnPermintaanFisio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPermintaanFisio.setText("Pemeriksaan Fisioterapi");
        MnPermintaanFisio.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPermintaanFisio.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPermintaanFisio.setName("MnPermintaanFisio"); // NOI18N
        MnPermintaanFisio.setPreferredSize(new java.awt.Dimension(170, 26));
        MnPermintaanFisio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPermintaanFisioActionPerformed(evt);
            }
        });
        MnPermintaan.add(MnPermintaanFisio);
        ...
        MnPermintaanKonsultasiMedik.setToolTipText("");
        ...
        MnDataRalan.setText("Tindakan Rawat Jalan");
        ...
        MnPeriksaMCU.setBackground(new java.awt.Color(255, 255, 254));
        MnPeriksaMCU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPeriksaMCU.setForeground(new java.awt.Color(50, 50, 50));
        MnPeriksaMCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPeriksaMCU.setText("Periksa MCU");
        MnPeriksaMCU.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPeriksaMCU.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPeriksaMCU.setName("MnPeriksaMCU"); // NOI18N
        MnPeriksaMCU.setPreferredSize(new java.awt.Dimension(250, 26));
        MnPeriksaMCU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPeriksaMCUActionPerformed(evt);
            }
        });
        MnTindakanRalan.add(MnPeriksaMCU);

        MnPeriksaMCUJIWA.setBackground(new java.awt.Color(255, 255, 254));
        MnPeriksaMCUJIWA.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPeriksaMCUJIWA.setForeground(new java.awt.Color(50, 50, 50));
        MnPeriksaMCUJIWA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPeriksaMCUJIWA.setText("Periksa MCU Kesehatan Jiwa");
        MnPeriksaMCUJIWA.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPeriksaMCUJIWA.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPeriksaMCUJIWA.setName("MnPeriksaMCUJIWA"); // NOI18N
        MnPeriksaMCUJIWA.setPreferredSize(new java.awt.Dimension(250, 26));
        MnPeriksaMCUJIWA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPeriksaMCUJIWAActionPerformed(evt);
            }
        });
        MnTindakanRalan.add(MnPeriksaMCUJIWA);
        ...
        MnPeriksaMCU1.setBackground(new java.awt.Color(255, 255, 254));
        MnPeriksaMCU1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPeriksaMCU1.setForeground(new java.awt.Color(50, 50, 50));
        MnPeriksaMCU1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPeriksaMCU1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPeriksaMCU1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPeriksaMCU1.setLabel("Periksa MCU Pegawai");
        MnPeriksaMCU1.setName("MnPeriksaMCUPegawai"); // NOI18N
        MnPeriksaMCU1.setPreferredSize(new java.awt.Dimension(250, 26));
        MnPeriksaMCU1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPeriksaMCU1ActionPerformed(evt);
            }
        });
        MnTindakanRalan.add(MnPeriksaMCU1);
        ...
        ppADIME.setBackground(new java.awt.Color(255, 255, 254));
        ppADIME.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppADIME.setForeground(new java.awt.Color(50, 50, 50));
        ppADIME.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppADIME.setText("Catatan ADIME Gizi");
        ppADIME.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppADIME.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppADIME.setName("ppADIME"); // NOI18N
        ppADIME.setPreferredSize(new java.awt.Dimension(210, 26));
        ppADIME.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppADIMEBtnPrintActionPerformed(evt);
            }
        });
        MnGizi.add(ppADIME);

        ppMakanSehat.setBackground(new java.awt.Color(255, 255, 254));
        ppMakanSehat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppMakanSehat.setForeground(new java.awt.Color(50, 50, 50));
        ppMakanSehat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppMakanSehat.setText("Makan Sehat");
        ppMakanSehat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppMakanSehat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppMakanSehat.setName("ppMakanSehat"); // NOI18N
        ppMakanSehat.setPreferredSize(new java.awt.Dimension(210, 26));
        ppMakanSehat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppMakanSehatBtnPrintActionPerformed(evt);
            }
        });
        MnGizi.add(ppMakanSehat);

        jPopupMenu1.add(MnGizi);
        ...
        MnDataPemberianObatFDC.setBackground(new java.awt.Color(255, 255, 254));
        MnDataPemberianObatFDC.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnDataPemberianObatFDC.setForeground(new java.awt.Color(50, 50, 50));
        MnDataPemberianObatFDC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnDataPemberianObatFDC.setText("Data Pemberian Obat FDC");
        MnDataPemberianObatFDC.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnDataPemberianObatFDC.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnDataPemberianObatFDC.setName("MnDataPemberianObatFDC"); // NOI18N
        MnDataPemberianObatFDC.setPreferredSize(new java.awt.Dimension(200, 26));
        MnDataPemberianObatFDC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDataPemberianObatFDCActionPerformed(evt);
            }
        });
        MnObatRalan.add(MnDataPemberianObatFDC);
        ...
        MnCetakSuratSehat1.setText("Surat Keterangan Sehat/MCU");
        ...
        MnCetakSuratJiwa.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakSuratJiwa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratJiwa.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratJiwa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratJiwa.setText("Surat Keterangan Kesehatan Jiwa");
        MnCetakSuratJiwa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratJiwa.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratJiwa.setName("MnCetakSuratJiwa"); // NOI18N
        MnCetakSuratJiwa.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratJiwa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratJiwaActionPerformed(evt);
            }
        });
        MnSuratSurat.add(MnCetakSuratJiwa);
        ...
        MnRiwayatPerawatanICareNIK.setPreferredSize(new java.awt.Dimension(230, 26));
        ...
        MnRiwayatPerawatanICareNoKartu.setPreferredSize(new java.awt.Dimension(230, 26));
        ...
        MnRiwayatPerawatanICareNIK1.setPreferredSize(new java.awt.Dimension(230, 26));
        ...
        MnRiwayatPerawatanICareNoKartu1.setPreferredSize(new java.awt.Dimension(230, 26));
        ...
        AD.setHighlighter(null);
        AD.setName("AD"); // NOI18N
        AD.setPreferredSize(new java.awt.Dimension(250, 23));
        ...
        BtnSeek4.setPreferredSize(new java.awt.Dimension(33, 23));
        ...
        BtnEdit2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cancel.png"))); // NOI18N
        BtnEdit2.setText("Pasien Batal");
        BtnEdit2.setToolTipText("");
        BtnEdit2.setName("BtnEdit2"); // NOI18N
        BtnEdit2.setPreferredSize(new java.awt.Dimension(130, 30));
        BtnEdit2.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentHidden(java.awt.event.ComponentEvent evt) {
                BtnEdit2ComponentHidden(evt);
            }
        });
        ...
        panelGlass7.add(BtnEdit2);

        BtnSuratKontrol.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bpjs.png"))); // NOI18N
        BtnSuratKontrol.setText("Surat Kontrol BPJS");
        BtnSuratKontrol.setToolTipText("");
        BtnSuratKontrol.setName("BtnSuratKontrol"); // NOI18N
        BtnSuratKontrol.setPreferredSize(new java.awt.Dimension(170, 30));
        BtnSuratKontrol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSuratKontrolActionPerformed(evt);
            }
        });
        panelGlass7.add(BtnSuratKontrol);
        ...
        jLabel11.setPreferredSize(new java.awt.Dimension(13, 23));
        ...
        jLabel9.setPreferredSize(new java.awt.Dimension(13, 23));
        ...
        BtnInput.setPreferredSize(new java.awt.Dimension(160, 30));
        BtnInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnInput);

        BtnInput1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        BtnInput1.setText("Riwayat Pasien");
        BtnInput1.setToolTipText("");
        BtnInput1.setName("BtnInput1"); // NOI18N
        BtnInput1.setPreferredSize(new java.awt.Dimension(160, 30));
        BtnInput1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInput1ActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnInput1);
                        ...
                        if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                            ...
                            if (normdipilih.equals(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 2).toString())) {
                                Sequel.queryu2("update asuhan_gizi set no_rawat=? where no_rawat=?", 2,
                                        new String[]{
                                            tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString(), norawatdipilih
                                        }
                                );
                                ...
                                if (Sequel.queryu2tf("delete from reg_periksa where no_rawat=?", 1, new String[]{norawatdipilih}) == true) {
                                    for (i = 0; i < tbKasirRalan.getRowCount(); i++) {
                                        if (tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString().equals(norawatdipilih)) {
...
private void BtnSeek3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek3ActionPerformed
    ...
    billing.dokter.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
...
private void BtnSeek4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek4ActionPerformed
    ...
    pilihan = 2;
    billing.poli.isCek();
    billing.poli.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
...
private void MnSudahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSudahActionPerformed
    if (TNoRw.getText().trim().equals("")) {
        ...
        if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                tabModekasir.setValueAt("Sudah", tbKasirRalan.getSelectedRow(), 11);
            }
        }
...
private void MnBelumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBelumActionPerformed
    if (TNoRw.getText().trim().equals("")) {
        ...
        if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                tabModekasir.setValueAt("Belum", tbKasirRalan.getSelectedRow(), 11);
            }
        }
    ...
    if (tabModekasir.getRowCount() == 0) {
        ...
        if (tbKasirRalan.getSelectedRow() != -1) {
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                if (tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString().equals("U0021") || tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString().equals("U0045")) {
                ...
                } else if (tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString().equals("U0036")) {
                    dlgrwjl2.isCek();
                    dlgrwjl2.rawatjl_dr();
                    dlgrwjl2.menuGizi();
                    dlgrwjl2.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                    ...
                    dlgrwjl2.SetPoli(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString());
                    dlgrwjl2.SetPj(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 17).toString());
                    dlgrwjl2.setNoRmGizi(TNoRw.getText(), DTPCari1.getDate(), DTPCari2.getDate());
                    dlgrwjl2.setVisible(true);
                } else {
                    dlgrwjl2.isCek();
                    dlgrwjl2.emptTeks();
...
private void MnKamarInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKamarInapActionPerformed
    if (tabModekasir.getRowCount() == 0) {
        ...
        if (tbKasirRalan.getSelectedRow() != -1) {
            if (tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 11).toString().equals("Batal")) {
                ...
                if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                    ...
                    kamarinap.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        ...
        if (kdpoli.getText().trim().equals("") || nmpoli.getText().trim().equals("")) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                ...
                tabModekasir.setValueAt(nmpoli.getText(), tbKasirRalan.getSelectedRow(), 5);
            }
            WindowGantiPoli.dispose();
        }
    ...
    private void MnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBatalActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                if (tbKasirRalan.getSelectedRow() > -1) {
                    tabModekasir.setValueAt("Batal", tbKasirRalan.getSelectedRow(), 11);
                }
            }
        }
    ...
    private void BtnSimpan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan5ActionPerformed
        ...
        if (kdpenjab.getText().trim().equals("") || nmpenjab.getText().trim().equals("")) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                ...
                tabModekasir.setValueAt(nmpenjab.getText(), tbKasirRalan.getSelectedRow(), 10);
            }
            WindowCaraBayar.dispose();
        }
    ...
    private void btnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBayarActionPerformed
        ...
        billing.penjab.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
    ...
    private void ppBerkasRanapBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasRanapBtnPrintActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                tabModekasir.setValueAt("Dirawat", tbKasirRalan.getSelectedRow(), 11);
            }
        }
    ...
    private void MnDirujukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDirujukActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                MnRujukActionPerformed(evt);
                if (tbKasirRalan.getSelectedRow() > -1) {
                    tabModekasir.setValueAt("Dirujuk", tbKasirRalan.getSelectedRow(), 11);
                }
            }
        }
    ...
    private void MnMeninggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMeninggalActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                if (tbKasirRalan.getSelectedRow() > -1) {
                    tabModekasir.setValueAt("Meninggal", tbKasirRalan.getSelectedRow(), 11);
                }
            }
...
//                    }
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString().equals("Batal")) {
                    ...
                    if (Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                        JOptionPane.showMessageDialog(rootPane, "Data billing sudah terverifikasi..!!");
                    } else {
                        akses.setstatus(true);
                        kamarinap.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                        ...
                        kamarinap.emptTeks();
                        kamarinap.isCek();
                        kamarinap.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 2).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 3).toString());
                        kamarinap.setVisible(true);
                    }
                }
            }
    ...
    private void MnObatLangsung1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnObatLangsung1ActionPerformed
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    JOptionPane.showMessageDialog(null, "Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
                } else {
                    if (Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                        JOptionPane.showMessageDialog(rootPane, "Data billing sudah terverifikasi ..!!");
                    } else {
                        TotalObat.setText(Sequel.cariIsi("select besar_tagihan from tagihan_obat_langsung where no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()));
                        WindowObatBhp.setSize(590, 80);
                        WindowObatBhp.setLocationRelativeTo(internalFrame1);
                        WindowObatBhp.setVisible(true);
                    }
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    dlgrwinap.isCek();
                    dlgrwinap.setNoRm(
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(),
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    periksalab.setLocationRelativeTo(internalFrame1);
                    periksalab.emptTeks();
                    periksalab.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(), "Ralan");
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    periksarad.setLocationRelativeTo(internalFrame1);
                    periksarad.emptTeks();
                    periksarad.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(), "Ralan");
                ...
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    if (Sequel.cariRegistrasi(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                        ...
                        dlgobt.setNoRm(
                                ...
                                Sequel.cariIsi("select reg_periksa.tgl_registrasi from reg_periksa where reg_periksa.no_rawat='" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString() + "'"),
                                Sequel.cariIsi("select jam_reg from reg_periksa where no_rawat='" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString() + "'")
                        );
                        dlgobt.isCek();
                        dlgobt.setDokter(
                                tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    try {
                        sudah = Sequel.cariInteger("select count(billing.no_rawat) from billing where billing.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
                        pscaripiutang = koneksi.prepareStatement("select tgl_piutang from piutang_pasien where no_rkm_medis=? and status='Belum Lunas' order by tgl_piutang asc limit 1");
                        try {
                            ...
                            if (rskasir.next()) {
                                ...
                                if (i == JOptionPane.YES_OPTION) {
                                    ...
                                    billing.TNoRw.setText(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
                                    billing.isCek();
                                    billing.isRawat();
                                    if (sudah > 0) {
                                        billing.setPiutang();
    ...
    private void ppBerkasDigital1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDigital1BtnPrintActionPerformed
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                ...
                try {
                    if (akses.gethapus_berkas_digital_perawatan() == true) {
                        berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkasrawat/login2.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&no_rawat=" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
                    } else {
                        berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkasrawat/login2nonhapus.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&no_rawat=" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
                    }
                } catch (Exception ex) {
                    System.out.println("Notifikasi : " + ex);
                }
    ...
    private void ppIKPBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppIKPBtnPrintActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            aplikasi.isCek();
            aplikasi.setNoRm(TNoRw.getText(), DTPCari1.getDate(), DTPCari2.getDate(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 5).toString());
            aplikasi.tampil();
    ...
    private void ppIKP1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppIKP1BtnPrintActionPerformed
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                ...
                aplikasi.setLocationRelativeTo(internalFrame1);
                aplikasi.isCek();
                aplikasi.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(), DTPCari1.getDate(), DTPCari2.getDate(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 5).toString());
                aplikasi.tampil();
                aplikasi.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        ...
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                    ...
                    form.setNoRm(TNoRw.getText(), TNoRMCari.getText(), TPasienCari.getText(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 5).toString(), "Ralan");
    ...
    private void MnPulangPaksaBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPulangPaksaBtnPrintActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                if (tbKasirRalan.getSelectedRow() > -1) {
                    tabModekasir.setValueAt("Pulang Paksa", tbKasirRalan.getSelectedRow(), 11);
                }
            }
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() > -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    form.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                    form.setLocationRelativeTo(internalFrame1);
                    form.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 2).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 3).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 5).toString(), "Ralan");
                    form.setVisible(true);
                    this.setCursor(Cursor.getDefaultCursor());
                }
            } else {
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() > -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()) > 0) {
                    ...
                    dlgro.emptTeks();
                    dlgro.isCek();
                    dlgro.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString(), "Ralan",
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
                            tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 1).toString());
                    dlgro.setVisible(true);
                    this.setCursor(Cursor.getDefaultCursor());
    ...
    private void ppBerkasDIterimaBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDIterimaBtnPrintActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                tabModekasir.setValueAt("Berkas Diterima", tbKasirRalan.getSelectedRow(), 11);
            }
        }
    ...
    private void MnCetakSuratJiwaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratJiwaActionPerformed
        if (TPasienCari.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
        } else {
            if (tbKasirRalan.getSelectedRow() != -1) {
                ...
                finger = Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString());
                param.put("finger", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 1).toString() + "\nID " + (finger.equals("") ? tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString() : finger) + "\n" + Valid.SetTgl3(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString()));
                Valid.MyReport("rptSuratSehatJiwa.jasper", param, "::[ Surat Keterangan Kesehatan Jiwa ]::");
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnCetakSuratJiwaActionPerformed
    ...
    private void MnSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSEPActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                ...
                dlgki.isCek();
                dlgki.setNoRm2(TNoRw.getText(), Valid.SetTgl2(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 13).toString()), "2. Ralan", tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 5).toString(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 6).toString());
    ...
    private void ppResumeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResumeBtnPrintActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMDataResumePasienRajal resume = new RMDataResumePasienRajal(null, false);
                resume.isCek();
                resume.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                resume.setLocationRelativeTo(internalFrame1);
    ...
    private void MnCetakSuratSakitPihak2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitPihak2ActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                ...
                resume.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                resume.setLocationRelativeTo(internalFrame1);
                resume.setNoRm(TNoRw.getText(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 9).toString(), DTPCari1.getDate(), DTPCari2.getDate());
                resume.tampil();
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        ...
        if (tabModekasir.getRowCount() == 0) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                    ...
                    norawatdipilih = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString();
...
//    }
        ...
        if (tabModekasir2.getRowCount() == 0) {
            ...
            if (tbKasirRalan2.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRwCari.getText()) > 0) {
                    ...
                    form.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                    form.setLocationRelativeTo(internalFrame1);
                    form.setNoRm(TNoRwCari.getText(), TNoRMCari.getText(), TPasienCari.getText(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 1).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 8).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 5).toString(), tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 15).toString());
                    form.setVisible(true);
                }
            }
        }
    ...
    private void BtnKetWarnaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKetWarnaActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgKeteranganWarna warna = new DlgKeteranganWarna(null, true);
    ...
    private void MnPeriksaMCUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaMCUActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        } else if (TPasienCari.getText().trim().equals("")) {
    ...
    }//GEN-LAST:event_MnPeriksaMCUActionPerformed
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                ...
                if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                    ...
                    Sequel.queryu2("update reg_periksa set stts=? where no_rawat=?", 2,
                            new String[]{
                                "Konfirmasi", tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString()
                            });
                    tampilkasir();
                }
            }
    ...
    private void BtnEdit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit2ActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (tbKasirRalan.getSelectedRow() > -1) {
                int reply = JOptionPane.showConfirmDialog(rootPane, "Konfirmasi pasien batal berobat??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                    JOptionPane.showMessageDialog(rootPane, "Data billing sudah terverifikasi, data tidak boleh diubah.\nSilahkan hubungi bagian kasir/keuangan ..!!");
                    TCari.requestFocus();
                } else if (reply == JOptionPane.YES_OPTION) {
                    Sequel.queryu2("update reg_periksa set stts=? where no_rawat=?", 2,
                            new String[]{
                                "Batal", tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString()
                            });
                    tampilkasir();
                }
            }
    ...
    private void BtnEdit2ComponentHidden(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_BtnEdit2ComponentHidden
        BtnEdit2.setVisible(false);
    }//GEN-LAST:event_BtnEdit2ComponentHidden
    ...
    private void MnPeriksaMCU1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaMCU1ActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        } else if (TPasienCari.getText().trim().equals("")) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                SuratMCUPegawai resume = new SuratMCUPegawai(null, false);
                resume.isCek();
                resume.emptTeks();
                resume.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                resume.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_MnPeriksaMCU1ActionPerformed
...
//GEN-LAST:event_MnRiwayatPerawatanICareNIK1ActionPerformed
    ...
    private void BtnInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Silahkan pilih pasien pada tabel");
            TCari.requestFocus();
        } else {
            if (tbKasirRalan.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
    ...
    private void MnPermintaanFisioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPermintaanFisioActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TNoReg.requestFocus();
        } else if (TPasienCari.getText().trim().equals("")) {
            ...
            if (tbKasirRalan.getSelectedRow() != -1) {
                if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                    ...
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    DlgPermintaanFisio dlgro = new DlgPermintaanFisio(null, false);
                    dlgro.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                    dlgro.setLocationRelativeTo(internalFrame1);
                    dlgro.emptTeks();
                    dlgro.isCek();
    ...
    }//GEN-LAST:event_MnPermintaanFisioActionPerformed
...
//                            resep.tampilobat();
    ...
    private void MnPeriksaMCUJIWAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaMCUJIWAActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        } else if (TPasienCari.getText().trim().equals("")) {
    ...
    }//GEN-LAST:event_MnPeriksaMCUJIWAActionPerformed

    private void ppADIMEBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppADIMEBtnPrintActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        } else if (TNoRw.getText().trim().equals("")) {
    ...
    }//GEN-LAST:event_ppMakanSehatBtnPrintActionPerformed
    ...
    private void MnDataPemberianObatFDCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatFDCActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Pasien belum dipilih...!!!");
            TNoRw.requestFocus();
        } else {
            if (Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?", TNoRw.getText()) > 0) {
                ...
                DlgPemberianObatFDC dlgrwinap = new DlgPemberianObatFDC(null, false);
                dlgrwinap.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                dlgrwinap.setLocationRelativeTo(internalFrame1);
                dlgrwinap.isCek();
                dlgrwinap.setNoRm(TNoRw.getText(), DTPCari1.getDate(), DTPCari2.getDate(), "ralan");
    ...
    private void MnPenilaianAwalSkriningTBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianAwalSkriningTBActionPerformed
        if (TPasienCari.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu data registrasi pada table...!!!");
            TCari.requestFocus();
        } else {
            if (tbKasirRalan.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMSkriningTB tb = new RMSkriningTB(null, false);
                tb.isCek();
                tb.emptTeks();
                tb.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                tb.setLocationRelativeTo(internalFrame1);
                tb.setNoRm(TNoRw.getText(), TNoRMCari.getText(), TPasienCari.getText(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 1).toString(), DTPCari1.getDate(), DTPCari2.getDate(), AD.getText());
                tb.tampil();
                tb.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnPenilaianAwalSkriningTBActionPerformed
    ...
    private widget.Button BtnInput;
    private widget.Button BtnInput1;
    ...
    private widget.Button BtnSuratKontrol;
    ...
    private javax.swing.JMenuItem MnCetakSuratJiwa;
    ...
    private javax.swing.JMenuItem MnDataPemberianObatFDC;
    ...
    private javax.swing.JMenuItem MnPenilaianAwalSkriningTB;
    ...
    private javax.swing.JMenuItem MnPermintaanFisio;
    ...
    private javax.swing.JMenuItem ppADIME;
    ...
    private javax.swing.JMenuItem ppMakanSehat;
...
//    private javax.swing.JMenuItem MnDataKonsultasiMedik;
    ...
    private void getDatakasir() {
        if (tbKasirRalan.getSelectedRow() != -1) {
            TNoRw.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString());
            Tanggal.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 13).toString());
            Jam.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 14).toString());
            TNoRwCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString());
            TNoReg.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 6).toString());
            ...
            KdPoli.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 18).toString());
            
            Integer umur = null;
            String kategoriUmur = "tidak diketahui";

            try {
                pskasir = koneksi.prepareStatement(
                        "SELECT umurdaftar FROM reg_periksa WHERE no_rkm_medis = ?"
                );
                pskasir.setString(1, TNoRMCari.getText());

                rskasir = pskasir.executeQuery();
                if (rskasir.next()) {
                    int tmpUmur = rskasir.getInt("umurdaftar");
                    if (!rskasir.wasNull()) {
                        umur = tmpUmur;
                        kategoriUmur = (umur < 17) ? "Anak" : "Dewasa";
                    }
                }

                AD.setText(kategoriUmur);
...
//        MnDataSEP.setEnabled(akses.getbpjs_sep());  
        ...
        MnCetakSuratSehat1.setEnabled(akses.getsurat_keterangan_sehat());
        MnPeriksaMCU.setEnabled(akses.getsurat_keterangan_sehat());
...
//        MnCatatanCekGDS.setEnabled(akses.getcatatan_cek_gds());
    ...
    private void otomatisRalan2() {
        try {
            ...
            try {
                ...
                psotomatis.setString(2, Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()));
                rskasir = psotomatis.executeQuery();
                while (rskasir.next()) {
                    if (Sequel.cariIsiAngka("select count(no_rawat) from rawat_jl_dr where "
                            + "no_rawat='" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString() + "' and kd_jenis_prw='" + rskasir.getString(1) + "' "
                            + "and kd_dokter='" + tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString() + "'") == 0) {
                        psotomatis2 = koneksi.prepareStatement(sqlpsotomatis2);
                        try {
                            psotomatis2.setString(1, tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
                            psotomatis2.setString(2, rskasir.getString(1));
            ...
            if (!akses.getkode().equals("Admin Utama")) {
                psotomatis = koneksi.prepareStatement(sqlpsotomatispetugas);
                try {
                    psotomatis.setString(1, Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?", tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString()));
                    rskasir = psotomatis.executeQuery();
                    while (rskasir.next()) {
    ...
    private void getDatakasir2() {
        if (tbKasirRalan2.getSelectedRow() != -1) {
            TNoRwCari.setText(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 11).toString());
            TNoReg.setText("-");
    ...
    private void panggilformobat() {
        if (tbKasirRalan.getSelectedRow() != -1) {
            ...
            dlgobt.setNoRm(TNoRw.getText(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 2).toString(),
                    ...
                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 14).toString());
            dlgobt.isCek();
            dlgobt.setDokter("", "");
            dlgobt.tampilobat();
            dlgobt.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
    ...
    private void billingparsial() {
        if (tbKasirRalan.getSelectedRow() != -1) {
            ...
            if (jmlparsial > 0) {
                ...
                parsialralan.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
                ...
                JOptionPane.showMessageDialog(null, "Maaf, Cara bayar " + tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 11).toString() + " tidak diijinkan menggunakan Billing Parsial...!!!");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            tbKasirRalan.requestFocus();
