...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private String kamar,namakamar,pemeriksaan="",pilihan="",status="",finger="",NmPasien="";
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
    ...
    public DlgCariPeriksaRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","No.Rm","Pasien","Petugas","Tgl.Periksa","Jam Periksa","Dokter Perujuk","Penanggung Jawab"};
    ...
    private void initComponents() {
        ...
        WindowDicom = new javax.swing.JDialog();
        internalFrame7 = new widget.InternalFrame();
        panelGlass9 = new widget.panelisi();
        BtnCloseIn6 = new widget.Button();
        ScrollDicom = new widget.ScrollPane();
        ...
        btnWhatsAppRad = new widget.Button();
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jPopupMenuDicom.setName("jPopupMenuDicom"); // NOI18N

        MnViewDicom.setBackground(new java.awt.Color(255, 255, 254));
        MnViewDicom.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnViewDicom.setForeground(new java.awt.Color(50, 50, 50));
        MnViewDicom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnViewDicom.setText("View Dicom Image");
        MnViewDicom.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnViewDicom.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnViewDicom.setName("MnViewDicom"); // NOI18N
        MnViewDicom.setPreferredSize(new java.awt.Dimension(200, 26));
        MnViewDicom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnViewDicomActionPerformed(evt);
            }
        });
        jPopupMenuDicom.add(MnViewDicom);

        WindowDicom.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowDicom.setName("WindowDicom"); // NOI18N
        WindowDicom.setUndecorated(true);
        WindowDicom.setResizable(false);
        WindowDicom.getContentPane().setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Image Dicom Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        panelGlass9.add(BtnCloseIn6);

        internalFrame7.add(panelGlass9, java.awt.BorderLayout.PAGE_END);

        ScrollDicom.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(245, 255, 235)));
        ScrollDicom.setName("ScrollDicom"); // NOI18N
        ScrollDicom.setOpaque(true);
        ...
        ScrollDicom.setViewportView(tbListDicom1);

        internalFrame7.add(ScrollDicom, java.awt.BorderLayout.CENTER);

        WindowDicom.getContentPane().add(internalFrame7, java.awt.BorderLayout.CENTER);
        ...
        nmmem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nmmemActionPerformed(evt);
            }
        });
        panelisi3.add(nmmem);
        ...
        btnWhatsAppRad.setIcon(new javax.swing.ImageIcon("E:\\Khanza-Matraman\\src\\picture\\whatsapp.png")); // NOI18N
        btnWhatsAppRad.setMnemonic('2');
        btnWhatsAppRad.setText("Kirim WhatsApp");
        btnWhatsAppRad.setToolTipText("Alt+2");
        btnWhatsAppRad.setName("btnWhatsAppRad"); // NOI18N
        btnWhatsAppRad.setPreferredSize(new java.awt.Dimension(28, 23));
        btnWhatsAppRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWhatsAppRadActionPerformed(evt);
            }
        });
        panelisi3.add(btnWhatsAppRad);
        btnWhatsAppRad.setBounds(770, 10, 160, 40);
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Kd2.getText().equals("")||Petugas.getText().equals("")){
               JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data terlebih dahulu...!!!!"); 
                ...
                if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString())>0){
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        if(Kd2.getText().equals("")){
            ...
            if(HasilPeriksa.getText().equals("")){
                Sequel.queryu2("delete from hasil_radiologi where no_rawat=? and tgl_periksa=? and jam=? and tgl_hasil=? and jam_hasil=?",6,new String[]{
                ...
                if(Sequel.menyimpantf2("hasil_radiologi","?,?,?,?,?,?","Hasil Pemeriksaan", 6,new String[]{
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),HasilPeriksa.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),
                })==false){
                    Sequel.queryu2("update hasil_radiologi set hasil=?,tgl_hasil=?,jam_hasil=? where no_rawat=? and tgl_periksa=? and jam=?",6,new String[]{
                        HasilPeriksa.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),
        ...
        if(Kd2.getText().equals("")){
            ...
            try {
                ps2=koneksi.prepareStatement(
                    ...
                    "periksa_radiologi.BSF,periksa_radiologi.inak,periksa_radiologi.jml_penyinaran,periksa_radiologi.dosis,dokter.kd_dokter,dokter.no_ijn_praktek from periksa_radiologi inner join jns_perawatan_radiologi "+
                    "on periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw inner join dokter on periksa_radiologi.kd_dokter=dokter.kd_dokter where periksa_radiologi.no_rawat=? and periksa_radiologi.tgl_periksa=? "+
                    "and periksa_radiologi.jam=?");
                try {
            ...
            //            param.put("tgl_hasil",Sequel.cariIsi("select DATE_FORMAT(tgl_hasil,'%d-%m-%Y') from hasil_radiologi where no_rawat=? and tgl_periksa=?",Kd2.getText()));
            //            param.put("jam_hasil",Sequel.cariIsi("select jam_hasil from hasil_radiologi where no_rawat=? and tgl_periksa=?",Kd2.getText()));
            param.put("tgl_hasil",Sequel.cariIsi("select DATE_FORMAT(tgl_hasil,'%d-%m-%Y') from hasil_radiologi where no_rawat='"+Kd2.getText()+"' and tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString()+"'"));
            param.put("jam_hasil",Sequel.cariIsi("select jam_hasil from hasil_radiologi where no_rawat='"+Kd2.getText()+"' and tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString()+"'"));
            param.put("no_ijn_praktek",Sequel.cariIsi("select dokter.no_ijn_praktek,periksa_radiologi.kd_dokter from periksa_radiologi inner join dokter on periksa_radiologi.kd_dokter=dokter.kd_dokter where no_rawat=? ",Kd2.getText()));
...
//        dicomViewer.setJudul("::[ DICOM SERIES "+tbListDicom.getValueAt(tbListDicom.getSelectedRow(),5).toString()+" ]::","gbrpemeriksaan/pages");
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnViewDicomActionPerformed
...
//        tampilOrthanc();
        ...
        if(Kd2.getText().equals("")){
            ...
            if(HasilPeriksa.getText().equals("")){
                ...
                if(Sequel.menyimpantf2("hasil_radiologi","?,?,?,?,?,?","Hasil Pemeriksaan", 6,new String[]{
                    ...
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString(),HasilPeriksa.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),
                })==false){
                    Sequel.queryu2("update hasil_radiologi set hasil=?,tgl_hasil=?,jam_hasil=? where no_rawat=? and tgl_periksa=? and jam=?",6,new String[]{
                        HasilPeriksa.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),
                        tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString()
    ...
    private void ppRiwayatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayatBtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbDokter.getSelectedRow()!= -1){
                ...
                resume.setNoRm(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(),TCari.getText());
    ...
    private void nmmemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nmmemActionPerformed
        
    }//GEN-LAST:event_nmmemActionPerformed
...
//                this.setCursor(Cursor.getDefaultCursor());
    ...
    private void btnWhatsAppRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWhatsAppRadActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Platform.runLater(() -> {
                try {
                    WhatsAppSendRAD app = new WhatsAppSendRAD();
    ...
    }//GEN-LAST:event_btnWhatsAppRadActionPerformed
    ...
    */
    ...
    private widget.ScrollPane ScrollDicom;
    private widget.TextBox TCari;
    private javax.swing.JTabbedPane TabData;
    private widget.Tanggal Tgl1;
    private widget.Tanggal Tgl2;
    private widget.TextBox Umur;
    private javax.swing.JDialog WindowDicom;
    ...
    private widget.Button btnWhatsAppRad;
    ...
    private javax.swing.JPopupMenu jPopupMenuDicom;
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps5=koneksi.prepareStatement(
                        "select hasil,tgl_hasil,jam_hasil from hasil_radiologi where hasil_radiologi.no_rawat=? and hasil_radiologi.tgl_periksa=? and hasil_radiologi.jam=?");  
                    try {
                        ...
                        while(rs5.next()){  
                            ...
                            tabMode.addRow(new Object[]{"Tanggal Hasil :",rs5.getString("tgl_hasil"),"","","","",""});
                            tabMode.addRow(new Object[]{"Jam Hasil :",rs5.getString("jam_hasil"),"","","","",""});
                        }
                    } catch (Exception e) {
    ...
    private void isPhoto(){
        if(ChkAccor.isSelected()==true){
            ...
            PanelAccor.setPreferredSize(new Dimension(internalFrame1.getWidth()-450,HEIGHT));
                ...
                if((!Kd2.getText().equals(""))&&(!Petugas.getText().equals(""))){
                     try { 
                        ...
                        try {
                            ...
                            System.out.println("Percobaan Mengambil Gambar Series : "+StudyInstanceUID+" ");
                            kosong = "1";
                            while(rs.next()){
                            ...
                            if(kosong.equals("1")){
                                ...
                                htmlContent.append("<tr><td border='0' align='center'><a href='"+koneksiDB.URLORTHANC()+":"+koneksiDB.PORTORTHANC()+"/stone-webviewer/index.html?study="+StudyInstanceUID+"'><img src='"+koneksiDB.URLORTHANC()+":"+koneksiDB.PORTORTHANC()+"/instances/"+list.asText()+"/preview' alt='gambar' width='"+(internalFrame1.getWidth()-580)+"' height='"+(internalFrame1.getWidth()-580)+"'/></a></td></tr>");    
                                }  
                            }
