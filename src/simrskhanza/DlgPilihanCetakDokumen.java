            ...
            if(tbData.getValueAt(i,0).toString().equals("true")){
                if(tbData.getValueAt(i,1).toString().equals("Kartu Pasien 1")){
                    ...
                    Valid.MyReportqry("rptBuktiRegister.jasper","report","::[ Bukti Register ]::",
                           ...
                           "and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli left join bridging_sep ON bridging_sep.no_rawat = reg_periksa.no_rawat where reg_periksa.no_rawat='"+NoRawat+"' ",param);
                    this.setCursor(Cursor.getDefaultCursor());
