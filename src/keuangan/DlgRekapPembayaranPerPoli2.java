 ...
 * @author perpustakaan
 */
public final class DlgRekapPembayaranPerPoli2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRekapPembayaranPerPoli2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapPembayaranPerPoli2 dialog = new DlgRekapPembayaranPerPoli2(new javax.swing.JFrame(), true);
...
try {
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(rawat_jl_dr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_dr ON reg_periksa.no_rawat=rawat_jl_dr.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar'   group by kd_poli");
                   drpr= Sequel.cariInteger("select sum(rawat_jl_drpr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_drpr ON reg_periksa.no_rawat=rawat_jl_drpr.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar' group by kd_poli");
                   pr= Sequel.cariInteger("select sum(rawat_jl_pr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_pr ON reg_periksa.no_rawat=rawat_jl_pr.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar' group by kd_poli");
        ...
        tabMode.addRow(list.toArray());
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(rawat_jl_dr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_dr ON reg_periksa.no_rawat=rawat_jl_dr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%'  and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
                   drpr= Sequel.cariInteger("select sum(rawat_jl_drpr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_drpr ON reg_periksa.no_rawat=rawat_jl_drpr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%' and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
                   pr= Sequel.cariInteger("select sum(rawat_jl_pr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN rawat_jl_pr ON reg_periksa.no_rawat=rawat_jl_pr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and  nm_poli like '%"+TCari.getText().trim()+"%' and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
...
try {
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(rawat_inap_dr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_dr ON reg_periksa.no_rawat=rawat_inap_dr.no_rawat WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar'   group by kd_poli");
                   drpr= Sequel.cariInteger("select sum(rawat_inap_drpr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_drpr ON reg_periksa.no_rawat=rawat_inap_drpr.no_rawat WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar' group by kd_poli");
                   pr= Sequel.cariInteger("select sum(rawat_inap_pr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_pr ON reg_periksa.no_rawat=rawat_inap_pr.no_rawat WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar' group by kd_poli");
        ...
        tabMode2.addRow(list.toArray());
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(rawat_inap_dr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_dr ON reg_periksa.no_rawat=rawat_inap_dr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%'  and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
                   drpr= Sequel.cariInteger("select sum(rawat_inap_drpr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_drpr ON reg_periksa.no_rawat=rawat_inap_drpr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%' and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
                   pr= Sequel.cariInteger("select sum(rawat_inap_pr.biaya_rawat) as jumlah_tagihan from  reg_periksa inner join nota_inap on nota_inap.no_rawat=reg_periksa.no_rawat JOIN rawat_inap_pr ON reg_periksa.no_rawat=rawat_inap_pr.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_inap.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and  nm_poli like '%"+TCari.getText().trim()+"%' and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
...
try {
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(detail_pemberian_obat.total) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN detail_pemberian_obat ON reg_periksa.no_rawat=detail_pemberian_obat.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar'   group by kd_poli");
        ...
        tabMode4.addRow(list.toArray());
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(detail_pemberian_obat.total) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN detail_pemberian_obat ON reg_periksa.no_rawat=detail_pemberian_obat.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%'  and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
...
try {
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(periksa_lab.biaya) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN periksa_lab ON reg_periksa.no_rawat=periksa_lab.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar'   group by kd_poli");
        ...
        tabMode5.addRow(list.toArray());
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(periksa_lab.biaya) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN periksa_lab ON reg_periksa.no_rawat=periksa_lab.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%'  and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
...
try {
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(operasi.bagian_rs) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN operasi ON reg_periksa.no_rawat=operasi.no_rawat WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and reg_periksa.kd_poli='"+rstindakan.getString("kd_poli")+"' and status_bayar='Sudah Bayar'   group by kd_poli");
        ...
        tabMode7.addRow(list.toArray());
            ...
            try{  
                ...
                while(rs.next()){
                   ...
                   dr= Sequel.cariInteger("select sum(operasi.bagian_rs) as jumlah_tagihan from  reg_periksa inner join nota_jalan on nota_jalan.no_rawat=reg_periksa.no_rawat JOIN operasi ON reg_periksa.no_rawat=operasi.no_rawat JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli WHERE  nota_jalan.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and  reg_periksa.kd_pj='"+rs.getString("kd_pj")+"' and nm_poli like '%"+TCari.getText().trim()+"%'  and status_bayar='Sudah Bayar' group by reg_periksa.kd_pj");
