...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
    ...
    private double ttl=0,y=0,subttl=0,ralanparamedis=0,piutang=0,itembayar=0,itempiutang=0,itempermintaan=1,
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            sqlpsdetailplab="select sum(detail_periksa_lab.biaya_item) as total,sum(detail_periksa_lab.bagian_perujuk+detail_periksa_lab.bagian_dokter) as totaldokter, "+
                           "sum(detail_periksa_lab.bagian_laborat) as totalpetugas,sum(detail_periksa_lab.kso) as totalkso,sum(detail_periksa_lab.bhp) as totalbhp "+
                           "from detail_periksa_lab where detail_periksa_lab.no_rawat=? "+
                           "and detail_periksa_lab.kd_jenis_prw=?",
    ...
    private void initComponents() {
        ...
        MnPermintaanLab.setText("Input Permintaan Lab");
        ...
        MnPermintaanRadiologi.setText("Input Permintaan Radiologi");
        MnPermintaanRadiologi.setToolTipText("");
        ...
        chkLaborat.setBounds(15, 8, 40, 23);
        ...
        chkRadiologi.setBounds(130, 8, 70, 23);
        ...
        chkPLaborat.setText("PLab");
        chkPLaborat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkPLaborat.setName("chkPLaborat"); // NOI18N
        chkPLaborat.setOpaque(false);
        chkPLaborat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkPLaboratActionPerformed(evt);
            }
        });
                ...
                try{
                    ...
                    try{
                          ...
                          switch (biaya) {
                                case "Nota":
                                      i=1;
                                      Sequel.menyimpan("cetakan_billing_ralan","?,?,?,?,?","Data",5,new String[]{
                                            TNoRw.getText(),akses.getkode(),tanggalNow.format(new Date()),jamNow.format(new Date()),Valid.autoNomer("cetakan_billing_ralan where no_rawat='"+TNoRw.getText()+"'","",2)
                                        });
                                      break;
                                case "Kwitansi":
                                      i=2;
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void chkPLaboratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPLaboratActionPerformed
        isRawat();
