 ...
 * @author dosen
 */
public class DlgAkunBayar2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAkunBayar2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAkunBayar2 dialog = new DlgAkunBayar2(new javax.swing.JFrame(), true);
