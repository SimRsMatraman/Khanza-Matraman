 ...
 * @author dosen
 */
public final class DlgJnsPerawatanFisio extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJnsPerawatanFisio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Pemeriksaan Fisioterapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel11.setText("Total Biaya Fisioterapi : Rp. ");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("jns_perawatan_fisio","?,?,?,?,?,?,?,?,?,?,?,?,?","Kode Periksa",13,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){ 
            if(tbJnsPerawatan.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("jns_perawatan_fisio","kd_jenis_prw='"+tbJnsPerawatan.getValueAt(i,1).toString()+"'","status='0'");
            }
        }  
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("jns_perawatan_fisio","kd_jenis_prw=?","kd_jenis_prw=?,nm_perawatan=?,bagian_rs=?,tarif_tindakan_petugas=?,total_byr=?,kd_pj=?,tarif_tindakan_dokter=?,tarif_perujuk=?,bhp=?,kso=?,menejemen=?,kelas=?",13,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReportqry("rptTarifRad.jasper","report","::[ Data Tarif Radiologi ]::",
                    "select jns_perawatan_fisio.kd_jenis_prw,jns_perawatan_fisio.nm_perawatan,jns_perawatan_fisio.bagian_rs,"+
                    "jns_perawatan_fisio.bhp,jns_perawatan_fisio.tarif_perujuk,jns_perawatan_fisio.tarif_tindakan_dokter,jns_perawatan_fisio.tarif_tindakan_petugas,"+
                    "jns_perawatan_fisio.kso,jns_perawatan_fisio.menejemen,jns_perawatan_fisio.total_byr,penjab.png_jawab "+
                    "from jns_perawatan_fisio inner join penjab on penjab.kd_pj=jns_perawatan_fisio.kd_pj where "+
                    " jns_perawatan_fisio.status='1' and jns_perawatan_fisio.kd_jenis_prw like '%"+TCari.getText().trim()+"%' or "+
                    " jns_perawatan_fisio.status='1' and jns_perawatan_fisio.nm_perawatan like '%"+TCari.getText().trim()+"%' or "+
                    " jns_perawatan_fisio.status='1' and jns_perawatan_fisio.kelas like '%"+TCari.getText().trim()+"%' or "+
                    " jns_perawatan_fisio.status='1' and penjab.png_jawab like '%"+TCari.getText().trim()+"%' "+
                    "order by jns_perawatan_fisio.kd_jenis_prw",param);   
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanFisio dialog = new DlgJnsPerawatanFisio(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        "select jns_perawatan_fisio.kd_jenis_prw,jns_perawatan_fisio.nm_perawatan,jns_perawatan_fisio.bagian_rs,jns_perawatan_fisio.bhp,"+
                        "jns_perawatan_fisio.tarif_perujuk,jns_perawatan_fisio.tarif_tindakan_dokter,jns_perawatan_fisio.tarif_tindakan_petugas,"+
                        "jns_perawatan_fisio.kso,jns_perawatan_fisio.menejemen,jns_perawatan_fisio.total_byr,"+
                        "penjab.png_jawab,jns_perawatan_fisio.kelas from jns_perawatan_fisio inner join penjab on penjab.kd_pj=jns_perawatan_fisio.kd_pj where "+
                        "jns_perawatan_fisio.status='1' and jns_perawatan_fisio.kd_jenis_prw like ? or "+
                        "jns_perawatan_fisio.status='1' and jns_perawatan_fisio.nm_perawatan like ? or "+
                        "jns_perawatan_fisio.status='1' and jns_perawatan_fisio.kelas like ? or "+
                        "jns_perawatan_fisio.status='1' and penjab.png_jawab like ? "+
                        "order by jns_perawatan_fisio.kd_jenis_prw");
            try {            
    ...
    public void emptTeks() {        
        ...
        //Valid.autoNomer(" jns_perawatan_fisio ","JP",6,TKd);
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kd_jenis_prw,5),signed)),0) from jns_perawatan_fisio","J",6,TKd);
        TKd.requestFocus();
    }
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            Sequel.cariIsi("select kd_pj from jns_perawatan_fisio where kd_jenis_prw=?", kdpnj,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
