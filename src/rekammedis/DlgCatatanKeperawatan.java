...
public class DlgCatatanKeperawatan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgCatatanKeperawatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(1285, 674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Keperawatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCatatanKeperawatan dialog = new DlgCatatanKeperawatan(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append(
                    ...
                    + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>Catatan Keperawatan</td>"
                    + "</tr>"
            );
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + " AND validasi_catatan_keperawatan_ranap.jam_rawat = catatan_keperawatan_ranap.jam "
                                + "inner join pegawai on catatan_keperawatan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id "
                                + "LEFT JOIN pegawai AS namavalidator ON validasi_catatan_keperawatan_ranap.nik_validator=namavalidator.nik where catatan_keperawatan_ranap.no_rawat='" + rs.getString("no_rawat") + "' "
                                + "order by catatan_keperawatan_ranap.tanggal,catatan_keperawatan_ranap.jam").executeQuery();
                        if (rs2.next()) {
                            htmlContent.append(
                                    "<tr class='isi'>"
                                    ...
                                    + "<td valign='middle' bgcolor='#FFFFF8' align='center' width='40%'>Catatan Keperawatan</td>"
