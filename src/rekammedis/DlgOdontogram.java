...
public final class DlgOdontogram extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Hasil.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lain-lain", "Erupsi", "Hilang", "Karies", "Sisa Akar", "Tumpatan", "Goyang", "Calculus", "Abces", "Impaksi", "Protesa", "Hiperemia", "Persistensi", "Malposisi", "Tumpatan Sementara", "Tumpatan Permanen" }));
        ...
        Rahang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Rahang Atas", "Rahang Bawah", "Rahang Atas dan Bawah" }));
...
//                    ps.setString(36,"%"+TCari.getText()+"%");
    ...
    public void emptTeks() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(noorder,4),signed)),0) from pemeriksaan_gigi where pemeriksaan_gigi.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ","OD"+Valid.SetTgl(Tanggal.getSelectedItem()+"").replaceAll("-",""),5,TNoPermintaan);
        Catatan.setText("");
