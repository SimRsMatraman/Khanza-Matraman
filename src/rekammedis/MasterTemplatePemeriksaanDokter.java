...
public class MasterTemplatePemeriksaanDokter extends javax.swing.JDialog {
    ...
    public MasterTemplatePemeriksaanDokter(java.awt.Frame parent, boolean modal) {
        ...
        masters.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("MasterTemplatePemeriksaanDokter")){
                    if(masters.getTable().getSelectedRow()!= -1){
                        Subjek.setText(masters.getTable().getValueAt(masters.getTable().getSelectedRow(),3).toString());
                    }  
                    Subjek.requestFocus();
                }
            }
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("MasterTemplatePemeriksaanDokter")){
                    if(mastero.getTable().getSelectedRow()!= -1){
                        Objek.setText(mastero.getTable().getValueAt(mastero.getTable().getSelectedRow(),3).toString());
                    }  
                    Objek.requestFocus();
                }
            }
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("MasterTemplatePemeriksaanDokter")){
                    if(masterp.getTable().getSelectedRow()!= -1){
                        Plan.setText(masterp.getTable().getValueAt(masterp.getTable().getSelectedRow(),3).toString());
                    }  
                    Plan.requestFocus();
                }
            }
    ...
    private void initComponents() {
        ...
        scrollPane2.setBounds(16, 60, 660, 73);
        ...
        scrollPane3.setBounds(16, 160, 660, 73);
        ...
        scrollPane4.setBounds(16, 260, 690, 73);
        ...
        scrollPane5.setBounds(16, 360, 660, 73);
        ...
        scrollPane6.setBounds(16, 460, 690, 73);
        ...
        scrollPane7.setBounds(20, 563, 690, 70);
        ...
        BtnDokter1.setBounds(680, 80, 30, 30);
        ...
        BtnDokter2.setBounds(680, 180, 30, 30);
        ...
        BtnDokter3.setBounds(680, 380, 30, 30);
...
*/
    ...
    private void BtnDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter1ActionPerformed
        akses.setform("MasterTemplatePemeriksaanDokter");
        masters.isCek();
        masters.onCari();
