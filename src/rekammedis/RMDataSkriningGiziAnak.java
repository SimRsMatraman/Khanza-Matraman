 ...
 * @author perpustakaan
 */
public final class RMDataSkriningGiziAnak extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataSkriningGiziAnak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Skrining Gizi Anak Usia 0 Bulan - 14 Tahun ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel14.setText("1.  Apakah pasien tampak kurus ?");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(79, 100, 335, 23);

        cmbSkor1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        cmbSkor1.setBounds(600, 100, 80, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("badan tidak naik selama 3 bulan terakhir)");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(95, 170, 370, 23);

        cmbSkor2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        cmbSkor2.setBounds(600, 130, 80, 23);
        ...
        jLabel23.setText("kali/hari dalam seminggu terakhir atau asupan makanan berkurang selama 1 minggu terakhir)");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(95, 210, 500, 23);

        cmbSkor3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        cmbSkor3.setBounds(600, 190, 80, 23);

        jLabel26.setText("Skor :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(680, 190, 60, 23);
        ...
        FormInput.add(Skor3);
        Skor3.setBounds(750, 190, 44, 23);

        jLabel27.setText("Total Skor :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(10, 260, 75, 23);
        ...
        TotalSkor.setBounds(90, 260, 50, 23);
        ...
        ParameterSkor.setBounds(140, 260, 658, 23);
        ...
        jLabel29.setText("4.  Apakah terdapat penyakit atau keadaan yang mengakibatkan pasien berisiko mengalami malnutrisi?");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(80, 230, 510, 23);

        cmbSkor4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        cmbSkor4.setBounds(600, 230, 80, 23);

        jLabel30.setText("Skor :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(680, 230, 60, 23);
        ...
        FormInput.add(Skor4);
        Skor4.setBounds(750, 230, 44, 23);

        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel31.setText("2.  Apakah terdapat penurunan berat badan selama satu bulan terakhir? (berdasarkan penilaian objektif ");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(79, 130, 520, 23);

        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel32.setText("data berat badan bila ada atau penilaian subjektif orang tua pasien atau untuk bayi < 1 tahun berat");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(95, 150, 500, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("3.  Apakah terdapat salah satu dari kondisi tersebut? (Diare ≥ 5 kali/hari danMuntah > 3 ");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(80, 190, 520, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from skrining_gizi_anak where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void MnSkriningGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSkriningGiziActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirSkriningGizi.jasper","report","::[ Formulir Monitoring & Evaluasi Asuhan Gizi Pasien ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,skrining_gizi_anak.tanggal,skrining_gizi_anak.alergi,skrining_gizi_anak.skrining_bb,skrining_gizi_anak.skrining_tb, "+
                    "skrining_gizi_anak.parameter_1,skrining_gizi_anak.skor_1,skrining_gizi_anak.parameter_2,skrining_gizi_anak.skor_2, "+
                    "skrining_gizi_anak.parameter_3,skrining_gizi_anak.skor_3,skrining_gizi_anak.parameter_4,skrining_gizi_anak.skor_4,skrining_gizi_anak.skor_total,skrining_gizi_anak.parameter_total, "+
                    "skrining_gizi_anak.nip,petugas.nama "+
                    "from skrining_gizi_anak inner join reg_periksa on skrining_gizi_anak.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on skrining_gizi_anak.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' and skrining_gizi_anak.tanggal='"+tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataSkriningGiziAnak dialog = new RMDataSkriningGiziAnak(new javax.swing.JFrame(), true);
    ...
    private void isCombo1(){
        if(cmbSkor1.getSelectedItem().equals("Ya")){
            Skor1.setText("1");
        }else if(cmbSkor1.getSelectedItem().equals("Tidak")){
            Skor1.setText("0");
        }
    }
    
    private void isCombo2(){
        if(cmbSkor2.getSelectedItem().equals("Ya")){
            Skor2.setText("1");
        }else if(cmbSkor2.getSelectedItem().equals("Tidak")){
            Skor2.setText("0");
        }
    }
    ...
    private void isCombo3(){
        if(cmbSkor3.getSelectedItem().equals("Ya")){
            Skor3.setText("1");
        }else if(cmbSkor3.getSelectedItem().equals("Tidak")){
            Skor3.setText("0");
        }
    } 
    
    private void isCombo4(){
        if(cmbSkor4.getSelectedItem().equals("Ya")){
            Skor4.setText("1");
        }else if(cmbSkor4.getSelectedItem().equals("Tidak")){
            Skor4.setText("0");
        }
    } 
    ...
    private void isHitung(){
        if(TotalSkor.getText().equals("0")){
            ParameterSkor.setText("Resiko Rendah");
        }else if(TotalSkor.getText().equals("1")){
            ParameterSkor.setText("Resiko Sedang");
        }else if(TotalSkor.getText().equals("2")){
            ParameterSkor.setText("Resiko Sedang");
        }else if(TotalSkor.getText().equals("3")){
            ParameterSkor.setText("Resiko Sedang");
        }else{
            ParameterSkor.setText("Resiko Tinggi");
        }
    }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            cmbSkor4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Skor4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            TotalSkor.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());  
            ParameterSkor.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());  
            nip.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());
            namapetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
