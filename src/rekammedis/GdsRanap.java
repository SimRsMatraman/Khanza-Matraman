 ...
 * @author perpustakaan
 */
public final class GdsRanap extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public GdsRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        isMenu();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ GDS Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("gds_ranap","?,?,?,?,?,?,?","No.Rawat",7,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from gds_ranap where jam=?",1,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("gds_ranap","jam=?","no_rawat=?,tanggal=?,jam=?,nik=?,hasil=?,pemberian=?,iu=?",8,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GdsRanap dialog = new GdsRanap(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,gds_ranap.tanggal,gds_ranap.jam,gds_ranap.nik,pegawai.nama,"+
                        "gds_ranap.hasil,gds_ranap.pemberian,gds_ranap.iu from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join gds_ranap on reg_periksa.no_rawat=gds_ranap.no_rawat "+
                        "inner join pegawai on gds_ranap.nik=pegawai.nik "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "gds_ranap.tanggal between ? and ? order by gds_ranap.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,gds_ranap.tanggal,gds_ranap.jam,gds_ranap.nik,pegawai.nama,"+
                        "gds_ranap.hasil,gds_ranap.pemberian,gds_ranap.iu from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        ...
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "gds_ranap.tanggal between ? and ? and reg_periksa.no_rawat like ? or "+
                        "gds_ranap.tanggal between ? and ? and pasien.no_rkm_medis like ? or "+
                        "gds_ranap.tanggal between ? and ? and pasien.nm_pasien like ? or "+
                        "gds_ranap.tanggal between ? and ? and gds_ranap.nik like ? or "+
                        "gds_ranap.tanggal between ? and ? and pegawai.nama like ? order by gds_ranap.tanggal");
            }
...
//            }
    ...
    private void tampilPersalinan() {
        ...
        try {
            ps=koneksi.prepareStatement("select * from gds_ranap where gds_ranap.no_rawat=? order by gds_ranap.tanggal");
            try {
