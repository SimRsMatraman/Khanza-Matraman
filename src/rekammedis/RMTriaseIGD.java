...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    public RMTriaseIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Alasan Kedatangan","Keterangan","Kode Kasus","Macam Kasus","Emergency","NIP","Nama Petugas"
            }){
        ...
        styleSheet.addRule(
                ...
                ".isi6 td{font: 8.5px tahoma;border:none;height:12px;background: #ffffff;color:#CCCC00;}"+
                ".isi7 td{font: 8.5px tahoma;border:none;height:12px;background: #ffffff;color:#009900;}"+
                ".isi8 td{font: 8.5px tahoma;border:none;height:12px;background: #ffffff;color:#0066cc;}"+
    ...
    private void initComponents() {
        ...
        jLabel16.setBounds(3, 70, 90, 23);

        PrimerSaturasi.setFocusTraversalPolicyProvider(true);
        PrimerSaturasi.setName("PrimerSaturasi"); // NOI18N
        PrimerSaturasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrimerSaturasiActionPerformed(evt);
            }
        });
        PrimerSaturasi.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                PrimerSaturasiKeyTyped(evt);
            }
        });
        internalFrame7.add(PrimerSaturasi);
        PrimerSaturasi.setBounds(100, 70, 40, 23);
        ...
        PrimerRespirasi.setBounds(240, 70, 50, 23);

        jLabel27.setText("Respirasi(/menit) :");
        jLabel27.setName("jLabel27"); // NOI18N
        internalFrame7.add(jLabel27);
        jLabel27.setBounds(140, 70, 100, 23);
        ...
        jLabel35.setBounds(300, 70, 20, 23);

        PrimerBB.setHighlighter(null);
        PrimerBB.setName("PrimerBB"); // NOI18N
        PrimerBB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrimerBBActionPerformed(evt);
            }
        });
        PrimerBB.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                PrimerBBKeyTyped(evt);
            }
        });
        internalFrame7.add(PrimerBB);
        PrimerBB.setBounds(320, 70, 50, 23);
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2023 09:50:14" }));
        ...
        PrimerResusitasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrimerResusitasiActionPerformed(evt);
            }
        });
        ...
        TabSkala1dan2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        TabSkala1dan2.addTab("KUNING ( ATS 2 )", Scroll4);
        ...
        jLabel17.setBounds(10, 70, 90, 23);
        ...
        SekunderSaturasi.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                SekunderSaturasiKeyTyped(evt);
            }
        });
        internalFrame11.add(SekunderSaturasi);
        SekunderSaturasi.setBounds(110, 70, 50, 23);
        ...
        SekunderRespirasi.setBounds(280, 70, 50, 23);

        jLabel33.setText("Respirasi(/menit) :");
        jLabel33.setName("jLabel33"); // NOI18N
        internalFrame11.add(jLabel33);
        jLabel33.setBounds(170, 70, 100, 23);
        ...
        SekunderTensi.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                SekunderTensiKeyTyped(evt);
            }
        });
        internalFrame11.add(SekunderTensi);
        SekunderTensi.setBounds(390, 70, 55, 23);

        jLabel15.setText("Tensi :");
        jLabel15.setName("jLabel15"); // NOI18N
        internalFrame11.add(jLabel15);
        jLabel15.setBounds(320, 70, 59, 23);

        jLabel39.setText("BB :");
        jLabel39.setName("jLabel39"); // NOI18N
        internalFrame11.add(jLabel39);
        jLabel39.setBounds(460, 70, 20, 23);
        ...
        SekunderBB.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                SekunderBBKeyTyped(evt);
            }
        });
        internalFrame11.add(SekunderBB);
        SekunderBB.setBounds(490, 70, 50, 23);
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2023 09:50:16" }));
        ...
        SekunderZonaKuning.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SekunderZonaKuningActionPerformed(evt);
            }
        });
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(495, 102));
        ...
        label13.setForeground(new java.awt.Color(0, 153, 0));
        ...
        TabSkala3dan4dan5.setBackground(new java.awt.Color(255, 255, 255));
        ...
        TabSkala3dan4dan5.setPreferredSize(new java.awt.Dimension(700, 432));
        ...
        tbSkala3.setForeground(new java.awt.Color(0, 153, 0));
        ...
        TabSkala3dan4dan5.addTab("BIRU ( ATS 4  )", Scroll7);
        ...
        tbSkala5.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TabSkala3dan4dan5.addTab("PUTIH ( ATS 5 )", Scroll8);
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2023 09:50:16" }));
        ...
        jLabel36.setText("Emergency :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(730, 40, 70, 23);

        Emergency.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "True Emergency", "False Emergency" }));
        Emergency.setName("Emergency"); // NOI18N
        Emergency.setOpaque(false);
        Emergency.setPreferredSize(new java.awt.Dimension(55, 28));
        Emergency.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                EmergencyKeyPressed(evt);
            }
        });
        FormInput.add(Emergency);
        Emergency.setBounds(810, 40, 170, 23);

        label16.setText("Petugas :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(730, 10, 70, 23);
        ...
        KdPetugas.setBounds(810, 10, 140, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(950, 10, 210, 23);
        ...
        BtnDokter.setBounds(1160, 10, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(TabTriase.getSelectedIndex()==0){
                ...
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                ...
                }else if(PrimerBB.getText().trim().equals("")){
                    Valid.textKosong(PrimerBB,"Berat Badan");
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",16,new String[]{
                            ...
                            KeteranganKedatangan.getText(),KdKasus.getText(),PrimerTensi.getText(),PrimerNadi.getText(),PrimerRespirasi.getText(),PrimerBB.getText(),PrimerSuhu.getText(),
                            PrimerSaturasi.getText(),PrimerNyeri.getText(),Emergency.getSelectedItem().toString(),KdPetugas.getText()
                        })==true){
                ...
                if(SekunderAnamnesa.getText().trim().equals("")){
                ...
                }else if(SekunderBB.getText().trim().equals("")){
                    Valid.textKosong(SekunderBB,"Berat Badan");
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",16,new String[]{
                            TNoRw.getText(),Valid.SetTgl(TanggalKunjungan.getSelectedItem()+"")+" "+TanggalKunjungan.getSelectedItem().toString().substring(11,19),
                            CaraMasuk.getSelectedItem().toString(),Transportasi.getSelectedItem().toString(),AlasanKedatangan.getSelectedItem().toString(), 
                            KeteranganKedatangan.getText(),KdKasus.getText(),SekunderTensi.getText(),SekunderNadi.getText(),SekunderRespirasi.getText(),SekunderBB.getText(),SekunderSuhu.getText(),
                            SekunderSaturasi.getText(),SekunderNyeri.getText(),Emergency.getSelectedItem().toString(),KdPetugas.getText()
                        })==true){
            ...
            if(tbTriase.getSelectedRow()> -1){
                ...
                if(TabTriase.getSelectedIndex()==0){
                    ...
                    if(PrimerKeluhanUtama.getText().trim().equals("")){
                        ...
                        if(Sequel.mengedittf("data_triase_igd","no_rawat=?","no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,bb=?,suhu=?,saturasi_o2=?,nyeri=?,emergency=?,nip=?",17,new String[]{
                                TNoRw.getText(),Valid.SetTgl(TanggalKunjungan.getSelectedItem()+"")+" "+TanggalKunjungan.getSelectedItem().toString().substring(11,19),
                                CaraMasuk.getSelectedItem().toString(),Transportasi.getSelectedItem().toString(),AlasanKedatangan.getSelectedItem().toString(), 
                                KeteranganKedatangan.getText(),KdKasus.getText(),PrimerTensi.getText(),PrimerNadi.getText(),PrimerRespirasi.getText(),PrimerBB.getText(),PrimerSuhu.getText(),
                                PrimerSaturasi.getText(),PrimerNyeri.getText(),Emergency.getSelectedItem().toString(),KdPetugas.getText(),tbTriase.getValueAt(tbTriase.getSelectedRow(),0).toString()
                            })==true){
                            if(PrimerResusitasi.isSelected()==true){
                                keputusan="Ruang Resusitasi";
                            }else if(PrimerKritis.isSelected()==true){
                    ...
                    if(SekunderAnamnesa.getText().trim().equals("")){
                        ...
                        if(Sequel.mengedittf("data_triase_igd","no_rawat=?","no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,bb=?,suhu=?,saturasi_o2=?,nyeri=?,emergency=?,nip=?",17,new String[]{
                                ...
                                CaraMasuk.getSelectedItem().toString(),Transportasi.getSelectedItem().toString(),AlasanKedatangan.getSelectedItem().toString(), 
                                KeteranganKedatangan.getText(),KdKasus.getText(),SekunderTensi.getText(),SekunderNadi.getText(),SekunderRespirasi.getText(),SekunderBB.getText(),SekunderSuhu.getText(),
                                SekunderSaturasi.getText(),SekunderNyeri.getText(),Emergency.getSelectedItem().toString(),KdPetugas.getText(),tbTriase.getValueAt(tbTriase.getSelectedRow(),0).toString()
                            })==true){
                            if(SekunderZonaKuning.isSelected()==true){
                                keputusan="Zona Kuning";
                            }else if(SekunderZonaHijau.isSelected()==true){
                    ...
                    try {
                        ...
                        for(i=0;i<tabMode.getRowCount();i++){  
                            ...
                            ps=koneksi.prepareStatement(
                                ...
                                "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.bb,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
...
//                                SekunderKodePetugas.setText(Sequel.cariIsi("select kd_dokter from reg_periksa where no_rawat=?",TNoRw.getText()));
//                                Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",SekunderNamaPetugas,SekunderKodePetugas.getText());
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
    ...
    private void btnPrimerPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPrimerPetugasKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            btnPrimerPetugasActionPerformed(null);
        }else{            
            Valid.pindah(evt,TNoRw,btnPrimerPetugas);
        }
    ...
    private void TabSkala3dan4dan5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabSkala3dan4dan5MouseClicked
        if(TabSkala3dan4dan5.getSelectedIndex()==0){
            label13.setForeground(new Color(0,153,0));
            TCariSkala3.setForeground(new Color(0,153,0));
            BtnTambahSkala2.setEnabled(akses.getmaster_triase_skala3());
            SekunderZonaKuning.setSelected(true);
        }else if(TabSkala3dan4dan5.getSelectedIndex()==1){
            label13.setForeground(new Color(30, 144, 255));
            TCariSkala3.setForeground(new Color(30, 144, 255));
...
//        Valid.pindah(evt,SekunderTanggalTriase,BtnSimpan);
       if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            btnSekunderPetugasActionPerformed(null);
        }else{            
            Valid.pindah(evt,TNoRw,btnSekunderPetugas);
        }
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(TNoRM1.getText().trim().equals("")||TPasien1.getText().trim().equals("")){
            ...
            if(tbTriase.getSelectedRow()> -1){
                ...
                }else if(LoadHTML.getText().contains("#CCCC00")){
                    Map<String, Object> param = new HashMap<>(); 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
                ...
                }else if(LoadHTML.getText().contains("#009900")){
                    Map<String, Object> param = new HashMap<>(); 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
                ...
                }else if(LoadHTML.getText().contains("#0066cc")){
                    Map<String, Object> param = new HashMap<>(); 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
    ...
    private void EmergencyKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EmergencyKeyPressed
        Valid.pindah(evt,KdKasus,KeteranganKedatangan);
    }//GEN-LAST:event_EmergencyKeyPressed
    ...
    private void PrimerTensiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerTensiKeyTyped
    ...
    }//GEN-LAST:event_PrimerTensiKeyTyped

    private void PrimerSuhuKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerSuhuKeyTyped
        char kata= evt.getKeyChar();
    ...
    }//GEN-LAST:event_PrimerSuhuKeyTyped

    private void PrimerSaturasiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerSaturasiKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9')  || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka ");
        }
    }//GEN-LAST:event_PrimerSaturasiKeyTyped

    private void SekunderTensiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderTensiKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9') || (kata==KeyEvent.VK_SLASH)  || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka dan Garis Miring");
        }
    }//GEN-LAST:event_SekunderTensiKeyTyped

    private void SekunderSuhuKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderSuhuKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9') || (kata== KeyEvent.VK_PERIOD) || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka dan Titik");
        }
    }//GEN-LAST:event_SekunderSuhuKeyTyped

    private void SekunderSaturasiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderSaturasiKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9')  || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka ");
        }
    }//GEN-LAST:event_SekunderSaturasiKeyTyped
    ...
    private void SekunderZonaKuningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SekunderZonaKuningActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SekunderZonaKuningActionPerformed

    private void PrimerResusitasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrimerResusitasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PrimerResusitasiActionPerformed
    ...
    private void PrimerSaturasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrimerSaturasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PrimerSaturasiActionPerformed

    private void PrimerBBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrimerBBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PrimerBBActionPerformed
    ...
    private void PrimerBBKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerBBKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9') || (kata== KeyEvent.VK_PERIOD) || (kata== KeyEvent.VK_COMMA) || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka dan Titik");
        }
    }//GEN-LAST:event_PrimerBBKeyTyped

    private void SekunderBBKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderBBKeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9') || (kata== KeyEvent.VK_PERIOD) || (kata== KeyEvent.VK_COMMA) || (kata== KeyEvent.VK_BACK_SPACE))){
            evt.consume();
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka dan Titik");
        }
    }//GEN-LAST:event_SekunderBBKeyTyped
    ...
    */
    ...
    private widget.ComboBox Emergency;
    ...
    public void tampil() {        
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,data_triase_igd.tgl_kunjungan,"+
                    "data_triase_igd.cara_masuk,data_triase_igd.alat_transportasi,data_triase_igd.alasan_kedatangan,"+
                    "data_triase_igd.keterangan_kedatangan,data_triase_igd.kode_kasus,master_triase_macam_kasus.macam_kasus,data_triase_igd.emergency,data_triase_igd.nip,petugas.nama "+
                    "from reg_periksa inner join pasien inner join data_triase_igd inner join master_triase_macam_kasus "+
                    "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on data_triase_igd.nip=petugas.nip and reg_periksa.no_rawat=data_triase_igd.no_rawat "+
                    "and data_triase_igd.kode_kasus=master_triase_macam_kasus.kode_kasus "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("keterangan_kedatangan"),rs.getString("kode_kasus"),rs.getString("macam_kasus"),rs.getString("emergency"),
    ...
    private void emptTeks(){
        ...
        PrimerSuhu.setText("0");
        PrimerNyeri.setText("0");
        PrimerTensi.setText("0");
        PrimerNadi.setText("0");
        PrimerSaturasi.setText("0");
        PrimerRespirasi.setText("0");
        PrimerBB.setText("0");
        PrimerKubutuhanKusus.setSelectedIndex(0);
        PrimerCatatan.setText("-");
        PrimerTanggalTriase.setDate(new Date());
        SekunderAnamnesa.setText("-");
        SekunderSuhu.setText("0");
        SekunderNyeri.setText("0");
        SekunderSaturasi.setText("0");
        SekunderRespirasi.setText("0");
        SekunderBB.setText("0");
        SekunderTensi.setText("0");
        SekunderNadi.setText("0");
...
//        KdPetugas.setText("");
    ...
    public void setNoRm(String norwt,String norm,String namapasien) {
        ...
        PrimerKodePetugas.setText(Sequel.cariIsi("select kd_dokter from reg_periksa where no_rawat=?",norwt));
        SekunderKodePetugas.setText(Sequel.cariIsi("select kd_dokter from reg_periksa where no_rawat=?",norwt));
        Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",PrimerNamaPetugas,PrimerKodePetugas.getText());
        Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",SekunderNamaPetugas,SekunderKodePetugas.getText());
        TCari.setText(norwt);   
    }
...
//            Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",SekunderNamaPetugas,SekunderKodePetugas.getText());
//            Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?", PrimerNamaPetugas,PrimerKodePetugas.getText());           
            SekunderNamaPetugas.setText(SekunderNamaPetugas.getText());
        } 
        if(akses.getjml2()>=1){
            KdPetugas.setEditable(false);
                    ...
                    if(rs.next()){
                        ...
                        htmlContent.append(    
                            ...
                            "<tr class='isi'>"+
                                ...
                                "<td valign='middle'>Suhu (C) : "+rs.getString("suhu")+", Nyeri : "+rs.getString("nyeri")+", Tensi : "+rs.getString("tekanan_darah")+", Nadi(/menit) : "+rs.getString("nadi")+", Saturasi O²(%) : "+rs.getString("saturasi_o2")+", Respirasi(/menit) : "+rs.getString("pernapasan")+", Berat Badan : "+rs.getString("bb")+"</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#AA0000' color='ffffff' align='center'>Resusitasi (Segera)</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Pemeriksaan</td>"+
                                        "<td valign='middle' bgcolor='#CCCC00' color='ffffff' align='center'>Emergensi (10 menit)</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
                                        "<tr class='isi'>"+
                                            "<td valign='middle'>"+rs2.getString("nama_pemeriksaan")+"</td>"+
                                            "<td valign='middle' bgcolor='#CCCC00' color='ffffff'>"+
                                                "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0'>"
                                    );
                                    ps3=koneksi.prepareStatement(
                                            "select master_triase_skala2.pengkajian_skala2 from master_triase_skala2 inner join data_triase_igddetail_skala2 "+
                                    ...
                                    try {
                                        ...
                                        while(rs3.next()){
                                            htmlContent.append(                             
                                                "<tr class='isi'>"+
                                                    "<td border='0' valign='middle' bgcolor='#CCCC00' color='ffffff' width='100%'>"+rs3.getString("pengkajian_skala2")+"</td>"+
                                                "</tr>"
                                            );
                                        }
                                    } catch (Exception e) {
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Pemeriksaan</td>"+
                                        "<td valign='middle' bgcolor='#009900' color='ffffff' align='center'>Urgent (30 menit)</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
                                        "<tr class='isi'>"+
                                            "<td valign='middle'>"+rs2.getString("nama_pemeriksaan")+"</td>"+
                                            "<td valign='middle' bgcolor='#009900' color='ffffff'>"+
                                                "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0'>"
                                    );
                                    ps3=koneksi.prepareStatement(
                                            "select master_triase_skala3.pengkajian_skala3 from master_triase_skala3 inner join data_triase_igddetail_skala3 "+
                                    ...
                                    try {
                                        ...
                                        while(rs3.next()){
                                            htmlContent.append(                             
                                                "<tr class='isi'>"+
                                                    "<td border='0' valign='middle' bgcolor='#009900' color='ffffff' width='100%'>"+rs3.getString("pengkajian_skala3")+"</td>"+
                                                "</tr>"
                                            );
                                        }
                                    } catch (Exception e) {
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Pemeriksaan</td>"+
                                        "<td valign='middle' bgcolor='#0066cc' color='ffffff' align='center'>Non Urgent (60 menit)</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
                                        "<tr class='isi'>"+
                                            "<td valign='middle'>"+rs2.getString("nama_pemeriksaan")+"</td>"+
                                            "<td valign='middle' bgcolor='#0066cc' color='ffffff'>"+
                                                "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0'>"
                                    );
                                    ps3=koneksi.prepareStatement(
                                            "select master_triase_skala4.pengkajian_skala4 from master_triase_skala4 inner join data_triase_igddetail_skala4 "+
                                    ...
                                    try {
                                        ...
                                        while(rs3.next()){
                                            htmlContent.append(                             
                                                "<tr class='isi'>"+
                                                    "<td border='0' valign='middle' bgcolor='#0066cc' color='ffffff' width='100%'>"+rs3.getString("pengkajian_skala4")+"</td>"+
                                                "</tr>"
                                            );
                                        }
                                    } catch (Exception e) {
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Pemeriksaan</td>"+
                                        "<td valign='middle' bgcolor='#969696' color='ffffff' align='center'>Tidak Segera (120 Menit)</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
