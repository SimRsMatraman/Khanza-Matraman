 ...
 * @author dosen
 */
public final class DlgMasterBedah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterBedah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode","Tindakan Bedah","Laporan Bedah"};
...
//        NmP.setDocument(new batasInput((byte)30).getKata(NmP));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Template Bedah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(KdP.getText().trim().equals("")){
            ...
            Valid.textKosong(NmP,"Tindakan");
        }else if(TKeluhan.getText().trim().equals("")){
            Valid.textKosong(TKeluhan,"Laporan");
        }else{
            Sequel.menyimpan("master_b","'"+KdP.getText()+"','"+NmP.getText()+"','"+TKeluhan.getText()+"'","Kode");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("master_b","kd_p",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
...
//            Valid.editTable(tabMode,"penjab","kd_pj",Kd2,"png_jawab='"+NmS.getText()+"',kd_pj='"+KdS.getText()+"',nama_perusahaan='"+Perusahaan.getText()+"',alamat_asuransi='"+AlamatAsuransi.getText()+"',no_telp='"+NoTelp.getText()+"',attn='"+Attn.getText()+"'");
            Valid.editTable(tabMode,"master_b","kd_p",Kd2,"judul_p='"+NmP.getText()+"',kd_p='"+KdP.getText()+"',isi_p='"+TKeluhan.getText()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterBedah dialog = new DlgMasterBedah(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "from master_b where  kd_p like ? or judul_p like ? order by isi_p ");
            try{
    ...
    public void emptTeks() {
        ...
        TKeluhan.setText("");
        KdP.requestFocus();        
        Valid.autoNomer("master_b","P",5,KdP);
    }
