...
//        isMenu();
    ...
    private void initComponents() {
        ...
        jLabel239.setBounds(243, 260, 10, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("ews_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",39,new String[]{
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "ews_ranap.keluar1,ews_ranap.keluar2,ews_ranap.keluar3,ews_ranap.keluar4,ews_ranap.keluar5,ews_ranap.jumlahkeluar,ews_ranap.bc,ews_ranap.diastol "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
