...
//        SNCN.setDocument(new batasInput((byte)25).getKata(SNCN));
    ...
    private void initComponents() {
        ...
        TPasien.setBounds(336, 10, 430, 23);
        ...
        btnPetugasRuangan.setBounds(380, 360, 28, 23);
        ...
        jLabel20.setBounds(20, 130, 660, 23);
        ...
        JumlahDrain.setBounds(360, 210, 40, 23);
        ...
        NamaDokterAnestesi.setBounds(590, 100, 175, 23);
        ...
        KodeDokterAnestesi.setBounds(490, 100, 97, 23);
        ...
        KeadaanUmum.setBounds(150, 150, 110, 23);

        jLabel52.setText(":");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(0, 150, 140, 23);
        ...
        FormInput.add(Drain);
        Drain.setBounds(150, 210, 110, 23);
        ...
        jLabel57.setBounds(60, 240, 210, 23);

        jLabel59.setText("Radiologi :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(70, 260, 74, 23);
        ...
        Radiologi.setBounds(150, 260, 100, 23);
        ...
        KeteranganRadiologi.setBounds(250, 260, 75, 23);

        jLabel60.setText("EKG :");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(330, 260, 55, 23);
        ...
        KeteranganEKG.setBounds(490, 260, 75, 23);
        ...
        FormInput.add(EKG);
        EKG.setBounds(390, 260, 100, 23);

        jLabel61.setText("CT Scan :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(330, 290, 55, 23);
        ...
        CTScan.setBounds(390, 290, 100, 23);
        ...
        KeteranganCTScan.setBounds(490, 290, 75, 23);

        jLabel62.setText("USG :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(70, 290, 74, 23);
        ...
        KeteranganUSG.setBounds(250, 290, 75, 23);

        jLabel63.setText("MRI :");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(570, 260, 40, 23);
        ...
        KeteranganMRI.setBounds(720, 260, 75, 23);

        jLabel26.setText("Petugas OK :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(430, 360, 70, 23);
        ...
        btnPetugasOK.setBounds(760, 360, 28, 23);
        ...
        jLabel65.setBounds(0, 210, 140, 23);
        ...
        jSeparator4.setBounds(0, 350, 810, 1);

        jLabel27.setText(":");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(10, 360, 110, 23);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel28.setText("Area Luka Operasi");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(60, 320, 100, 23);
        ...
        AreaLukaOperasi.setBounds(160, 320, 633, 23);
        ...
        KateterUrine.setBounds(150, 180, 110, 23);

        jLabel53.setText("Kateter Urine :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(0, 180, 140, 23);
        ...
        WarnaUrine.setBounds(590, 180, 83, 23);

        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel29.setText("buah, ");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(400, 210, 40, 23);
        ...
        LetakDrain.setBounds(470, 210, 112, 23);
        ...
        CairanInfus.setBounds(370, 150, 150, 23);

        jLabel64.setText("Jaringan/Organ Tubuh PA/VC :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(530, 150, 160, 23);
        ...
        JaringanPA.setBounds(690, 150, 100, 23);

        jLabel36.setText(":");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 320, 152, 23);
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("checklist_post_operasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",30,new String[]{
                ...
                tabMode.addRow(new String[]{
                    ...
                    KodePerawatSNCN.getText(),NamaPerawatSNCN.getText(),Tindakan.getText(),KodeDokterBedah.getText(),NamaDokterBedah.getText(),KodeDokterAnestesi.getText(),NamaDokterAnestesi.getText(),KeadaanUmum.getSelectedItem().toString(),
        ...
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString())||akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString())){
                    ...
                    JOptionPane.showMessageDialog(null,"Harus salah satu petugas anastesi atau petugas OK yang dapat menghapus sesuai user login..!!");
                }
            }
        }else{
...
//        SNCN.requestFocus();
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Radiologi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            KeteranganRadiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            ...
            CTScan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
            KeteranganCTScan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            MRI.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            KeteranganMRI.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
            CairanInfus.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            KateterUrine.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            if(!tbObat.getValueAt(tbObat.getSelectedRow(),26).toString().equals("")){
                Valid.SetTgl2(Tanggal,tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            WarnaUrine.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            JumlahUrine.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            AreaLukaOperasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            Drain.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            JumlahDrain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            LetakDrain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            WarnaDrain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
            JaringanPA.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
            KdPetugasOK.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
            NmPetugasOK.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            KdPetugasAnest.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());
            NmPetugasAnest.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("checklist_post_operasi","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,nip_perawat_sncn=?,tindakan=?,kd_dokter_bedah=?,kd_dokter_anestesi=?,keadaan_umum=?,"+
            ...
            tbObat.setValueAt(KodePerawatSNCN.getText(),tbObat.getSelectedRow(),6);
            tbObat.setValueAt(NamaPerawatSNCN.getText(),tbObat.getSelectedRow(),7);
            ...
            tbObat.setValueAt(Radiologi.getSelectedItem().toString(),tbObat.getSelectedRow(),14);
            tbObat.setValueAt(KeteranganRadiologi.getText(),tbObat.getSelectedRow(),15);
            tbObat.setValueAt(EKG.getSelectedItem().toString(),tbObat.getSelectedRow(),16);
            tbObat.setValueAt(KeteranganEKG.getText(),tbObat.getSelectedRow(),17);
            tbObat.setValueAt(USG.getSelectedItem().toString(),tbObat.getSelectedRow(),18);
            tbObat.setValueAt(KeteranganUSG.getText(),tbObat.getSelectedRow(),19);
            tbObat.setValueAt(CTScan.getSelectedItem().toString(),tbObat.getSelectedRow(),20);
            tbObat.setValueAt(KeteranganCTScan.getText(),tbObat.getSelectedRow(),21);
            tbObat.setValueAt(MRI.getSelectedItem().toString(),tbObat.getSelectedRow(),22);
            tbObat.setValueAt(KeteranganMRI.getText(),tbObat.getSelectedRow(),23);
            tbObat.setValueAt(CairanInfus.getText(),tbObat.getSelectedRow(),24);
            tbObat.setValueAt(KateterUrine.getSelectedItem().toString(),tbObat.getSelectedRow(),25);
            tbObat.setValueAt((KateterUrine.getSelectedIndex()==0?Valid.SetTgl(TanggalKateter.getSelectedItem()+"")+" "+TanggalKateter.getSelectedItem().toString().substring(11,19):""),tbObat.getSelectedRow(),26);
            tbObat.setValueAt(WarnaUrine.getSelectedItem().toString(),tbObat.getSelectedRow(),27);
            tbObat.setValueAt(JumlahUrine.getText(),tbObat.getSelectedRow(),28);
            tbObat.setValueAt(AreaLukaOperasi.getText(),tbObat.getSelectedRow(),29);
            tbObat.setValueAt(Drain.getSelectedItem().toString(),tbObat.getSelectedRow(),30);
            tbObat.setValueAt(JumlahDrain.getText(),tbObat.getSelectedRow(),31);
            tbObat.setValueAt(LetakDrain.getText(),tbObat.getSelectedRow(),32);
            tbObat.setValueAt(WarnaDrain.getText(),tbObat.getSelectedRow(),33);
            tbObat.setValueAt(JaringanPA.getSelectedItem().toString(),tbObat.getSelectedRow(),34);
            tbObat.setValueAt(KdPetugasOK.getText(),tbObat.getSelectedRow(),35);
            tbObat.setValueAt(NmPetugasOK.getText(),tbObat.getSelectedRow(),36);
            tbObat.setValueAt(KdPetugasAnest.getText(),tbObat.getSelectedRow(),37);
            tbObat.setValueAt(NmPetugasAnest.getText(),tbObat.getSelectedRow(),38);
            emptTeks();
        }
    }
