...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private RMCariPemeriksaanFisikAssMedis caripemeriksaanfisikass=new RMCariPemeriksaanFisikAssMedis(null,false);
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        caripemeriksaanfisikass.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaanfisikass.getTable().getSelectedRow()!= -1){
                    JalannyaPenyakit.append(caripemeriksaanfisikass.getTable().getValueAt(caripemeriksaanfisikass.getTable().getSelectedRow(),2).toString()+", ");
                    JalannyaPenyakit.requestFocus();
                }
            }
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Resume Medis Pasien IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setBounds(140, 150, 70, 23);
        ...
        scrollPane4.setBounds(244, 184, 540, 50);
        ...
        BtnDokter1.setBounds(100, 95, 28, 23);
        ...
        BtnDokter5.setBounds(100, 150, 28, 23);
        ...
        BtnDokter16.setBounds(212, 96, 28, 23);
        ...
        jLabel15.setBounds(40, 150, 60, 23);
        ...
        BtnDokter17.setBounds(210, 150, 28, 23);

        jLabel16.setText("SOAP :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(40, 95, 60, 23);

        jLabel17.setText("ASS MEDIS :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(140, 95, 70, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",29,new String[]{
                    ...
                    KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),Kondisi.getSelectedItem().toString(),Obat2an.getText(),Kondisi1.getSelectedItem().toString(),Kondisi2.getText().toString(),Tindakan.getText(),
                })==true){
                    tampil();
                    emptTeks();
            }
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataResumePasien.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "resume_pasien.obat_pulang,resume_pasien.tindak_lanjut,resume_pasien.asal_pasien,resume_pasien.tindakan from resume_pasien inner join reg_periksa on resume_pasien.no_rawat=reg_periksa.no_rawat  "+
    ...
    private void BtnDokter17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter17ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            caripemeriksaanfisikass.setNoRawat(TNoRw.getText());
            caripemeriksaanfisikass.tampil();
            caripemeriksaanfisikass.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            caripemeriksaanfisikass.setLocationRelativeTo(internalFrame1);
            caripemeriksaanfisikass.setVisible(true);
        }
...
//      Menampilkan Subjek dan Object dari CPPT
        try {
            ps=koneksi.prepareStatement(
                    "SELECT a.no_rawat,a.no_rkm_medis,IFNULL(rps,'')as rps,IFNULL(keluhan,'')as keluhan,IFNULL(pemeriksaan,'')as pemeriksaan,IFNULL(ket_fisik,'')as ket_fisik,IFNULL(tata,'')as tata FROM reg_periksa a "
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(Tindakan.getText().isEmpty()){
                        Tindakan.setText(rs.getString("tata")+", ");
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
