 ...
 * @author dosen
 */
public final class RMCariJumlahObatDosis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariJumlahObatDosis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Obat Diberikan","Dosis"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariJumlahObatDosis dialog = new RMCariJumlahObatDosis(new javax.swing.JFrame(), true);
