 ...
 * @author perpustakaan
 */
public final class RMDataResumePasienRajal extends javax.swing.JDialog {
    ...
    private String namaPenyakit="",Listpenyakit="";
    
    /** Creates new form DlgRujuk
     * @param parent
     * @param modal */
    public RMDataResumePasienRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tgl.Rawat","Status","No.Rawat","No.RM","Nama Pasien","Kode Dokter","Dokter Penanggung Jawab","Pulang","S (SUBJECTIVE) / Anamnesa",
            "O (OBJECTIVE) / Pemeriksaan Fisik","Pemeriksaan penunjang yang positif","Hasil laboratorium yang positif","Diagnosa Utama","ICD10 Utama","Diagnosa Sekunder 1",
            "ICD10 Sek 1","Diagnosa Sekunder 2","ICD10 Sek 2","Diagnosa Sekunder 3","ICD10 Sek 3","Diagnosa Sekunder 4","ICD10 Sek 4","Prosedur 1","ICD9 1",
            "Prosedur 2","ICD9 2","Prosedur 3","ICD9 3","Prosedur 4","ICD9 4","Obat-obatan waktu pulang/nasihat","Rencana Tindak Lanjut","Asal Pasien","Tindakan Yang Dilakukan",
            "Tanggal Kontrol","Kontrol Di"
        }){
        ...
        Di.setDocument(new batasInput((int)100).getKata(Di));
    ...
    private void initComponents() {
        ...
        Kondisi2 = new widget.TextBox();
        jLabel37 = new widget.Label();
        Kondisi = new widget.ComboBox();
        jLabel36 = new widget.Label();
        Kondisi1 = new widget.ComboBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Resume Medis Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel11.setBounds(0, 660, 240, 23);
        ...
        scrollPane6.setBounds(240, 660, 541, 50);
        ...
        BtnDokter4.setBounds(210, 680, 28, 23);

        jLabel12.setText("Asal Pasien :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(570, 40, 70, 23);

        Kondisi2.setEditable(false);
        Kondisi2.setHighlighter(null);
        Kondisi2.setName("Kondisi2"); // NOI18N
        Kondisi2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Kondisi2ActionPerformed(evt);
            }
        });
        Kondisi2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Kondisi2KeyPressed(evt);
            }
        });
        FormInput.add(Kondisi2);
        Kondisi2.setBounds(650, 40, 130, 24);

        jLabel37.setText("Keadaan Saat Pulang :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(90, 720, 140, 23);

        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Hidup", "Meninggal", "Sembuh", "Atas Permintaan Sendiri", "Rujuk" }));
        ...
        Kondisi.setBounds(240, 720, 140, 23);

        jLabel36.setText("Rencana Tindak Lanjut :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(90, 750, 143, 23);

        Kondisi1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya Kontrol", "Tidak" }));
        Kondisi1.setName("Kondisi1"); // NOI18N
        Kondisi1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Kondisi1ActionPerformed(evt);
            }
        });
        Kondisi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Kondisi1KeyPressed(evt);
            }
        });
        FormInput.add(Kondisi1);
        Kondisi1.setBounds(240, 750, 80, 23);
        ...
        BtnDokter6.setBounds(790, 320, 28, 23);
        ...
        BtnDokter7.setBounds(790, 350, 28, 23);
        ...
        BtnDokter8.setBounds(790, 380, 28, 23);
        ...
        BtnDokter9.setBounds(790, 410, 28, 23);
        ...
        BtnDokter10.setBounds(790, 440, 28, 23);
        ...
        BtnDokter11.setBounds(790, 470, 28, 23);
        ...
        BtnDokter12.setBounds(790, 500, 28, 23);
        ...
        BtnDokter13.setBounds(790, 530, 28, 23);
        ...
        BtnDokter14.setBounds(790, 560, 28, 23);

        jLabel13.setText("Tindakan Yang Dilakukan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 600, 240, 23);
        ...
        BtnDokter15.setBounds(210, 620, 28, 23);
        ...
        scrollPane7.setBounds(240, 600, 541, 50);

        jLabel14.setText("S (SUBJECTIVE) / Anamnesa :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 70, 240, 23);

        jLabel15.setText("SOAP :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(150, 150, 60, 23);

        jLabel16.setText("SOAP :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(150, 90, 60, 23);

        jLabel18.setText("Tgl. Kontrol :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(330, 750, 70, 23);

        Tgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-02-2024" }));
        ...
        FormInput.add(Tgl);
        Tgl.setBounds(410, 750, 90, 23);

        jLabel20.setText("Di :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(500, 750, 30, 23);

        Di.setHighlighter(null);
        Di.setName("Di"); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_rajal","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",31,new String[]{
                    ...
                    Kondisi1.getSelectedItem().toString(),Kondisi2.getText().toString(),Tindakan.getText(),Valid.SetTgl(Tgl.getSelectedItem()+""),Di.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from resume_pasien_rajal where no_rawat=?",1,new String[]{
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataResumePasien.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "resume_pasien_rajal.kd_dokter,dokter.nm_dokter,resume_pasien_rajal.kondisi_pulang,resume_pasien_rajal.keluhan_utama,resume_pasien_rajal.jalannya_penyakit, "+
                        "resume_pasien_rajal.pemeriksaan_penunjang,resume_pasien_rajal.hasil_laborat,resume_pasien_rajal.diagnosa_utama,resume_pasien_rajal.kd_diagnosa_utama, "+
                        "resume_pasien_rajal.diagnosa_sekunder,resume_pasien_rajal.kd_diagnosa_sekunder,resume_pasien_rajal.diagnosa_sekunder2,resume_pasien_rajal.kd_diagnosa_sekunder2, "+
                        "resume_pasien_rajal.diagnosa_sekunder3,resume_pasien_rajal.kd_diagnosa_sekunder3,resume_pasien_rajal.diagnosa_sekunder4,resume_pasien_rajal.kd_diagnosa_sekunder4, "+
                        "resume_pasien_rajal.prosedur_utama,resume_pasien_rajal.kd_prosedur_utama,resume_pasien_rajal.prosedur_sekunder,resume_pasien_rajal.kd_prosedur_sekunder, "+
                        "resume_pasien_rajal.prosedur_sekunder2,resume_pasien_rajal.kd_prosedur_sekunder2,resume_pasien_rajal.prosedur_sekunder3,resume_pasien_rajal.kd_prosedur_sekunder3, "+
                        "resume_pasien_rajal.obat_pulang,resume_pasien_rajal.tindak_lanjut,resume_pasien_rajal.asal_pasien,resume_pasien_rajal.tindakan,resume_pasien_rajal.tanggal,resume_pasien_rajal.di from resume_pasien_rajal inner join reg_periksa on resume_pasien_rajal.no_rawat=reg_periksa.no_rawat  "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien_rajal.kd_dokter=dokter.kd_dokter "+
                    ...
                    Valid.MyReportqry("rptDataResumePasien.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                        ...
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.kondisi_pulang like '%"+TCari.getText().trim()+"%' or "+
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.kd_diagnosa_utama like '%"+TCari.getText().trim()+"%' or "+
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.diagnosa_utama like '%"+TCari.getText().trim()+"%' or "+
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.prosedur_utama like '%"+TCari.getText().trim()+"%' or "+
                        ...
                        "reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and resume_pasien_rajal.kd_prosedur_utama like '%"+TCari.getText().trim()+"%' "+
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptLaporanResumeRajal.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    ...
    private void BtnDokter2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            rmcariradralan.setNoRawat(TNoRM.getText());
    ...
    private void BtnDokter3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter3ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            rmcarilabralan.setNoRawat(TNoRM.getText());
    ...
    private void Kondisi1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Kondisi1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kondisi1ActionPerformed

    private void Kondisi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Kondisi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kondisi1KeyPressed
    ...
    private void MnDigitalTTEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDigitalTTEActionPerformed
        if(tbObat.getSelectedRow()>-1){
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        FileName="resume_pasien_rawat_jalan-"+tbObat.getValueAt(tbObat.getSelectedRow(),2).toString().replaceAll("/","")+".pdf";
    ...
    private void DiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiKeyPressed

    }//GEN-LAST:event_DiKeyPressed

    private void Kondisi2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Kondisi2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kondisi2KeyPressed

    private void Kondisi2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Kondisi2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kondisi2ActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataResumePasienRajal dialog = new RMDataResumePasienRajal(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox Kondisi1;
    private widget.TextBox Kondisi2;
        ...
        try{
            if(TCari.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.kd_dokter like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and dokter.nm_dokter like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.kondisi_pulang like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.kd_diagnosa_utama like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.diagnosa_utama like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.prosedur_utama like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_rawat like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and resume_pasien_rajal.kd_prosedur_utama like ? "+
...
//                    ps.setString(36,"%"+TCari.getText()+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("obat_pulang"),rs.getString("tindak_lanjut"),rs.getString("asal_pasien"),rs.getString("tindakan"),
                        rs.getString("tanggal"),rs.getString("di")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Kondisi1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Kondisi2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
            Valid.SetTgl(Tgl,tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
            Di.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
        }
    }
...
//      Menampilkan Asal Pasien
        try {
            ps=koneksi.prepareStatement(
                    "SELECT a.no_rawat,a.no_rkm_medis,IF(bridging_sep.no_sep !='','Rujukan','Non Rujukan') as sep "
                            + "FROM reg_periksa a LEFT JOIN bridging_sep ON bridging_sep.no_rawat = a.no_rawat "
                            + "WHERE a.no_rawat=?");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    if(Kondisi2.getText().isEmpty()){
                        Kondisi2.setText(rs.getString("sep"));
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
...
//        try {
//            ps=koneksi.prepareStatement(
//                    "SELECT a.no_rawat,a.no_rkm_medis,nm_perawatan,hasil FROM reg_periksa a "
...
//        }
    ...
    Map<String, Object> param = new HashMap<>();    
            ...
            Valid.MyReportPDFWithName("rptLaporanResumeRajal.jasper","report","tempfile",FileName,"::[ Laporan Resume Pasien ]::",param);
}
