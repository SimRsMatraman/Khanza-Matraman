 ...
 * @author perpustakaan
 */
public final class AsesmenAwalMedisRanapAnak extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public AsesmenAwalMedisRanapAnak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Jantung","Paru","Abdomen","Genital&Anus","Ekstremitas","Kulit","Ket.Pemeriksaan Fisik","Ket.Status Lokalis","Hasil Laboratorium","Hasil Radiologi",
            "Hasil Penunjang Lainnya","Diagnosis/Asesmen","Tatalaksana","Edukasi"
        }){
...
//        isMenu();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Asesmen Awal Medis Rawat Inap Anak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        PanelWall.setBounds(20, 840, 860, 340);
        ...
        scrollPane8.setBounds(30, 1230, 850, 160);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("Keterangan :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(30, 1210, 120, 23);
        ...
        jSeparator14.setBounds(0, 1405, 880, 1);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("III. STATUS LOKALIS");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(30, 810, 180, 23);
        ...
        scrollPane9.setBounds(30, 1460, 250, 100);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("Laboratorium :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(30, 1440, 120, 23);
        ...
        scrollPane10.setBounds(300, 1460, 250, 100);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(300, 1440, 120, 23);
        ...
        scrollPane11.setBounds(570, 1460, 250, 100);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("Penunjang Lainnya :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(570, 1440, 120, 23);
        ...
        jLabel101.setBounds(30, 1415, 190, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asesmen_medis_ranap_anak","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from asesmen_medis_ranap_anak where no_rawat=?",1,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AsesmenAwalMedisRanapAnak dialog = new AsesmenAwalMedisRanapAnak(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,asesmen_medis_ranap_anak.tanggal,"+
                        "asesmen_medis_ranap_anak.jam,asesmen_medis_ranap_anak.kd_dokter,asesmen_medis_ranap_anak.anamnesis,asesmen_medis_ranap_anak.hubungan,asesmen_medis_ranap_anak.keluhan_utama,asesmen_medis_ranap_anak.rps,asesmen_medis_ranap_anak.rpk,asesmen_medis_ranap_anak.rpd,asesmen_medis_ranap_anak.rpo,asesmen_medis_ranap_anak.alergi,"+
                        "asesmen_medis_ranap_anak.keadaan,asesmen_medis_ranap_anak.gcs,asesmen_medis_ranap_anak.kesadaran,asesmen_medis_ranap_anak.td,asesmen_medis_ranap_anak.nadi,asesmen_medis_ranap_anak.rr,asesmen_medis_ranap_anak.suhu,asesmen_medis_ranap_anak.spo,"+
                        "asesmen_medis_ranap_anak.bb,asesmen_medis_ranap_anak.tb,asesmen_medis_ranap_anak.kepala,asesmen_medis_ranap_anak.mata,asesmen_medis_ranap_anak.gigi,asesmen_medis_ranap_anak.tht,asesmen_medis_ranap_anak.thoraks,"+
                        "asesmen_medis_ranap_anak.jantung,asesmen_medis_ranap_anak.paru,asesmen_medis_ranap_anak.abdomen,asesmen_medis_ranap_anak.ekstremitas,asesmen_medis_ranap_anak.genital,asesmen_medis_ranap_anak.kulit,"+
                        "asesmen_medis_ranap_anak.ket_fisik,asesmen_medis_ranap_anak.ket_lokalis,asesmen_medis_ranap_anak.lab,asesmen_medis_ranap_anak.rad,asesmen_medis_ranap_anak.penunjang,asesmen_medis_ranap_anak.diagnosis,"+
                        "asesmen_medis_ranap_anak.tata,asesmen_medis_ranap_anak.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join asesmen_medis_ranap_anak on reg_periksa.no_rawat=asesmen_medis_ranap_anak.no_rawat "+
                        "inner join dokter on asesmen_medis_ranap_anak.kd_dokter=dokter.kd_dokter "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? order by asesmen_medis_ranap_anak.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,asesmen_medis_ranap_anak.tanggal,"+
                        "asesmen_medis_ranap_anak.jam,asesmen_medis_ranap_anak.kd_dokter,asesmen_medis_ranap_anak.anamnesis,asesmen_medis_ranap_anak.hubungan,asesmen_medis_ranap_anak.keluhan_utama,asesmen_medis_ranap_anak.rps,asesmen_medis_ranap_anak.rpk,asesmen_medis_ranap_anak.rpd,asesmen_medis_ranap_anak.rpo,asesmen_medis_ranap_anak.alergi,"+
                        ...
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? and reg_periksa.no_rawat like ? or "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? and pasien.no_rkm_medis like ? or "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? and pasien.nm_pasien like ? or "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? and asesmen_medis_ranap_anak.kd_dokter like ? or "+
                        "asesmen_medis_ranap_anak.tanggal between ? and ? and dokter.nm_dokter like ? order by asesmen_medis_ranap_anak.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("ket_lokalis"),rs.getString("lab"),rs.getString("rad"),rs.getString("penunjang"),rs.getString("diagnosis"),rs.getString("tata"),rs.getString("edukasi")
                     });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
...
//                ps=koneksi.prepareStatement(
//                        "select asesmen_medis_ranap_anak.tata from asesmen_medis_ranap_anak "+
//                        "where asesmen_medis_ranap_anak.no_rawat=? ");
//                try {
//                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
//                    rs=ps.executeQuery();
//                    while(rs.next()){
