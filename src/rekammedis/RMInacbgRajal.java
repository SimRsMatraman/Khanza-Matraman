 ...
 * @author perpustakaan
 */
public final class RMInacbgRajal extends javax.swing.JDialog {
    ...
    private RMCariAsesment cariasesment=new RMCariAsesment(null,false);
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public RMInacbgRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tgl.Rawat","Status","No.Rawat","No.RM","Nama Pasien","Kode Dokter","Dokter Penanggung Jawab","Diagnosa Utama","ICD10 Utama","Diagnosa Sekunder 1",
            "ICD10 Sek 1","Diagnosa Sekunder 2","ICD10 Sek 2","Diagnosa Klinis","Rencana Tindakan","Terapi","Rencana Tindak Lanjut","Tanggal Kontrol","Di"
        }){
        ...
        KodeDiagnosaUtama.setDocument(new batasInput((int)200).getKata(KodeDiagnosaUtama));
        ...
        Di.setDocument(new batasInput((int)255).getKata(Di));
        ...
        carirencana.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(carirencana.getTable().getSelectedRow()!= -1){
                    Rencana.append(carirencana.getTable().getValueAt(carirencana.getTable().getSelectedRow(),2).toString()+", ");
        ...
        cariasesment.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariasesment.getTable().getSelectedRow()!= -1){
                    Klinis.append(cariasesment.getTable().getValueAt(cariasesment.getTable().getSelectedRow(),2).toString()+", ");
                    Klinis.requestFocus();
                }
            }
            @Override
        ...
        cariterapi.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(cariterapi.getTable().getSelectedRow()!= -1){
                    Terapi.append(cariterapi.getTable().getValueAt(cariterapi.getTable().getSelectedRow(),2).toString()+", ");
                    Terapi.requestFocus();
                }
            }
            @Override
    ...
    private void initComponents() {
        ...
        MnLaporanResume.setText("Laporan INACBG");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data INACBG Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DiagnosaSekunder2.setBounds(150, 160, 520, 23);
        ...
        DiagnosaUtama.setBounds(150, 100, 520, 23);
        ...
        jLabel11.setText("Rencana Tindakan dan :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(0, 260, 140, 23);
        ...
        scrollPane6.setBounds(150, 260, 541, 50);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(0, 80, 97, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 130, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(530, 80, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(710, 100, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(710, 130, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(710, 160, 75, 23);
        ...
        BtnDokter4.setBounds(120, 280, 28, 23);
        ...
        BtnDokter6.setBounds(790, 100, 28, 23);
        ...
        BtnDokter7.setBounds(790, 130, 28, 23);
        ...
        BtnDokter8.setBounds(790, 160, 28, 23);

        jLabel4.setText("Tanggal :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(280, 380, 60, 23);
        ...
        BtnDokter1.setBounds(120, 340, 28, 23);
        ...
        scrollPane2.setBounds(150, 320, 541, 50);

        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya Kontrol" }));
        Kontrol.setName("Kontrol"); // NOI18N
        Kontrol.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                KontrolItemStateChanged(evt);
            }
        });
        ...
        Kontrol.setBounds(150, 380, 120, 23);

        jLabel8.setText("Terapi :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 320, 140, 23);

        jLabel9.setText("Rencana Tindak Lanjut :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 380, 140, 23);

        jLabel26.setText("Di :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(480, 380, 30, 23);
        ...
        FormInput.add(Di);
        Di.setBounds(520, 380, 300, 23);

        Tanggal.setText("1945-08-17");
        ...
        Tanggal.setBounds(350, 380, 90, 23);

        jLabel12.setText("Diagnosa Klinis :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(0, 200, 140, 23);

        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane7.setName("scrollPane7"); // NOI18N

        Klinis.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Klinis.setColumns(20);
        Klinis.setRows(5);
        Klinis.setName("Klinis"); // NOI18N
        Klinis.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KlinisKeyPressed(evt);
            }
        });
        scrollPane7.setViewportView(Klinis);

        FormInput.add(scrollPane7);
        scrollPane7.setBounds(150, 200, 541, 50);
        ...
        BtnDokter5.setBounds(120, 220, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Rencana.getText().equals("")){
            Valid.textKosong(Rencana,"Rencana Tindakan");
        }else{
            if(Sequel.menyimpantf("inacbg_rajal","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",16,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                    DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(), 
                    KodeDiagnosaSekunder2.getText(),Klinis.getText(),Rencana.getText(),Terapi.getText(),Kontrol.getSelectedItem().toString(),
                    Tanggal.getText(),Di.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from inacbg_rajal where no_rawat=?",1,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("inacbg_rajal","no_rawat=?","no_rawat=?,kd_dokter=?,tgl=?,jam=?,diagnosa_utama=?,kd_diagnosa_utama=?,diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,klinis=?,rencana=?,terapi=?,kontrol=?,tanggal=?,di=?",17,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                    DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(), 
                    KodeDiagnosaSekunder2.getText(),Klinis.getText(),Rencana.getText(),Terapi.getText(),Kontrol.getSelectedItem().toString(),
                    Tanggal.getText(),Di.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),2).toString()
                    })==true){
                       tampil();
                       emptTeks();
                }
    ...
    private void DiagnosaUtamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaUtamaKeyPressed
       Valid.pindah(evt,DiagnosaSekunder1,KodeDiagnosaUtama);
    ...
    private void KodeDiagnosaSekunder2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder2KeyPressed
        Valid.pindah(evt,DiagnosaSekunder2,Rencana);
    ...
    private void BtnDokter4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter4ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            carirencana.setNoRawat(TNoRw.getText());
            carirencana.tampil();
            carirencana.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            carirencana.setLocationRelativeTo(internalFrame1);
            carirencana.setVisible(true);
        }
    ...
    private void KontrolItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_KontrolItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_KontrolItemStateChanged
    ...
    private void KlinisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KlinisKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KlinisKeyPressed

    private void BtnDokter5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter5ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            cariasesment.setNoRawat(TNoRw.getText());
            cariasesment.tampil();
            cariasesment.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariasesment.setLocationRelativeTo(internalFrame1);
            cariasesment.setVisible(true);
        }
    ...
    */
    ...
    private widget.TextArea Klinis;
    ...
    private widget.ComboBox Kontrol;
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.status_lanjut,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "inacbg_rajal.kd_dokter,dokter.nm_dokter,inacbg_rajal.diagnosa_utama,inacbg_rajal.kd_diagnosa_utama, "+
                    "inacbg_rajal.diagnosa_sekunder,inacbg_rajal.kd_diagnosa_sekunder,inacbg_rajal.diagnosa_sekunder2,inacbg_rajal.kd_diagnosa_sekunder2, "+
                    "inacbg_rajal.klinis,inacbg_rajal.rencana,inacbg_rajal.terapi,inacbg_rajal.kontrol,inacbg_rajal.tanggal,inacbg_rajal.di from inacbg_rajal inner join reg_periksa on inacbg_rajal.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on inacbg_rajal.kd_dokter=dokter.kd_dokter "+
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "reg_periksa.tgl_registrasi between ? and ? and inacbg_rajal.kd_dokter like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and dokter.nm_dokter like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and inacbg_rajal.kd_diagnosa_utama like ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and inacbg_rajal.diagnosa_utama like ? or "+
...
//                    ps.setString(36,"%"+TCari.getText()+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_diagnosa_sekunder2"),rs.getString("klinis"),rs.getString("rencana"),rs.getString("terapi"),rs.getString("kontrol"),rs.getString("tanggal"),rs.getString("di")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DiagnosaUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());  
            KodeDiagnosaUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            DiagnosaSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());  
            KodeDiagnosaSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());    
            DiagnosaSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());  
            KodeDiagnosaSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString()); 
            Klinis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Kontrol.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            Tanggal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            Di.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
        }
    }
