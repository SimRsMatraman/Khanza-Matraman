 ...
 * @author perpustakaan
 */
public final class ValidasiIMPKep extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public ValidasiIMPKep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tgl.Rawat","Status","No.Rawat","No.RM","Nama Pasien","NIP","Nama Pemeriksa","Tanggal Implementasi","Jam Implementasi","Implementasi Keperawatan"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi Implementasi Keperawatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Implementasi Keperawatan"));
        ...
        label16.setText("Tanggal Implementasi:");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(10, 100, 120, 23);

        label17.setText("Jam Implementasi:");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            Valid.textKosong(Implementasi,"Implementasi Keperawatan");
        }else{
            if(Sequel.menyimpantf("validasi_implementasi_ranap","?,?,?,?,?,?,?,?,?","No.Rawat",9,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ValidasiIMPKep dialog = new ValidasiIMPKep(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,implementasi_keperawatan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "implementasi_keperawatan_ranap.tanggal,implementasi_keperawatan_ranap.jam,implementasi_keperawatan_ranap.implementasi, " +
                    "implementasi_keperawatan_ranap.nip,petugas.nama from pasien inner join reg_periksa inner join implementasi_keperawatan_ranap "+
                    "on implementasi_keperawatan_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on implementasi_keperawatan_ranap.nip=petugas.nip LEFT JOIN validasi_implementasi_ranap ON validasi_implementasi_ranap.no_rawat = implementasi_keperawatan_ranap.no_rawat AND validasi_implementasi_ranap.tgl_perawatan = implementasi_keperawatan_ranap.tanggal AND validasi_implementasi_ranap.jam_rawat = implementasi_keperawatan_ranap.jam where "+
                    "implementasi_keperawatan_ranap.no_rawat like ? and ISNULL(validasi_implementasi_ranap.status_validasi) order by implementasi_keperawatan_ranap.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,implementasi_keperawatan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "implementasi_keperawatan_ranap.tanggal,implementasi_keperawatan_ranap.jam,implementasi_keperawatan_ranap.implementasi, " +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tanggal"),rs.getString("jam"),rs.getString("implementasi")
                    });
                }
            } catch (Exception e) {
