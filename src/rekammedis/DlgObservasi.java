...
public class DlgObservasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgObservasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Observasi Lanjutan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgObservasi dialog = new DlgObservasi(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>Observasi Lanjutan</td>"+
                "</tr>"
            );     
                        ...
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='40%'>GCS(E,V,M)</td>"+  
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='40%'>TD(mmHg)</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='40%'>HR(x/menit)</td>"+
                                ...
                                //2021/04/18/000056
                                 htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        ...
                                        "<td align='left'>"+rs2.getString("gcs")+"</td>"+
                                        "<td align='left'>"+rs2.getString("td")+"</td>"+
                                        "<td align='left'>"+rs2.getString("hr")+"</td>"+
