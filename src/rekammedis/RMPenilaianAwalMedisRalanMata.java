...
public final class RMPenilaianAwalMedisRalanMata extends javax.swing.JDialog {
    ...
    */
    ...
    public void emptTeks() {
        ...
        COAkanan.setText("Dalam, Sel -, Fl -");
        COAkiri.setText("Dalam, Sel -, Fl -");
        Pupilkanan.setText("Bulat, Sentral, RC+");
        Pupilkiri.setText("Bulat, Sentral, RC+");
        Lensakanan.setText("Jernih");
        Lensakiri.setText("Jernih");
        Funduskanan.setText("Jernih");
        Funduskiri.setText("Jernih");
        Papilkanan.setText("Bulat, Batas Tegas CDR 0,3-0,4");
        Papilkiri.setText("Bulat, Batas Tegas CDR 0,3-0,4");
        Retinakanan.setText("Retina Baik");
        Retinakiri.setText("Retina Baik");
