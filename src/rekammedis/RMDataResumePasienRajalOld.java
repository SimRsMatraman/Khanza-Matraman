 ...
 * @author perpustakaan
 */
public final class RMDataResumePasienRajalOld extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataResumePasienRajalOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "ICD10 Sek 1","Diagnosa Sekunder 2","ICD10 Sek 2","Rencana Tindakan","Terapi","Rencana Tindak Lanjut","Tanggal","Di"
        }){
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-07-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-07-2022" }));
        ...
        jLabel11.setBounds(7, 200, 140, 23);
        ...
        scrollPane6.setBounds(150, 200, 541, 50);
        ...
        BtnDokter4.setBounds(120, 230, 28, 23);

        jLabel36.setText("Rencana Tindak Lanjut :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 330, 143, 23);
        ...
        Kondisi1.setBounds(150, 330, 80, 23);
        ...
        jLabel4.setText("Terapi :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(0, 270, 140, 23);
        ...
        BtnDokter1.setBounds(120, 290, 28, 23);
        ...
        scrollPane2.setBounds(150, 270, 541, 50);

        jLabel8.setText("Tgl. Kontrol :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(230, 330, 70, 23);

        Tgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-07-2022" }));
        ...
        FormInput.add(Tgl);
        Tgl.setBounds(310, 330, 90, 23);

        jLabel9.setText("Di :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(400, 330, 30, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_rajal","?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",13,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                    DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(), 
                    KodeDiagnosaSekunder2.getText(),Rencana.getText(),Terapi.getText(),Kondisi1.getSelectedItem().toString(),
                    Valid.SetTgl(Tgl.getSelectedItem()+""),Di.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("resume_pasien_rajal","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_utama=?,kd_diagnosa_utama=?,diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,rencana=?,terapi=?,tindak_lanjut=?,tanggal=?,di=?",14,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                    DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(), 
                    KodeDiagnosaSekunder2.getText(),Rencana.getText(),Terapi.getText(),Kondisi1.getSelectedItem().toString(),
                    Valid.SetTgl(Tgl.getSelectedItem()+""),Di.getText(),
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataResumePasienRajalOld dialog = new RMDataResumePasienRajalOld(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.status_lanjut,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "resume_pasien_rajal.kd_dokter,dokter.nm_dokter,resume_pasien_rajal.diagnosa_utama,resume_pasien_rajal.kd_diagnosa_utama, "+
                    ...
                    "resume_pasien_rajal.rencana,resume_pasien_rajal.terapi,resume_pasien_rajal.tindak_lanjut,resume_pasien_rajal.tanggal,resume_pasien_rajal.di from resume_pasien_rajal inner join reg_periksa on resume_pasien_rajal.no_rawat=reg_periksa.no_rawat  "+
...
//                    ps.setString(36,"%"+TCari.getText()+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_diagnosa_sekunder2"),rs.getString("rencana"),rs.getString("terapi"),rs.getString("tindak_lanjut"),rs.getString("tanggal"),rs.getString("di")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Kondisi1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Valid.SetTgl(Tgl,tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            Di.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
        }
    }
