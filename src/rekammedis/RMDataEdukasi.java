...
//        });
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Edukasi Pasien/Keluarga Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("edukasi_pasien_rajal","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Surat",94,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from edukasi_pasien_rajal where no_surat=?",1,new String[]{
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.status_lanjut,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "edukasi_pasien_rajal.no_surat,edukasi_pasien_rajal.no_rawat,edukasi_pasien_rajal.tanggal_surat,edukasi_pasien_rajal.jam,edukasi_pasien_rajal.tanggal_pengkajian, "+
                    "edukasi_pasien_rajal.jam_pengkajian,edukasi_pasien_rajal.nik,pegawai.nama,edukasi_pasien_rajal.pengkajian,edukasi_pasien_rajal.pengkajian_lainnya, "+
                    "edukasi_pasien_rajal.bicara,edukasi_pasien_rajal.membaca,edukasi_pasien_rajal.penerjemah,edukasi_pasien_rajal.isyarat, "+
                    "edukasi_pasien_rajal.kepercayaan,edukasi_pasien_rajal.pengetahuan,edukasi_pasien_rajal.budaya,edukasi_pasien_rajal.merokok, "+
                    "edukasi_pasien_rajal.alkohol,edukasi_pasien_rajal.informasi,edukasi_pasien_rajal.alasan,edukasi_pasien_rajal.rencana,edukasi_pasien_rajal.jelaskan, "+
                    "edukasi_pasien_rajal.profesi,edukasi_pasien_rajal.kd_edukasi1,edukasi_pasien_rajal.edukasi1,edukasi_pasien_rajal.penerima1, "+
                    "edukasi_pasien_rajal.metode1,edukasi_pasien_rajal.frekuensi1,edukasi_pasien_rajal.evaluasi1,edukasi_pasien_rajal.kd_edukasi2, "+
                    "edukasi_pasien_rajal.edukasi2,edukasi_pasien_rajal.penerima2,edukasi_pasien_rajal.metode2,edukasi_pasien_rajal.frekuensi2, "+
                    "edukasi_pasien_rajal.evaluasi2,edukasi_pasien_rajal.kd_edukasi3,edukasi_pasien_rajal.edukasi3,edukasi_pasien_rajal.penerima3, "+
                    "edukasi_pasien_rajal.metode3,edukasi_pasien_rajal.frekuensi3,edukasi_pasien_rajal.evaluasi3,edukasi_pasien_rajal.kd_edukasi4,edukasi_pasien_rajal.edukasi4, "+
                    "edukasi_pasien_rajal.penerima4,edukasi_pasien_rajal.metode4,edukasi_pasien_rajal.frekuensi4,edukasi_pasien_rajal.evaluasi4, "+
                    "edukasi_pasien_rajal.kd_edukasi5,edukasi_pasien_rajal.edukasi5,edukasi_pasien_rajal.penerima5,edukasi_pasien_rajal.metode5, "+
                    "edukasi_pasien_rajal.frekuensi5,edukasi_pasien_rajal.evaluasi5,edukasi_pasien_rajal.kd_edukasi6,edukasi_pasien_rajal.edukasi6, "+
                    "edukasi_pasien_rajal.penerima6,edukasi_pasien_rajal.metode6,edukasi_pasien_rajal.frekuensi6,edukasi_pasien_rajal.evaluasi6, "+
                    "edukasi_pasien_rajal.kd_edukasi7,edukasi_pasien_rajal.edukasi7,edukasi_pasien_rajal.penerima7,edukasi_pasien_rajal.metode7, "+
                    "edukasi_pasien_rajal.frekuensi7,edukasi_pasien_rajal.evaluasi7,edukasi_pasien_rajal.kd_edukasi8,edukasi_pasien_rajal.edukasi8, "+
                    "edukasi_pasien_rajal.penerima8,edukasi_pasien_rajal.metode8,edukasi_pasien_rajal.frekuensi8,edukasi_pasien_rajal.evaluasi8, "+
                    "edukasi_pasien_rajal.kd_edukasi9,edukasi_pasien_rajal.edukasi9,edukasi_pasien_rajal.penerima9,edukasi_pasien_rajal.metode9, "+
                    "edukasi_pasien_rajal.frekuensi9,edukasi_pasien_rajal.evaluasi9,edukasi_pasien_rajal.kd_edukasi10,edukasi_pasien_rajal.edukasi10, "+
                    "edukasi_pasien_rajal.penerima10,edukasi_pasien_rajal.metode10,edukasi_pasien_rajal.frekuensi10,edukasi_pasien_rajal.evaluasi10, "+
                    "edukasi_pasien_rajal.edukasi_lainnya,edukasi_pasien_rajal.kolaborasi,edukasi_pasien_rajal.edukasi_kolaborasi, "+
                    "edukasi_pasien_rajal.penerima11,edukasi_pasien_rajal.metode11,edukasi_pasien_rajal.frekuensi11,edukasi_pasien_rajal.evaluasi11, "+
                    "edukasi_pasien_rajal.hubungan,edukasi_pasien_rajal.kedua,edukasi_pasien_rajal.acc_ep,edukasi_pasien_rajal.tte from edukasi_pasien_rajal inner join reg_periksa on edukasi_pasien_rajal.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on edukasi_pasien_rajal.nik=pegawai.nik "+
                    "where edukasi_pasien_rajal.tanggal_surat between ? and ? order by edukasi_pasien_rajal.tanggal_surat");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.status_lanjut,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "edukasi_pasien_rajal.no_surat,edukasi_pasien_rajal.no_rawat,edukasi_pasien_rajal.tanggal_surat,edukasi_pasien_rajal.jam,edukasi_pasien_rajal.tanggal_pengkajian, "+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on edukasi_pasien_rajal.nik=pegawai.nik "+
                    "where edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.acc_ep like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.pengkajian like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.no_surat like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and pasien.nm_pasien like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.nik like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and pegawai.nama like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.nik like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.edukasi1 like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.edukasi2 like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.edukasi3 like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.edukasi4 like ? or "+
                    "edukasi_pasien_rajal.tanggal_surat between ? and ? and edukasi_pasien_rajal.no_rawat like ? "+
                    "order by edukasi_pasien_rajal.tanggal_surat");
            }
            try {
                if(TCari.getText().equals("")){
...
//        KodeDokter.setText("");
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,4),signed)),0) from edukasi_pasien_rajal where tanggal_surat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ",
...
//                "ICRJ"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,4),signed)),0) from edukasi_pasien_rajal where tanggal_surat='"+Valid.SetTgl(tglPilih+"")+"' ",
                "EPRJ"+Valid.SetTgl(tglPilih+"").replaceAll("-", ""),4,NoSurat);
    }
...
//        if(FormPhotoPass.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select edukasi_pasien_rajal.tte from edukasi_pasien_rajal where edukasi_pasien_rajal.no_surat=?");
                try {
