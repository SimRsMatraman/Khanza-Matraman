...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Monitoring & Evaluasi","Status Gizi","Resiko Malnutrisi","Kondisi Khusus","Ket Kondisi Khusus","Bentuk Makanan","Diet Khusus","Rute Pemberian",
            "Kalori","Tindak Lanjut","NIP","Nama Petugas"
        }){
...
//        IntervensiGizi.setDocument(new batasInput((int)100).getKata(IntervensiGizi));
        ...
        KetKondisi.setDocument(new batasInput((int)255).getKata(KetKondisi));
    ...
    private void initComponents() {
        ...
        Bentuk = new widget.TextBox();
        jLabel55 = new widget.Label();
        Rute = new widget.TextBox();
        jLabel56 = new widget.Label();
        Kalori = new widget.TextBox();
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(192, 455));
        ...
        label14.setBounds(0, 850, 130, 23);
        ...
        KdPetugas.setBounds(130, 850, 130, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(270, 850, 300, 23);
        ...
        BtnDokter.setBounds(570, 850, 28, 23);
        ...
        jLabel9.setBounds(0, 640, 130, 23);
        ...
        jLabel12.setBounds(0, 510, 160, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(160, 510, 60, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(220, 510, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(340, 510, 60, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(280, 510, 50, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("Kg/Cm");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(580, 510, 50, 23);
        ...
        FormInput.add(IMT);
        IMT.setBounds(510, 510, 60, 23);

        jLabel17.setText("IMT :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(450, 510, 60, 23);

        jLabel18.setText("LilA :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(640, 510, 40, 23);
        ...
        FormInput.add(LiLA);
        LiLA.setBounds(690, 510, 60, 23);

        jLabel22.setText("TL :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 540, 160, 23);
        ...
        FormInput.add(TL);
        TL.setBounds(160, 540, 60, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Cm");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(750, 510, 30, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("Cm");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(220, 540, 30, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("Cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(400, 510, 30, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("Cm");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(400, 540, 30, 23);
        ...
        FormInput.add(ULNA);
        ULNA.setBounds(340, 540, 60, 23);

        jLabel26.setText("ULNA :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(280, 540, 50, 23);

        jLabel14.setText("BB Ideal :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(450, 540, 60, 23);
        ...
        BBIdeal.setBounds(510, 540, 60, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Kg");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(580, 540, 50, 23);

        jLabel28.setText("BB/U :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(640, 540, 40, 23);
        ...
        BBPerU.setBounds(690, 540, 60, 23);

        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel29.setText("%");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(750, 540, 30, 23);

        jLabel30.setText("TB/U :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 570, 160, 23);
        ...
        TBPerU.setBounds(160, 570, 60, 23);

        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel31.setText("%");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(220, 570, 30, 23);

        jLabel32.setText("BB/TB :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(280, 570, 50, 23);
        ...
        BBPerTB.setBounds(340, 570, 60, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("%");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(400, 570, 30, 23);

        jLabel34.setText("LiLA/U :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(450, 570, 60, 23);
        ...
        LiLAPerU.setBounds(510, 570, 60, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("%");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(580, 570, 50, 23);

        jLabel36.setText("Antropometri :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 490, 130, 23);
        ...
        Biokimia.setBounds(130, 640, 645, 23);

        jLabel37.setText("Fisik/Klinis :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(0, 670, 130, 23);
        ...
        FisikKlinis.setBounds(130, 670, 645, 23);
        ...
        PolaMakan.setBounds(130, 700, 645, 23);

        jLabel38.setText("Riwayat Personal :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(0, 730, 130, 23);
        ...
        DiagnosisGizi.setBounds(130, 760, 645, 23);

        jLabel40.setText("Diagnosis Gizi :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 760, 130, 23);

        jLabel41.setText("Intervensi Gizi :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 790, 130, 23);
        ...
        IntervensiGizi.setBounds(130, 790, 645, 23);

        jLabel42.setText("Monitoring & Evaluasi :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 820, 130, 23);
        ...
        Monitoring.setBounds(130, 820, 645, 23);

        jLabel39.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel39.setText("Telur");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(90, 190, 170, 23);

        jLabel44.setText("Pola Makan :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 700, 130, 23);
        ...
        TelurYa.setBounds(260, 190, 45, 23);
        ...
        TelurTidak.setBounds(310, 190, 60, 23);
        ...
        SusuTidak.setBounds(310, 210, 60, 23);
        ...
        KacangYa.setBounds(260, 230, 45, 23);
        ...
        KacangTidak.setBounds(310, 230, 60, 23);

        jLabel47.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel47.setText("Gluten / gandum");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(90, 250, 170, 23);
        ...
        GlutenYa.setBounds(260, 250, 45, 23);
        ...
        GlutenTidak.setBounds(310, 250, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("Udang");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(470, 190, 100, 23);
        ...
        UdangYa.setBounds(570, 190, 45, 23);
        ...
        UdangTidak.setBounds(620, 190, 60, 23);

        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel49.setText("Ikan");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(470, 210, 100, 23);
        ...
        IkanYa.setBounds(570, 210, 45, 23);
        ...
        IkanTidak.setBounds(620, 210, 60, 23);
        ...
        HazelnutYa.setBounds(570, 230, 45, 23);
        ...
        HazelnutTidak.setBounds(620, 230, 60, 23);

        jLabel51.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel51.setText("Hazelnut / almont");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(470, 230, 100, 23);

        jLabel50.setText("3. Alergi Makanan :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(8, 170, 150, 23);
        ...
        RiwayatPersonal.setBounds(130, 730, 645, 23);

        jLabel52.setText("Status Gizi :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(30, 600, 130, 23);

        StatusGizi.setFocusTraversalPolicyProvider(true);
        StatusGizi.setName("StatusGizi"); // NOI18N
        StatusGizi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                StatusGiziKeyPressed(evt);
            }
        });
        FormInput.add(StatusGizi);
        StatusGizi.setBounds(160, 600, 240, 23);
        ...
        jSeparator1.setBounds(0, 70, 783, 1);

        jLabel98.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel98.setText("ASESMENT GIZI AWAL");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(10, 70, 180, 23);

        jLabel78.setText("Diagnosa Medis");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(20, 90, 90, 23);

        Resiko.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Resiko Ringan", "Resiko Sedang", "Resiko Tinggi" }));
        ...
        Resiko.setBounds(390, 110, 120, 23);

        jLabel79.setText("1. Resiko malnutrisi berdasarkan hasil skrining gizi oleh perawat :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(60, 110, 320, 23);

        jLabel80.setText("2. Apakah pasien memiliki kondisi khusus :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(63, 140, 210, 23);

        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ...
        Kondisi.setBounds(390, 140, 120, 23);

        jLabel43.setText("Diet Khusus :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(30, 330, 150, 23);

        Diet.setFocusTraversalPolicyProvider(true);
        ...
        FormInput.add(Diet);
        Diet.setBounds(190, 330, 570, 23);

        jLabel53.setText("4. Preskripsi Diet");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(0, 280, 150, 23);

        jLabel54.setText("Bentuk Makanan :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(20, 300, 160, 23);

        Bentuk.setFocusTraversalPolicyProvider(true);
        Bentuk.setName("Bentuk"); // NOI18N
        Bentuk.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BentukKeyPressed(evt);
            }
        });
        FormInput.add(Bentuk);
        Bentuk.setBounds(190, 300, 570, 23);

        jLabel55.setText("Rute Pemberian :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(30, 360, 150, 23);
        ...
        FormInput.add(Rute);
        Rute.setBounds(190, 360, 570, 23);

        jLabel56.setText("Kalori :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(30, 390, 150, 23);

        Kalori.setFocusTraversalPolicyProvider(true);
        Kalori.setName("Kalori"); // NOI18N
        Kalori.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KaloriKeyPressed(evt);
            }
        });
        FormInput.add(Kalori);
        Kalori.setBounds(190, 390, 570, 23);

        jLabel81.setText("5. Tindak lanjut :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(30, 430, 130, 23);

        TindakLanjut.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Perlu asuhan gizi (lanjutkan ke Asesment Gizi)", "Belum perlu asuhan gizi lanjut" }));
        ...
        TindakLanjut.setBounds(170, 430, 280, 23);

        jLabel99.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel99.setText("ASESMENT GIZI LANJUT");
        jLabel99.setName("jLabel99"); // NOI18N
        FormInput.add(jLabel99);
        jLabel99.setBounds(10, 460, 180, 23);
        ...
        jSeparator2.setBounds(0, 460, 783, 1);

        KetKondisi.setHighlighter(null);
        KetKondisi.setName("KetKondisi"); // NOI18N
        FormInput.add(KetKondisi);
        KetKondisi.setBounds(590, 140, 337, 23);

        jLabel57.setText("Jelaskan :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(520, 140, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asuhan_gizi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
                    ...
                    Monitoring.getText(),StatusGizi.getText(),Resiko.getSelectedItem().toString(),Kondisi.getSelectedItem().toString(),KetKondisi.getText(),
                    Bentuk.getText(),Diet.getText(),Rute.getText(),Kalori.getText(),TindakLanjut.getSelectedItem().toString(),KdPetugas.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                ...
                if(Sequel.mengedittf("asuhan_gizi","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,antropometri_bb=?,antropometri_tb=?,antropometri_imt=?,antropometri_lla=?,antropometri_tl=?,antropometri_ulna=?,antropometri_bbideal=?,antropometri_bbperu=?,antropometri_tbperu=?,antropometri_bbpertb=?,antropometri_llaperu=?,biokimia=?,fisik_klinis=?,alergi_telur=?,alergi_susu_sapi=?,alergi_kacang=?,alergi_gluten=?,alergi_udang=?,alergi_ikan=?,alergi_hazelnut=?,pola_makan=?,riwayat_personal=?,diagnosis=?,intervensi_gizi=?,monitoring_evaluasi=?,status_gizi=?,resiko=?,kondisi=?,ket_kondisi=?,bentuk=?,diet=?,rute=?,kalori=?,tindak_lanjut=?,nip=?",39,new String[]{
                        TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+""),BB.getText(),TB.getText(),IMT.getText(),LiLA.getText(), 
                        TL.getText(),ULNA.getText(),BBIdeal.getText(),BBPerU.getText(),TBPerU.getText(),BBPerTB.getText(),LiLAPerU.getText(), 
                        Biokimia.getText(),FisikKlinis.getText(), alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, 
                        alergi_ikan, alergi_hazelnut, PolaMakan.getText(),RiwayatPersonal.getText(),DiagnosisGizi.getText(),IntervensiGizi.getText(),
                        Monitoring.getText(),StatusGizi.getText(),Resiko.getSelectedItem().toString(),Kondisi.getSelectedItem().toString(),KetKondisi.getText(),
                        Bentuk.getText(),Diet.getText(),Rute.getText(),Kalori.getText(),TindakLanjut.getSelectedItem().toString(),
                        KdPetugas.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()
                    })==true){
                        tampil();
                        emptTeks();
                }
    ...
    private void StatusGiziKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StatusGiziKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_StatusGiziKeyPressed
    ...
    private void BentukKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BentukKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BentukKeyPressed

    private void RuteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RuteKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RuteKeyPressed

    private void KaloriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KaloriKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KaloriKeyPressed
    ...
    */
    ...
    private widget.TextBox StatusGizi;
    ...
    public void tampil() {
        ...
        try{
            ...
            "ULNA(Cm)","BB Ideal(Kg)","BB/U(%)","TB/U(%)","BB/TB(%)","LiLA/U(%)","Biokimia","Fisik/Klinis","Telur","Susu Sapi",
            "Kacang","Gluten","Udang","Ikan","Hazelnut","Pola Makan","Riwayat Personal","Diagnosis Gizi","Intervensi Gizi",
            "Monitoring & Evaluasi","Status Gizi","NIP","Nama Petugas"*/
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "asuhan_gizi.fisik_klinis,asuhan_gizi.alergi_telur,asuhan_gizi.alergi_susu_sapi,asuhan_gizi.alergi_kacang,asuhan_gizi.alergi_gluten,"+
                        "asuhan_gizi.alergi_udang,asuhan_gizi.alergi_ikan,asuhan_gizi.alergi_hazelnut,asuhan_gizi.pola_makan,asuhan_gizi.riwayat_personal,"+
                        "asuhan_gizi.diagnosis,asuhan_gizi.intervensi_gizi,asuhan_gizi.monitoring_evaluasi,asuhan_gizi.status_gizi,"+
                        "asuhan_gizi.resiko,asuhan_gizi.kondisi,asuhan_gizi.ket_kondisi,asuhan_gizi.bentuk,asuhan_gizi.diet,asuhan_gizi.rute,asuhan_gizi.kalori,asuhan_gizi.tindak_lanjut,asuhan_gizi.nip,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join asuhan_gizi on reg_periksa.no_rawat=asuhan_gizi.no_rawat "+
                        "inner join petugas on asuhan_gizi.nip=petugas.nip where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("intervensi_gizi"),rs.getString("monitoring_evaluasi"),rs.getString("status_gizi"),
                        rs.getString("resiko"),rs.getString("kondisi"),rs.getString("ket_kondisi"),rs.getString("bentuk"),rs.getString("diet"),rs.getString("rute"),
                        rs.getString("kalori"),rs.getString("tindak_lanjut"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            StatusGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Resiko.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            Kondisi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
            KetKondisi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
            Bentuk.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
            Diet.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            Rute.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());
            Kalori.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
            TindakLanjut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            KdPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            NmPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
