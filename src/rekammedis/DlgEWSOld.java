...
public class DlgEWSOld extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgEWSOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgEWSOld dialog = new DlgEWSOld(new javax.swing.JFrame(), true);
