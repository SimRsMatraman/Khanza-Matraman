...
public final class RMMCU extends javax.swing.JDialog {
    ...
    private String finger="",namaPenyakit="",Listpenyakit=""; 
...
//        Alkohol.setDocument(new batasInput((int)100).getKata(Alkohol));
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-12-2023 08:46:17" }));
        ...
        jLabel59.setText("C. PEMERIKSAAN LABORATORIUM (HASIL TERLAMPIR)");
        ...
        scrollPane10.setBounds(50, 1060, 810, 53);
        ...
        scrollPane11.setBounds(50, 1140, 810, 53);
        ...
        scrollPane12.setBounds(50, 1220, 810, 53);
        ...
        scrollPane14.setBounds(50, 1460, 810, 53);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("H. KESIMPULAN");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 1440, 190, 23);
        ...
        scrollPane15.setBounds(50, 1540, 810, 53);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("I. ANJURAN");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(10, 1520, 330, 23);
        ...
        jSeparator6.setBounds(10, 1440, 880, 1);
        ...
        jSeparator8.setBounds(10, 1520, 880, 1);
        ...
        jLabel108.setText("F. AUDIOMETRI");
        jLabel108.setName("jLabel108"); // NOI18N
        FormInput.add(jLabel108);
        jLabel108.setBounds(10, 1280, 182, 23);
        ...
        scrollPane16.setBounds(50, 1300, 810, 53);
        ...
        jLabel110.setText("G. LAIN-LAIN");
        jLabel110.setName("jLabel110"); // NOI18N
        FormInput.add(jLabel110);
        jLabel110.setBounds(10, 1360, 182, 23);
        ...
        scrollPane18.setBounds(50, 1380, 810, 53);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
           ...
           if(Sequel.menyimpantf("penilaian_mcu","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",75,new String[]{
                    ...
                    ExtremitasBawah.getSelectedItem().toString(),KetExtremitasBawah.getText(),PemeriksaanLaboratorium.getText(),RongsenThorax.getText(),EKG.getText(),"",Audiometri.getText(),"",Lainlain.getText(),
...
//            Alkohol.setText(tbObat.getValueAt(tbObat.getSelectedRow(),75).toString());
    ...
    private void isRawat() {
        try {
            ...
            try {
                ...
                while(rs.next()){
                 ...
                 RiwayatPenyakitSekarang.append(namaPenyakit.length()>0 ? namaPenyakit.substring(0,namaPenyakit.length()-1):"");
            } catch (Exception e) {
                System.out.println("Notif : "+e);
           } finally{
                if(rs!=null){
        ...
        Sequel.cariIsi("select pemeriksaan_ralan.rpd from pemeriksaan_ralan INNER JOIN reg_periksa ON pemeriksaan_ralan.no_rawat = reg_periksa.no_rawat where no_rkm_medis=? ORDER BY pemeriksaan_ralan.tgl_perawatan DESC, pemeriksaan_ralan.jam_rawat DESC",RiwayatPenyakitDahulu,TNoRM.getText());
        Sequel.cariIsi("select pemeriksaan_ralan.rpk from pemeriksaan_ralan INNER JOIN reg_periksa ON pemeriksaan_ralan.no_rawat = reg_periksa.no_rawat where no_rkm_medis=? ORDER BY pemeriksaan_ralan.tgl_perawatan DESC, pemeriksaan_ralan.jam_rawat DESC",RiwayatPenyakitKeluarga,TNoRM.getText());
        try {
            ps=koneksi.prepareStatement(
                    "SELECT CONCAT (nm_perawatan,' - ',Pemeriksaan, ' : ', detail_periksa_lab.nilai,' ', satuan, ' | ', ' Nilai Rujukan ( ', detail_periksa_lab.nilai_rujukan, ' ) ' )as hasil FROM detail_periksa_lab INNER JOIN jns_perawatan_lab ON jns_perawatan_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw INNER JOIN template_laboratorium on template_laboratorium.id_template=detail_periksa_lab.id_template WHERE no_rawat='"+TNoRw.getText()+"'");
            try {
                rs=ps.executeQuery();
                namaPenyakit="";
                while(rs.next()){
                 ...
                 PemeriksaanLaboratorium.append(namaPenyakit.length()>0 ? namaPenyakit.substring(0,namaPenyakit.length()-1):"");
            } catch (Exception e) {
                System.out.println("Notif : "+e);
           } finally{
                if(rs!=null){
        ...
        if(Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_ralan where no_rawat='"+TNoRw.getText()+"' ")>0){
            ...
            BeratBadan.setText(Sequel.cariIsi("select bb from penilaian_awal_keperawatan_ralan where no_rawat=?",TNoRw.getText()));
            TinggiBadan.setText(Sequel.cariIsi("select tb from penilaian_awal_keperawatan_ralan where no_rawat=?",TNoRw.getText()));
            ...
            BeratBadan.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            TinggiBadan.setText(Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rkm_medis,pasien.nm_pasien, if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,reg_periksa.tgl_registrasi,hasil_radiologi.hasil "+
                    "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis LEFT JOIN hasil_radiologi on hasil_radiologi.no_rawat = reg_periksa.no_rawat where reg_periksa.no_rawat=?");
            try {
                ...
                if(rs.next()){
                    ...
                    RongsenThorax.setText(rs.getString("hasil"));
