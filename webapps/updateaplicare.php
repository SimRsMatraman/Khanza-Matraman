<?php
    ...
    //require_once ('api_khanza_dashboard.php');
...
//            $host="http://dvlp.bpjs-kesehatan.go.id:8888";
	          $host="https://new-api.bpjs-kesehatan.go.id/aplicaresws";
            ...
            $_sql="select aplicare_ketersediaan_kamar.kode_kelas_aplicare,
            ...
            aplicare_ketersediaan_kamar.tersediapria,
            aplicare_ketersediaan_kamar.tersediawanita,
            aplicare_ketersediaan_kamar.tersediapriawanita
...
<script type="text/javascript">
	$(document).ready(function() {
	    $.ajax({
			  url: "http://api.bpjs-kesehatan.go.id/aplicaresws/",
	        //url: "https://dvlp.bpjs-kesehatan.go.id/new-aplicares",
	        type: "POST",
	        data: {
			content: $("#content").val()
		},
