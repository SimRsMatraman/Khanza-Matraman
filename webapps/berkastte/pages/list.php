<div id="post">
    <div align="center" class="link">
            <a href=?act=MasterBerkas&action=TAMBAH>| Master Berkas TTE BSSN |</a>
            <a href=?act=List>| List Berkas TTE BSSN |</a>
    </div> 
    <div class="entry">   
        ...
        if(mysqli_num_rows($hasil)!=0) {
            echo "<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    <tr class='head'>
                        ...
                        <td width='36%'><div align='center'>Berkas TTE BSSN</div></td>
                    </tr>";
                               ...
                               <td bgcolor='#FF0040' valign='top'>
                                  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>";
                                        ...
                                        while($baris2 = mysqli_fetch_array($hasil2)) { 
                                            echo "<tr class='isi8'> 
                                                    <td width='5%'>$no.</td>
                                                    <td width='95%'><a target=_blank href=../berkastte/pages/upload/".$baris2["lokasi_file"].">".$baris2["nama"]."</a></td>
                                                  </tr>";$no++;
                                        }
                                    echo "                                  
                                  </table>
            ...
            echo "</table>";           
                        ...
                        <tr class='head'>
                            ...
                            <td width='33%'><div align='center'>Berkas TTE BSSN</div></td>
                        </tr>
                      </table>";        
        }        
