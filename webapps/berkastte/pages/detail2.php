    ...
    <div class="entry">
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data> <?php $getnik = isset($_GET['nik']) ? $_GET['nik'] : $_POST['nik']; ?> <input type="text" name="nik" value="<?= $getnik; ?>">
            ...
            if (isset($BtnSimpan)) {
                ...
                $fields = array(
                    'file' => new CurlFile($_FILES['dokumen']['tmp_name'], 'application/pdf'), 'nik' => $_GET['nik'], 'passphrase' => $psw, 'tampilan' => 'VISIBLE', 'page' => '1', 'image' => 'true', 'linkQR' => 'http://rsudcipayung.jakarta.go.id/rsudcipayung/', 'xAxis' => '0', 'yAxis' => '0', 'tag_koordinat' => '#', 'width' => '200', 'height' => '100', 'signed_file' => new CurlFile('C:\xampp\htdocs\webapps\berkastte\pages\Wew.pdf')
                );
