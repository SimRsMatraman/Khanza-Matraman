...
<div id="post">
    <div class="entry">        
		...
		<tr class="isi2">
                ...
                <tr class="isi2">
                    <td width="25%" >Berkas TTE BSSN</td><td width="">:</td>
                    <td width="75%">
        ...
        <?php
            if ($action=="HAPUS") {                
                ...
                Hapus(" berkas_tte "," no_rawat ='".$_GET['no_rawat']."' and kode ='".$_GET['kode']."' and lokasi_file='".$_GET['lokasi_file']."' ","?act=Detail&action=TAMBAH&no_rawat=$no_rawat");
            }
