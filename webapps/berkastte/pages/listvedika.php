                ...
                if(mysqli_num_rows($hasil)!=0) {
                    echo "<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                            <tr class='head'>
                                ...
                                <td width='21%'><div align='center'>Berkas TTE BSSN</div></td>
                            </tr>";
                            while($baris = mysqli_fetch_array($hasil)) {                        
                                echo "<tr class='isi'>
                                       <td valign='midle'>
                                            <center>
                                                <a target=_blank href=../berkastte/pages/tampilpdf.php?norawat=".$baris["no_rawat"].">[Gabung]</a><br>
                                                <a target=_blank href=../berkastte/pages/billing.php?norawat=".$baris["no_rawat"].">[Billing]</a>
                                            </center>
                                       </td>
                                       ...
                                       <td bgcolor='#FFFFFF' valign='top'>
                                          <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>";
                                                $_sql2 = "SELECT berkas_tte.no_rawat,berkas_tte.kode, 
                                                          ...
                                                          where berkas_tte.no_rawat='".$baris["no_rawat"]."' ORDER BY master_berkas_tte.nama ASC ";
                                                $hasil2=bukaquery($_sql2);
                                                $no=1;
                                                while($baris2 = mysqli_fetch_array($hasil2)) { 
                                                    echo "<tr class='isi8'> 
                                                            <td width='5%'>$no.</td>
                                                            <td width='95%'><a target=_blank href=../berkastte/".$baris2["lokasi_file"].">".$baris2["nama"]."</a></td>
                                                          </tr>";$no++;
                                                }
                                            echo "                                  
                                          </table>
