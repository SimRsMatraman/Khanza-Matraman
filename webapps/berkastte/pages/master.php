    ...
    <div class="entry">        
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <table width="100%" align="center">
                <tr class="head">
                    <td width="25%" >Kode Berkas TTE BSSN</td><td width="">:</td>
                ...
                <tr class="head">
                    <td width="25%" >Nama Berkas TTE BSSN</td><td width="">:</td>
            ...
            <?php
                ...
                if (isset($BtnSimpan)) {
                    ...
                    if ((!empty($kode))&&(!empty($nama))) {
                        switch($action) {
                            case "TAMBAH":
                                Tambah(" master_berkas_tte "," '$kode','$nama'", " Master TTE BSSN " );
            ...
            <?php
                $_sql = "SELECT * from master_berkas_tte ORDER BY kode ASC ";
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    echo "<table width='99.6%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                            <tr class='head'>
                                ...
                                <td width='18%'><div align='center'>Kode Berkas TTE BSSN</div></td>
                                <td width='76%'><div align='center'>Nama Berkas TTE BSSN</div></td>
                            </tr>";
        ...
        <?php
            if ($action=="HAPUS") {
                Hapus(" master_berkas_tte "," kode ='".$_GET['kode']."' ","?act=MasterBerkas&action=TAMBAH");
            }
