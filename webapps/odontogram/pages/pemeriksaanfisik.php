...
<?php if($_GET['com']=='hapus')
 ...
 $_query="Delete FROM gambar_pemeriksaan WHERE id='$id'";
bukaquery($_query);
?>
                            ...
                            <label class='col-lg-3 mb-3'>Bagian</label>
                             <div class='col-lg-9 mb-9'>
                                <select class="form-control" data-live-search="true" name='bagian' id="bagian">
                                  <?php 
                                  $queryBagian = "SELECT * FROM  bagian_gambar ";
           $_queryBagian=bukaquery($queryBagian);
                $no=1;  while($dataBagian=mysqli_fetch_array($_queryBagian)){ ?>
...
<?php $norawat=$_GET['norawat'];
           $_sql = "SELECT * FROM  gambar_pemeriksaan Where no_rawat='$norawat'";
           $hasil=bukaquery($_sql);
                $no=1;  while($data=mysqli_fetch_array($hasil)){ ?>
