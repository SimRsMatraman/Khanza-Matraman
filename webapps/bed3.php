<?php
 ...
 require_once('bedeisnew.php');
 require_once('spgdt.php');
 require_once('api_bed_rsonlinev2_put.php');
 require_once('api_non_bed_rsonlinev2_put.php');
 require_once('bedeisnewv2.php');
