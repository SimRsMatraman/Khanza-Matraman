...
<nav class="deep-orange accent-3">
    <div class="nav-wrapper">
        <ul class="center hide-on-med-and-down" id="nv">
            <li>
                <a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_hospital</i> RSUD CIPAYUNG</a>
            </li>
    ...
    <div class="footer-copyright deep-orange accent-3 white-text">
        <div class="container simple-marquee-container" id="footer">
            ...
            <marquee class="marquee" scrollamount="4">
                  <?php 
                    $sql ="SELECT kelas, trf_kamar FROM kamar WHERE statusdata='1' and statusdata='0' GROUP BY kelas";
                    $hasil=bukaquery($sql);
