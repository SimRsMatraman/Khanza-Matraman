...
<body bgcolor='#ffffff'>
    ...
    $cetakan = mysqli_fetch_array(bukaquery("select cetakan,tanggal,jam from cetakan_billing_ralan where no_rawat='$norawat' order by no_rawat,cetakan desc"));
        ...
        echo "
			    ...
			    <td colspan='7' padding='0'>
                                <table width='100%' bgcolor='#ffffff' align='left' border='0' padding='0' cellspacing='0' cellpadding='0'>
                                    ...
                                    <tr class='isi12' padding='0'>
                                     <td padding='0' width='50%' align=center><font color='000000' size='1'  face='Tahoma'></td> 
                                     <td padding='0' width='50%' align='center'><font color='000000' size='1'  face='Tahoma'>Petugas</font></td>              
                                    </tr>  
                                    <tr class='isi12' padding='0'>
