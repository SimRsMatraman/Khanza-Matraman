...
<html>
    ...
    <?php
        ...
        $cetakan = mysqli_fetch_array(bukaquery("select cetakan,tanggal,jam from cetakan_billing_ranap where no_rawat='$norawat' order by no_rawat,cetakan desc"));
        ...
        if(mysqli_num_rows($hasil)!=0) { 
            ...
            <td colspan='7' padding='0'>
                   <table width='100%' bgcolor='#ffffff' align='left' border='0' cellspacing='0' cellpadding='0'>
                        <tr>
                            <td  width='20%'>
				<img width='120' height='80' src='data:image/jpeg;base64,". base64_encode($setting['logo']). "'/>
			    </td>
			    <td>
				<center>
            ...
            <tr>
              <td colspan='7' padding='0'>
               <hr/>
                ...
                <font color='333333' size='1'  face='Tahoma'>Dokter DPJP</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <font color='333333' size='1' face='Tahoma'>".getOne("select nm_dokter from dpjp_ranap JOIN dokter ON dokter.kd_dokter=dpjp_ranap.kd_dokter where no_rawat='$norawat'")."</font>
              </td>
              
            </tr>
            <tr>
              <td colspan='7' padding='0'>
                <font color='333333' size='1'  face='Tahoma'>Dokter Operator 1</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <font color='333333' size='1' face='Tahoma'>".getOne("select nm_dokter from operasi JOIN dokter ON dokter.kd_dokter=operasi.operator1 where no_rawat='$norawat'")."</font>
              </td>
            ...
            echo "  <tr class='isi12' padding='0'>
			    <td colspan='7' padding='0'>
                                <table width='100%' bgcolor='#ffffff' align='left' border='0' padding='0' cellspacing='0' cellpadding='0'>
                                    ...
                                    <tr class='isi12' padding='0'>
                                     <td padding='0' width='40%' align=center><font color='000000' size='1'  face='Tahoma'>Mengetahui,<br></td> 
                                     <td padding='0' width='20%' align=center><font color='000000' size='1'  face='Tahoma'>&nbsp;</td>     
                                    ...
                                    <tr class='isi12' padding='0'>
                                     <td padding='0' width='40%' align=center><font color='000000' size='1'  face='Tahoma'>Kepala Ruangan</td> 
                                     <td padding='0' width='20%' align=center><font color='000000' size='1'  face='Tahoma'></td>   
			    ...
			    <td colspan='7' padding='0'>&nbsp</td>
                        ...
                        <td><font color='000000' size='1'  face='Tahoma'>" . "Cetakan Ke" . "-" . $cetakan["cetakan"] . " " . $cetakan["tanggal"] . " " . $cetakan["jam"] . "</font><br></td>
                        <tr class='isi12' padding='0'>
			    <td colspan='7' padding='0'>&nbsp</td>
                        </tr>
                        <tr class='isi12' padding='0'>
