...
<head>
    ...
    <title>Skrining RSUD Cipayung</title>
...
<body background="img/putih.jpg">
    ...
    <section class="content">
        <center>
            <h3><b>SELAMAT DATANG RSUD CIPAYUNG</b></i>
                <p></p>
                </b>
            </h3>
            <br>
        ...
        <div class="col-md-4">
            ...
            <div class="box box-deafult box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><span class="fa fa-user-circle"> PILIHAN SKRINING</span></h3>
                ...
                <?php  
                $tanggal = date('Y-m-d');
                $kuota = getOne("select count(kategori) from skrining_mandiri where kategori='Vaksin' and status ='TERIMA' and tanggal='$tanggal'");
                if(date("H:i:s") > "11:00:00" || $kuota > 199){

                }else{ ?>
                    <a class="btn btn-success btn-block" href="https://rsudcipayung.jakarta.go.id/webapps/skrining/vaksin.php"> VAKSIN </a>
               <?php } ?>
                                
                                <br>
                                <a class="btn btn-primary btn-block" href="https://rsudcipayung.jakarta.go.id/webapps/skrining/pasien.php"> PASIEN </a>
                                <br>
                                <a class="btn btn-info btn-block" href="https://rsudcipayung.jakarta.go.id/webapps/skrining/pengunjung.php"> PENGUNJUNG </a>
                                <br>
                                <a class="btn btn-danger btn-block" href="https://rsudcipayung.jakarta.go.id/webapps/skrining/tamu.php"> TAMU </a>
                                <br>
                                <a class="btn btn-warning btn-block" href="https://rsudcipayung.jakarta.go.id/webapps/skrining/sa.php"> SELF ASSESMENT </a>
                            </fieldset>
                        </form>
                    </div>
                    <br><br><br>
