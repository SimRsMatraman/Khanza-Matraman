...
<body class="login-page">
    ...
    <body background="images/putih.jpg">
        <?php
        ...
        $no_rm_next1 = sprintf('%06s', ($lastRM));
        ?>
        <!-- Page Loader -->
		...
		'-'
                    ...
                    if ($insert) {
                        set_message('Selamat..!! Anda telah melakukan pendaftaran pasien baru (Harap screen shot untuk akses login).');
                    ...
                    <div class="body">
                        <form id="sign_up" method="POST">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="no_peserta" placeholder="Nomor Peserta BPJS" required autofocus>
                                </div>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon">
                            ...
                            <div class="m-t-25 m-b--5 align-center">
                                <a href="https://play.google.com/store/apps/details?id=com.rsudcipayung.sibolen&hl=in">Sudah terdaftar sebagai pasien?</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            ?>
                ...
                <div class="card">
                    <div class="body text-center">
                        <h5>Username (No.RM):</h5>
                        <h2><?php echo $no_rm_next1; ?></h2><br>
                        <p>Gunakan No. KTP anda sebagai password.</p>
                        <!-- <p>Silahkan klik tombol login dibawah</p><br> -->
                        <a href="https://play.google.com/store/apps/details?id=com.rsudcipayung.sibolen&hl=in"><button type="button" class="btn bg-green btn-lg waves-effect">SILAKAN LOGIN DI APLIKASI</button></a>
                    </div>
                </div>
