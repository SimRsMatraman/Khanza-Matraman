...
<body background="img/putih.jpg">
    ...
    <section class="content">
        <center>
            ...
            <img src="img/vaksin.png" width="300" height="300">
            <h3>
        </center>
        <div class="col-md-4">
        </div>
        <div class="col-md-4">
            ...
            <div class="box box-success box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><span class="fa fa-user-circle"> Form Skrining Vaksin</span></h3>
                    ...
                    <?php if (isset($_POST['submit'])) {
                        ...
                        else
                        {
                            ...
                            $folder_foto = "upload/";
                                        ...
                                        echo "<script>alert('Data berhasil di Simpan (HARAP SCREENSHOT SETELAH OK) !!!'); window.location = 'cetak.php?nobok=$autonumber" . "'</script>";
                            //         } else {
