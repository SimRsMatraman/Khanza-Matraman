...
<body background="img/putih.jpg">
    ...
    <section class="content">
        <center>
            <h3><b>SELAMAT DATA ANDA BERHASIL DI SIMPAN</b></i>
                <p></p>
                </b>
            </h3>
            <img src="img/icon.png" width="190" height="200">
            <h3>
                <b>
                    <h3><b>RSUD CIPAYUNG</b></i>
                </b></h3>
        </center>
        <div class="col-md-4">
        </div>
        <div class="col-md-4">
            ...
            <div class="box box-success box-solid">
                <div class="box-header with-border">
                    <center>
                        <h3 class="box-title"><span class="fa "> HARAP SCREENSHOT UNTUK BUKTI SELF ASSESMENT !!!</span></h3>
                    </center>
                ...
                <div class="box-body">
                    <center>
                        <!-- <h3><b> NOMOR REGISTRASI : <?= $id ?> <b></h3> -->
                        <h3><b> ID REGISTRASI : <?php echo getOne("select id_reg from pemeriksaan_mandiri where id_reg='$_GET[nobok]'"); ?> <b></h3>
                        <h3><b> NO RAWAT : <?php echo getOne("select no_rawat from pemeriksaan_mandiri where id_reg='$_GET[nobok]'"); ?> <b></h3>
                        <h3><b> NAMA : <?php echo getOne("select 
                        pasien.nm_pasien
                        from pemeriksaan_mandiri 
                        inner join reg_periksa on reg_periksa.no_rawat=pemeriksaan_mandiri.no_rawat
                        inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis 
                        inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli where id_reg='$_GET[nobok]'"); ?> <b></h3>
                        <h3><b> POLIKLINIK : <?php echo getOne("select 
                        poliklinik.nm_poli
                        from pemeriksaan_mandiri 
                        inner join reg_periksa on reg_periksa.no_rawat=pemeriksaan_mandiri.no_rawat
                        inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis 
