        ...
        <div class="col-md-4">
            ...
            <div class="box <?php echo $color?> box-solid">
                <div class="box-header with-border">
                    <center>
                    <?php if ( $view ==true){?>
                        <h3 class="box-title"><span class="fa ">SELAMAT ANDA BERHASIL REGISTRASI</span></h3>
                        <?php } else{?>
                ...
                <?php if ( $view ==true){?>
                    <center>
                        ...
                        <h3><b> No Registrasi : <?php echo getOne("select no_reg from skrining_mandiri where id_daftar='$_GET[nobok]'"); ?> <b></h3>
                        ...
                        <h3><b style="color:red;">No : 001 s/d 050 (08:00:00 WIB s/d 09:00:00 WIB)<b></h3>
                        <h3><b style="color:red;">No : 051 s/d 100 (09:00:00 WIB s/d 10:00:00 WIB)<b></h3>
                        <h3><b style="color:red;">No : 101 s/d 150 (10:00:00 WIB s/d 11:00:00 WIB)<b></h3>
                        <h3><b style="color:red;">No : 151 s/d 200 (11:00:00 WIB s/d 12:00:00 WIB)<b></h3>
                        <h3><b style="color:red;">Harap datang sesuai jam sudah di tentukan !!!<b></h3>
                    </center>
