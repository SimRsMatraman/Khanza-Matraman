...
<body background="img/putih.jpg">
    ...
    <section class="content">
        <center>
            ...
            <img src="img/pasien.png" width="500" height="300">
            <h3>
        </center>
        <div class="col-md-4">
        </div>
        <div class="col-md-4">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><span class="fa fa-user-circle"> Form Skrining Pasien</span></h3>
                ...
                <div class="box-body">
                    <?php if (isset($_POST['submit'])) {
                        ...
                        else
                        {
                            ...
                            $no_reg1 = noRegWaw('skrining_mandiri','Pasien',$tanggal);
                            ...
                            $folder_foto = "upload/";
                                        ...
                                        echo "<script>alert('Data berhasil di Simpan (HARAP SCREENSHOT SETELAH OK) !!!'); window.location = 'cetakpasienrs.php?nobok=$autonumber" . "'</script>";
                            //         } else {
                        ...
                        <form method="post" role="form" enctype="multipart/form-data" aria-labelledby="myModalLabel">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Pasien" name="kategori" type="kategori" value="Pasien" readonly>
                                </div>
