...
<body background="img/putih.jpg">
    ...
    <section class="content">
        <center>
            ...
            <img src="img/tamu.png" width="500" height="300">
            <h3>
        </center>
        <div class="col-md-4">
        </div>
        <div class="col-md-4">
            ...
            <div class="box box-danger box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><span class="fa fa-user-circle"> Form Skrining Tamu</span></h3>
                        ...
                        <form method="post" role="form" enctype="multipart/form-data" aria-labelledby="myModalLabel">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Tamu" name="kategori" type="kategori" value="Tamu" readonly>
                                </div>
